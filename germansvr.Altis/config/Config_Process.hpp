...
class ProcessAction {
	...
	class iridium {
        MaterialsReq[] = {{"iridiumerz",1}};
        MaterialsGive[] = {{"iridium",1}};
        Text = "STR_Process_Iridium";
        //ScrollText = "Iridium schmelzen";
        NoLicenseCost = 350;
    };
	class aluminium {
        MaterialsReq[] = {{"aluminiumerz",1}};
        MaterialsGive[] = {{"aluminium",1}};
        Text = "STR_Process_Aluminium";
        //ScrollText = "Aluminium schmelzen";
        NoLicenseCost = 350;
    };
	class silber {
	...
	class uran {
        ...
        //ScrollText = "Tobias experimentieren lassen";
        NoLicenseCost = 350;
    };
	
	class bier {
        MaterialsReq[] = {{"malz",1}, {"hopfen",1}};
        MaterialsGive[] = {{"bier",1}};
        Text = "STR_Process_Bier";
        //ScrollText = "Bier brauen";
        NoLicenseCost = 350;
    };
};
