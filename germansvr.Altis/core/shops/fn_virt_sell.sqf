...

{
	...
	if (_curItemName==_itemNameToSearchFor) then {
		_price=_curItemPrice
	};
...
[player, player, _price, format["VIRTITEMSELL|%1",_type], BANK, CASH] remoteExec ["DB_fnc_handleDBLog", 2];