if (life_wu) exitWith {hint "Wurde schon Gestartet XD";};
life_wu = true;
...
playSound "wu";
hintsilent parsetext"<t size='1.5'>ACHTUNG! Weltuntergang (Serverrestart)</t><br/><br/><t size='1.3'>Bis gleich euer Nextgeneration Life Team</t>";
uisleep 14;
