...
_title             = "Willkommen Bürger";
_shorttext         = "NextGeneration-Life";
_posText        = [0.8,0.7,0.4];


_title2         = "Website";
_shorttext2     = "www.NextGeneration-Life.de";
_posText2        = [0.8,0.6,0.25];


_title3            = "Teamspeak 3";
_shorttext3     = "ts.NextGeneration-Life.de";
_posText3        = [0.8,0.6,0.25];


_title4         = "Donate";
_shorttext4     = "Unterstütze den Server und helfe ihn am leben zu beleiben";
_posText4        = [0.8,0.5,0.28];


_title5         = "Top Donator";
_shorttext5     = 	"Jodie Holmes - 30€ <br />
                     Peter Quill - 25€ <br />
					";
_posText5        = [0.8,0.5,0.335];


_title6         = "Custom Scripts";
_shorttext6     = "Handy<br/>Personalausweiß<br/>Bugtracker<br/>Sperrzonen System<br/>Jail System<br/>Defi<br/>Tankstellen<br/>Bankomat<br/>IGI-Load<br/>";
_posText6        = [0.8,0.4,0.335];


_title7         = "Play Fair And Enjoy";
_shorttext7     = "Admins are Always Active";
_posText7        = [0.8,0.3,0.4];
