...
{
    private _pump = nearestObjects [_x,["Land_FuelStation_Feed_F","Land_fs_feed_F"],5] select 0;
    _pump setFuelCargo 0;
    _pump addAction [localize "STR_Action_Pump", life_fnc_fuelStatOpen, 1, 3, true, true, "", '_this distance _target < 10'];
    false
