...
if(_house getVariable "alarme") then { // Hinzugefügter Code
 [_house]call life_fnc_alarme;
 [2,"STR_House_Raid_NOTF",true,[(_house getVariable "house_owner") select 1]] remoteExecCall ["life_fnc_broadcast",RCLIENT]; // Nachricht erscheint für alle Spieler, kann man aber optional ausschalten.
};
