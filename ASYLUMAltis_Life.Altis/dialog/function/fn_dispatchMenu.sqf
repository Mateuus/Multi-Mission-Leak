...
[[player],"ASY_fnc_requestDispatcher",false,false] spawn BIS_fnc_MP;
...
["dispatchMap", "onMapSingleClick",
{
	...
	[[_unit, _pos, _alt], "ASY_fnc_setWaypoint", false, false] spawn BIS_fnc_MP;
...
(getPos player) spawn
{
	...
	[[player, -1, true], "ASY_fnc_manageRadio", false, false] spawn BIS_fnc_MP;
};