...
{
	case civilian: { ["civ_car","civ_kart","reb_car","civ_truck","civ_air","civ_ship"] };
...
_smallHeliT = 20;
_largeHeli = ["I_Heli_Transport_02_F", "O_Heli_Light_02_unarmed_F","O_Heli_Transport_04_F","O_Heli_Transport_04_bench_F","O_Heli_Transport_04_covered_F"];
_largeHeliT = 21;
...
[[_vid,_pid,life_veh_sp,_unit,_price,life_talents,_insured,life_coprole in ["all","detective"]],"ASY_fnc_spawnVehicle",false,false] spawn BIS_fnc_MP;