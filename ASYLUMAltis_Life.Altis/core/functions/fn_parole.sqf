...
if(!life_confirm_response) exitWith { [[[0,1,2], format["%1 refused parole", profileName]],"life_fnc_broadcast",_unit,false] spawn BIS_fnc_MP; };

[[[0,1,2], format["%1 accepted parole!", profileName]],"life_fnc_broadcast",_unit,false] spawn BIS_fnc_MP;
[[player,_unit,false],"life_fnc_wantedBounty",false,false] spawn BIS_fnc_MP;
