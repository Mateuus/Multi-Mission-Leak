...
[[_val,name player],"life_fnc_clientWireTransfer",_unit,false] spawn BIS_fnc_MP;
...
[[159, player, format["Transferred $%1 to %2 (%3) with tax fee of $%4", _val, name _unit, getPlayerUID _unit, _tax]],"ASY_fnc_logIt",false,false] spawn BIS_fnc_MP;
