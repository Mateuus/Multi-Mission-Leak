...
else
{
	...
	if (life_gov_atm) then { [["999999",_val,"add",player],"ASY_fnc_updateGangBank",false,false] spawn BIS_fnc_MP; }
	else { [[life_gang,_val,"add",player],"ASY_fnc_updateGangBank",false,false] spawn BIS_fnc_MP; };
