...
[[_vehicle,_unit,name player], "life_fnc_clientGetKey",_unit,false] spawn BIS_fnc_MP;

//[[65, player, format["Gave keys for %1 to %2", typeOf _vehicle, name _unit]],"ASY_fnc_logIt",false,false] spawn BIS_fnc_MP;