...
if (life_isRebooting) exitWith{
	[[1,"The server is already running a shut down sequence and will ignore your request."],"life_fnc_broadcast",_callUser,false] spawn BIS_fnc_MP;
...
[[1, format[_bootString, 15]],"life_fnc_broadcast",nil,false] spawn BIS_fnc_MP;
[[format[_bootStringSysChat, 15]],"life_fnc_localChatMessage",true,false] spawn BIS_fnc_MP;
sleep 300;
[[1, format[_bootString, 10]],"life_fnc_broadcast",nil,false] spawn BIS_fnc_MP;
[[format[_bootStringSysChat, 10]],"life_fnc_localChatMessage",true,false] spawn BIS_fnc_MP;
sleep 300;
[[1, format[_bootString, 5]],"life_fnc_broadcast",nil,false] spawn BIS_fnc_MP;
[[format[_bootStringSysChat, 5]],"life_fnc_localChatMessage",true,false] spawn BIS_fnc_MP;
sleep 240;
[[1, format[_bootString, 1]],"life_fnc_broadcast",nil,false] spawn BIS_fnc_MP;
[[format[_bootStringSysChat, 1]],"life_fnc_localChatMessage",true,false] spawn BIS_fnc_MP;
sleep 60;
