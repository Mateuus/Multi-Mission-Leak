...
_max = switch (true) do
{
	case (6 in life_talents || (playerSide == west && (life_coprole in ["warrant","all"]))): { 2000000 };
	case (4 in life_talents): { 100000 };
	case (3 in life_talents): { 50000 };
	case (2 in life_talents): { 10000 };
	default { 5000 };
};
...
[[player,_max,life_bounty_uid,_maxBounties], "life_fnc_wantedGetBounty", false, false] call BIS_fnc_MP;