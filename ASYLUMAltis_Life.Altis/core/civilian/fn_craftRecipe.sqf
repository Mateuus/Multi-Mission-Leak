...
else
{
	...
	if (isClass (configFile >> "CfgVehicles" >> _className)) then
	{
		...
		[[(getPlayerUID player),playerSide,_vehicle,_color,player,_plate,0.5,damage _vehicle,(87 in life_talents),false],"ASY_fnc_vehicleCreate",false,false] spawn BIS_fnc_MP;
