...
if(!(_ctrl in ["scotch_0","scotch_1","scotch_2","whiskeyc_0","whiskeyc_1","whiskeyc_2","whiskeyr_0","whiskeyr_1","whiskeyr_2"]) && (typeOf life_trunk_vehicle) == "Land_WaterBarrel_F") exitWith {hint "You can't place this into an aging barrel!";};
...
//[[70, player, format["Put %1 %2 in trunk of %3", _num, _ctrl, typeOf life_trunk_vehicle]],"ASY_fnc_logIt",false,false] spawn BIS_fnc_MP;