...
[[_spikeStrip],"ASY_fnc_spikeStrip",false,false] spawn BIS_fnc_MP; //Send it to the server for monitoring.
[_spikeStrip,"ASY_fnc_setIdleTime",false,false] spawn BIS_fnc_MP;

//[[64, player, format["Deployed a spike strip!"]],"ASY_fnc_logIt",false,false] spawn BIS_fnc_MP;