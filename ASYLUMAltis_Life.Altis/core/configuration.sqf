...
life_phone_buttons = [
	...
	["Wanted", "icons\phone_wanted.paa", "[] call life_fnc_wantedMenu", "playerSide == west || getPlayerUID player == (life_configuration select 0) || life_adminlevel > 0", "Index of criminals and warrants"],
...
life_achievementInfo = [
	...
	[[civilian,west,independent], "Upper Class", "life_wealthPrestige > 500000", "Obtained over 500,000 prestige.", "Triple Paychecks"],
...
switch (playerSide) do
{
	...
	{
		["atm","set",1000] call life_fnc_uC;
		life_paycheck = 35; //Paycheck Amount
	};
	case independent: {
		["atm","set",1000] call life_fnc_uC;
		life_paycheck = 45; //Paycheck Amount
	};
};
...
//			["civ_car","Orel_Agora",10000,130,0,0,0,18,civilian,0,0,false],
			...
			["civ_air","C_Heli_Light_01_civil_F",150000,200,0,0,0,20,civilian,0,0,false],
			...
			["reb_air","B_Heli_Light_01_F",125000,80,0,0,0,20,civilian,0,0,false],
...
[
	...
	["arifle_Katiba_F",16000],
	["arifle_Katiba_C_F",15000],
...
life_talentInfo = if (worldName == "Australia") then
{
	[
		// Civilian
		[1, "CIV", "Vigilante", 0, "Able to buy bounty hunter license. Max bounty $5,000."],
		[2, "CIV", "Bounty Hunter", 1, "Maximum bounty increased to $10,000."],
		[3, "CIV", "Bounty Hunter 2", 2, "Maximum bounty increased to $50,000."],
		...
		[6, "CIV", "Bounty Hunter 4", 4, "Unlimited maximum bounty."],
		...
		[9, "CIV", "Motivated", 6, "Able to have up to 4 active bounties at a time."],
		...
		[13, "CIV", "First Aid Level D", 12, "Ability to fix broken legs with a splint."],
		[14, "CIV", "First Aid HCP", 13, "Can revive an unconscious player with defibrillator."],
...
else
{
	[
		...
		[3, "CIV", "Bounty Hunter 2", 2, "Maximum bounty increased to $50,000."],
		[4, "CIV", "Bounty Hunter 3", 3, "Maximum bounty increased to $100,000."],
		[5, "CIV", "Feud", 3, "Access to Vermin and TRG-20 SMGs with rubber bullets."],
		[6, "CIV", "Bounty Hunter 4", 4, "Unlimited maximum bounty."],
		[7, "CIV", "Watch Dog", 1, "Receive reports when your bounty accesses an ATM."],
		[8, "CIV", "Informants", 7, "Rare chance that informants may spot bounties in populated areas."],
		[9, "CIV", "Motivated", 6, "Able to have up to 4 active bounties at a time."],
		...
		[81, "WEST", "Show of Force 4", 80, "Able to purchase the MXM assault rifle."],
		[82, "WEST", "Stunning", 80, "Able to purchase flashbangs. (Constable)"],
		[83, "WEST", "Mechanic", 0, "You can now repair vehicles without the use of tools."],
		[84, "WEST", "Grease Monkey", 83, "Slightly increased speed of repairing vehicles."],
		[85, "WEST", "Nourished", 0, "Food and drink consumption reduced by 25%."],
