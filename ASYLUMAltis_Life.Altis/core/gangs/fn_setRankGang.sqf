...
if (!isNull _active) then { [[player, _rank],"life_fnc_rankGang",_active,false] spawn BIS_fnc_MP; }
else { [[_user,life_gang,_rank],"ASY_fnc_gangMember",false,false] spawn BIS_fnc_MP; };
