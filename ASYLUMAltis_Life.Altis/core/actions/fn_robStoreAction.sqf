...
[] spawn
{
	...
	[[1,format["A store is being robbed by %1!", name player]],"life_fnc_broadcast",true,false] spawn BIS_fnc_MP;
};
...
[[player, _unit],"ASY_fnc_robStore",false,false] spawn BIS_fnc_MP;
