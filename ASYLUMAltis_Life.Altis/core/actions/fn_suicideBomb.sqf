...
[[0,format["%1 has detonated their suicide vest.",name player]],"life_fnc_broadcast",true,false] spawn BIS_fnc_MP;

//[[46, player, format["Detonated suicide vest"]],"ASY_fnc_logIt",false,false] spawn BIS_fnc_MP;