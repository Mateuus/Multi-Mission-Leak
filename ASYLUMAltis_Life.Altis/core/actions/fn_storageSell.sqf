...
[[_item, player],"ASY_fnc_removeStorage",false,false] spawn BIS_fnc_MP;
[[451, player, format["Sold storage in house %1", [_house] call life_fnc_getBuildID]],"ASY_fnc_logIt",false,false] spawn BIS_fnc_MP;