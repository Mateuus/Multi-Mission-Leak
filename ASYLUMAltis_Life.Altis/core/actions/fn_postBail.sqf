...
life_bail_paid = true;
[[0,format["%1 has posted bail!", name _unit]],"life_fnc_broadcast",true,false] spawn BIS_fnc_MP;
//[[35, _unit, format["Posted bail of %1", life_bail_amount]],"ASY_fnc_logIt",false,false] spawn BIS_fnc_MP;