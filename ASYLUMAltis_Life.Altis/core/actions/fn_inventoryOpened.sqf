...
if (_container isKindOf "Bag_Base" && !(cursorTarget getVariable ["playerSurrender",false])) exitWith { hint "No stealing allowed!"; true };
...
if ((locked _container) > 1) exitWith { hint "The container is locked and cannot be opened!"; true };
