...
[[player],"life_fnc_handleDowned",_unit,false] spawn BIS_fnc_MP;
[[[0,1,2],format["You've been shanked by %1!", profileName]],"life_fnc_broadcast",_unit,false] spawn BIS_fnc_MP;