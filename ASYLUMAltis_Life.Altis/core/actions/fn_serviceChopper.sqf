...
_search = nearestObjects[getPos air_sp, ["Air"],8];
...
["cash","take",250] call life_fnc_uC;
...
{
	[{(_search select 0) setFuel 1;},"BIS_fnc_spawn",(_search select 0),false] spawn BIS_fnc_MP;
}
	else
{
