...
_maxHouses = 5;
if (worldName != "Altis") then { _maxHouses = 1; };
...
{
	[[_saleOwner, player, format["You've sold a house (%1) and $%2 has been added to your bank account!", _buildingName, _price], _price],"ASY_fnc_addMessage",false,false] spawn BIS_fnc_MP;
...
[[_buildingID, _uid, 0, position _house],"DB_fnc_insertHouse",false,false] spawn BIS_fnc_MP;
