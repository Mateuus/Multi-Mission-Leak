...
if (_bankSale) then
{
	...
	[[_buildingID, _house],"DB_fnc_deleteHouse",false,false] spawn BIS_fnc_MP;
	[[_buildingID],"life_fnc_gangDisbanded",civilian,false] spawn BIS_fnc_MP;
	[[598, player, format["%1 sold house %2 for $%3", profileName, _buildingID, _price]],"ASY_fnc_logIt",false,false] spawn BIS_fnc_MP;
}
else
{
	...
	[[_buildingID, _house, _val],"DB_fnc_listHouse",false,false] spawn BIS_fnc_MP;
	[[_buildingID],"life_fnc_gangDisbanded",civilian,false] spawn BIS_fnc_MP;
	[[599, player, format["%1 listed house %2 for $%3", profileName, _buildingID, _val]],"ASY_fnc_logIt",false,false] spawn BIS_fnc_MP;
};
