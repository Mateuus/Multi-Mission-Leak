...
//[[17, player, format["Started delivery mission to %1", _dp]],"ASY_fnc_logIt",false,false] spawn BIS_fnc_MP;
...
time spawn
{
	...
	if(!alive player) then
	{
		...
		//[[18, player, format["Failed delivery mission due to death"]],"ASY_fnc_logIt",false,false] spawn BIS_fnc_MP;
