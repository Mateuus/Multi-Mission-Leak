...
if (_unit getVariable["playerSurrender",false]) then {
	...
	detach _unit;
	deleteVehicle _obj;
	[[_unit,"AmovPercMstpSsurWnonDnon_AmovPercMstpSnonWnonDnon","playNow"],"life_fnc_animSync",true,false] spawn BIS_fnc_MP;
	[[_unit,"AmovPercMstpSsurWnonDnon_AmovPercMstpSnonWnonDnon","switch"],"life_fnc_animSync",true,false] spawn BIS_fnc_MP;
