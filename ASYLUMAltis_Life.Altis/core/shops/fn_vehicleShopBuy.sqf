...
//Spawn vehicle
_vehicle = [_veh,_color,_sp,_dir,_plate,player,(87 in life_talents)] call life_fnc_createVehicle;
...
[[(getPlayerUID player),playerSide,_vehicle,_color,player,_plate,_fuel,_damage,(87 in life_talents),_insured],"ASY_fnc_vehicleCreate",false,false] spawn BIS_fnc_MP;
