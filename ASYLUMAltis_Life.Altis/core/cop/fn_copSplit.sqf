...
{
	[["atm","add",_amount],"life_fnc_uC",_x,false] spawn BIS_fnc_MP;
} forEach _cops;

[[0,format["All active police have received $%1 for an arrest by %2.", [_amount] call life_fnc_numberText, name _unit]],"life_fnc_broadcast",west,false] spawn BIS_fnc_MP;