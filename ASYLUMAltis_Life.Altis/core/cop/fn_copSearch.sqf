...
*/
private["_civ","_invs","_license","_robber","_guns","_gun","_holsterLabel","_money","_alcohol","_class","_className","_index"];
...
_drug = [_this,4,0,[0]] call BIS_fnc_param;
_alcohol = [_this,5,0,[0]] call BIS_fnc_param;
_money = [_this,6,0,[0]] call BIS_fnc_param;
_extra = "";
...
if(_robber) then {_extra = "Matches description of robbery suspect.<br/>"};
switch (true) do
{
