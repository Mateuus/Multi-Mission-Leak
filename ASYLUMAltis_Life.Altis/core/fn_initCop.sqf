...
switch (true) do
{
	...
	{
		_found = false; { if (str _x == "Swat_comm") then { _found = true; }; } foreach playableUnits;
...
//[[25, player, format["Initialized as cop of rank %1", life_coplevel]],"ASY_fnc_logIt",false,false] spawn BIS_fnc_MP;
