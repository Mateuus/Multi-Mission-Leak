...
_items = switch (_item) do
{
	...
	case "RH_vz61";
	case "SMG_02_F" : { [["life_inv_ironore",10],["life_inv_salt",10]] };
	case "RH_tec9";
	case "RH_muzi";
	case "SMG_01_F" : { [["life_inv_ironore",10],["life_inv_salt",7]] };
	case "hlc_rifle_ak47";
	case "hlc_rifle_ak12";
	...
	case "srifle_DMR_01_F" : { [["life_inv_diamond",2],["life_inv_coke",25]] };
	case "hlc_rifle_akm";
//	case "CUP_sgun_M1014";
	case "CUP_srifle_AWM_des";
	case "CUP_srifle_AWM_wdl";
	case "srifle_EBR_F" : { [["life_inv_diamond",4],["life_inv_coke",25]] };
	case "srifle_DMR_03_khaki_F" : { [["life_inv_diamond",4],["life_inv_coke",25]] };
	case "srifle_DMR_03_multicam_F" : { [["life_inv_diamond",4],["life_inv_coke",25]] };
	case "srifle_DMR_03_tan_F" : { [["life_inv_diamond",4],["life_inv_coke",25]] };
	case "srifle_DMR_03_woodland_F" : { [["life_inv_diamond",4],["life_inv_coke",25]] };
	case "srifle_DMR_06_olive_F" : { [["life_inv_diamond",4],["life_inv_coke",25]] };
	case "srifle_DMR_06_camo_F" : { [["life_inv_diamond",4],["life_inv_coke",25]] };
	default { [] };
};

if (worldName == "Stratis" && _item == "SMG_01_F") then { _items = [["life_inv_ironore",10],["life_inv_sand",6]] };
if (worldName == "Stratis" && _item == "SMG_02_F") then { _items = [["life_inv_ironore",10],["life_inv_sand",8]] };
