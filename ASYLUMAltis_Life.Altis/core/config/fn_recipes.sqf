...
_items = switch (worldName) do
{
	...
	default
	{
		switch (_shop) do
		{
			...
			case "blackmarket" : { ["B_G_Offroad_01_F","B_G_Offroad_01_armed_F","O_MRAP_02_F","I_Heli_light_03_unarmed_F","O_Heli_Light_02_unarmed_F","arifle_Katiba_F","arifle_Katiba_C_F","LMG_Mk200_F","srifle_DMR_01_F","srifle_EBR_F","srifle_DMR_03_khaki_F","srifle_DMR_03_multicam_F","srifle_DMR_03_tan_F","srifle_DMR_03_woodland_F","srifle_DMR_06_olive_F","srifle_DMR_06_camo_F"] };
			case "weapons" : { ["hgun_ACPC2_F","hgun_PDW2000_F","SMG_02_F","SMG_01_F"] };
			default { [] };
		};
	};
