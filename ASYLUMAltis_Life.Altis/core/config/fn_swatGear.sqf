...
if (worldName == "Australia") then
{
	switch (_role) do
	{
		...
		case 2: // Leader
		{
			...
			for "_i" from 1 to 7 do {player addItemToVest "CUP_8Rnd_B_Beneli_74Slug";};
...
else
{
	switch (_role) do
	{
		...
		case 2: // Leader
		{
			...
			for "_i" from 1 to 5 do {player addItem "30Rnd_65x39_caseless_mag";};
			for "_i" from 1 to 4 do {player addItem "30Rnd_65x39_caseless_mag_Tracer";};
			player addItemToVest "SmokeShell";
			player addItemToVest "SmokeShellGreen";
			for "_i" from 1 to 2 do {player addItem "MiniGrenade";};
