...
private["_control","_index","_className","_classNameLife","_basePrice","_vehicleInfo","_colorArray","_ctrl","_color1","_color2"];
...
_color1 = " <t color='#8cff9b'>%1€</t><br/>";
_color2 = " <t color='#8cff9b'>%2€</t><br/>";
...
(localize "STR_Shop_Veh_UI_Rental")+ _color1 +
(localize "STR_Shop_Veh_UI_Ownership")+ _color2 +
