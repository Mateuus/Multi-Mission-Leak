...

{
	...
	"pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","morphine",
	"rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtleSoup","hen","rooster","sheep","goat","boltcutter","blastingcharge","hache","menottes","nitro","adactool","couteau","cagoule","baillon","radarfalle"
];
