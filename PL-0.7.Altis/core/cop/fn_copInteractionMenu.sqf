...
_Btn8 ctrlSetText localize "STR_pInAct_RemoveWeapon";
_Btn8 buttonSetAction "[life_pInact_curTarget] spawn life_fnc_removeWeaponAction; closeDialog 0;";

_Btn9 ctrlSetText localize "STR_pInAct_RemoveUniform";
_Btn9 buttonSetAction "[life_pInact_curTarget] spawn life_fnc_removeUniformAction; closeDialog 0;";
...
if(!((player distance (getMarkerPos "prison_1") < 30) ||  (player distance (getMarkerPos "prison_2") < 30) || (player distance (getMarkerPos "prison_3") < 30) || (player distance (getMarkerPos "jail_marker") < 200) || (player distance (getMarkerPos "prison_4") < 30))) then  {
