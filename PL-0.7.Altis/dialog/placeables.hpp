class Life_Cop_Placeables {
	...
	class controls {
		...
		class RemoveAll : life_RscButtonMenu {
			...
			x = 0.10 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH)); //0,15625
			y = 0.8 - (1 / 25);
			w = (6.25 / 40) + 0.125;
			h = (1 / 25);
		};

		class RemoveOneItem : life_RscButtonMenu {
			idc = -1;
			text = "Supprimer";
			onButtonClick = "[] call life_fnc_placeablesDeleteObject";
			x = 0.26 + 0.125 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.8 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
		};
