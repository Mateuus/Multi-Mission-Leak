...
[[_unit,grpPlayer],"clientGangKick",_unit,false] call GTA_fnc_remoteExec; //Boot that bitch!
[[4,grpPlayer],"TON_fnc_updateGang",false,false] call GTA_fnc_remoteExec; //Update the database.
