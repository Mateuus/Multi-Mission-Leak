...
_action = [
	format[localize "STR_GNOTF_TransferMSG",_unit getVariable ["nametag_title",name _unit]],
...
if(_action) then {
	...
	[[_unit,grpPlayer],"clientGangLeader",_unit,false] call GTA_fnc_remoteExec; //Boot that bitch!
	[[3,grpPlayer],"TON_fnc_updateGang",false,false] call GTA_fnc_remoteExec; //Update the database.
} else {
