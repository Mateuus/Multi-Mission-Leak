/*
	...
	//Added - stuffz Keyword:EDIT
*/
private["_itemArray","_uniform","_vest","_backpack","_goggles","_headgear","_items","_prim","_seco","_uItems","_bItems","_vItems","_pItems","_hItems","_yItems","_uMags","_bMags","_vMags","_handle","_maxLoadB","_maxLoadV","_strongBack"];
params [["_itemArray", [], [[]]]];
...
_uniform = [_itemArray,0,"",[""]] call GTA_fnc_param;
_vest = [_itemArray,1,"",[""]] call GTA_fnc_param;
_backpack = [_itemArray,2,"",[""]] call GTA_fnc_param;
_goggles = [_itemArray,3,"",[""]] call GTA_fnc_param;
_headgear = [_itemArray,4,"",[""]] call GTA_fnc_param;
_items = [_itemArray,5,[],[[]]] call GTA_fnc_param;
_prim = [_itemArray,6,"",[""]] call GTA_fnc_param;
_seco = [_itemArray,7,"",[""]] call GTA_fnc_param;
_uItems = [_itemArray,8,[],[[]]] call GTA_fnc_param;
_uMags = [_itemArray,9,[],[[]]] call GTA_fnc_param;
_bItems = [_itemArray,10,[],[[]]] call GTA_fnc_param;
_bMags = [_itemArray,11,[],[[]]] call GTA_fnc_param;
_vItems = [_itemArray,12,[],[[]]] call GTA_fnc_param;
_vMags = [_itemArray,13,[],[[]]] call GTA_fnc_param;
_pItems = [_itemArray,14,[],[[]]] call GTA_fnc_param;
_hItems = [_itemArray,15,[],[[]]] call GTA_fnc_param;
_yItems = [_itemArray,16,[],[[]]] call GTA_fnc_param;
