...
if (life_drink > 0.22) then {
			...
			[[0,format[localize "STR_MISC_StPubIntox",profileName]],"life_fnc_broadcast",nil,false] call GTA_fnc_remoteExec;
			[[getPlayerUID player,profileName,"390"],"life_fnc_wantedAdd",false,false] call GTA_fnc_remoteExec;
