...
_control ctrlSetStructuredText parseText format["<t align='center'><t size='.8px'>" +(localize "STR_Cop_Ticket_GUI_Given"),_cop getVariable["nametag_title",name _cop],_val];
...
[] spawn
{
	...
	{
		[[0,format[localize "STR_Cop_Ticket_Refuse",profileName]],"life_fnc_broadcast",west,false] call GTA_fnc_remoteExec;
		[[1,format[localize "STR_Cop_Ticket_Refuse",profileName]],"life_fnc_broadcast",life_ticket_cop,false] call GTA_fnc_remoteExec;
	};
};