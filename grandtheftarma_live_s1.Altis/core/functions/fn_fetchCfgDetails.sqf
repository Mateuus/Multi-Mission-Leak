...
*/
private["_entity","_cfg","_ret","_type","_acc_p","_acc_o","_slotclasses","_acc_m","_acc_u","_scope","_displayName","_picture","_config","_itemInfo","_muzzles","_magazines","_desc","_base"];
_entity = [_this,0,"",[""]] call GTA_fnc_param;
_type = -1;
_acc_p = [];
_acc_o = [];
_acc_m = [];
...
_ret = [_entity,_displayName,_picture,_scope,_type,_itemInfo,_cfg,_magazines,_muzzles,_desc,_acc_p,_acc_o,_acc_m,_base,_slotclasses,_acc_u];
_ret;