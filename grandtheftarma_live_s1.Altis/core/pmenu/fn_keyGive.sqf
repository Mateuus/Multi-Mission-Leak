...
if(_index == -1) then 
{
	_owners set[count _owners,[_uid,_unit getVariable["nametag_title",name _unit]]];
	_vehicle setVariable["vehicle_info_owners",_owners,true];
};

hint format["You have given %1 keys to your %2",_unit getVariable["nametag_title",name _unit],typeOf _vehicle];
[[_vehicle,_unit,profileName], "clientGetKey",_unit,false] call GTA_fnc_remoteExec;