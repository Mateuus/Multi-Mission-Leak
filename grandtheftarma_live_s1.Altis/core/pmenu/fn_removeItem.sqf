...
if(_ind != -1 && playerSide != west && ([west,getPos player,50] call life_fnc_nearUnits)) exitWith {titleText["This is an illegal item and cops are nearby, you cannot dispose of the evidence","PLAIN"]};
