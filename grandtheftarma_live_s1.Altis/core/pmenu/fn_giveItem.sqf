...
[[_unit,_val,_item,player],"life_fnc_receiveItem",_unit,false] call GTA_fnc_remoteExec;
_type = [_item,0] call life_fnc_varHandle;
_type = [_type] call life_fnc_varToStr;
hint format["You gave %1 %2 %3",_unit getVariable["nametag_title",name _unit],_val,_type];
