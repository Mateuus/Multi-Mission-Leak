...
if(_type in ["bruce","dive","reb","kart","bounty"] && playerSide != civilian) exitWith {hint localize "STR_Shop_NotaCiv"; closeDialog 0;};
if(_type == "reb" && !license_civ_rebel) exitWith {hint localize "STR_Shop_NotaReb"; closeDialog 0;};
if(_type in ["cop"] && playerSide != west) exitWith {hint localize "STR_Shop_NotaCop"; closeDialog 0;};
if(_type in ["dive"] && !license_civ_dive) exitWith { hint localize "STR_Shop_NotaDive"; closeDialog 0;};
if(_type == "jet" && !license_civ_jet) exitWith {hint localize "STR_Shop_NotaJet"; closeDialog 0;};
if(_type == "heli" && !license_civ_air) exitWith {hint localize "STR_Shop_NotaHeli"; closeDialog 0;};
