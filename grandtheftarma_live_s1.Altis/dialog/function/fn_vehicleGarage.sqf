...
_type = [_this,1,"",[""]] call GTA_fnc_param;
_spawnPos = [_this,0,ObjNull,[ObjNull]] call GTA_fnc_param;

life_garage_sp = [(_spawnPos modelToWorld [-11.5,0,0]),(getDir _spawnPos)-90];
life_garage_type = _type;
[[getPlayerUID player,playerSide,_type,player],"TON_fnc_getVehicles",false,false] call GTA_fnc_remoteExec;
