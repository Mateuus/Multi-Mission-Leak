...
class playerSettings {
	...
	class controls {
		...
		class NearPlayers : GTA_RscCombo
		{
			idc = 2022;
		...
		class iNearPlayers : GTA_RscCombo
		{
			idc = 2023;
		...
		*/
		...
		class ButtonAdminMenu : Life_RscButtonMenu {
			...
			onButtonClick = "createDialog ""GTA_RscDisplayAdmin"";";
			x = 0.42 + (6.25 / 19.8) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.805;
			w = (6.25 / 40);
			h = (1 / 25);
		...
		class ButtonTalent : life_RscButtonMenu {
			idc = 2024;
			text = "Perks";
			onButtonClick = "createDialog ""GTA_RscDisplayPerks"";";
