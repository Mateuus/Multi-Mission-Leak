...
_val = parseNumber(ctrlText 1412);
_unit = call compile format["%1",(lbData[2100,(lbCurSel 2100)])];
if(isNull _unit) exitWith {};
if((lbCurSel 2100) == -1) exitWith {hint localize "STR_ATM_NoneSelected"};
...
[_val,profileName] remoteExecCall ["life_fnc_wireTransfered",_unit];
