...
_num = ctrlText 3505;
_safeInfo = life_heliGoldObj getVariable["heligold",0];
...
if(_num > _safeInfo) exitWith {hint format[localize "STR_Civ_IsntEnoughSmuggler",_num];};
...
life_heliGoldObj setVariable["heligold",_safeInfo - _num,TRUE];
