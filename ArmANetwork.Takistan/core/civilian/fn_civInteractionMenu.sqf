...
_Btn4 buttonSetAction "[[],""life_fnc_removeWeaponActionCiv"",life_pInact_curTarget,false] spawn life_fnc_MP;";

_Btn5 ctrlSetText "Rob Player";
_Btn5 buttonSetAction "[life_pInact_curTarget] call life_fnc_robAction; [life_pInact_curTarget] call life_fnc_civInteractionMenu;closeDialog 0;";
