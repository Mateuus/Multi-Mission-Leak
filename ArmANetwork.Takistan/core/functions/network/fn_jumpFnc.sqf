...
if(animationState _unit == "amovpercmsprsnonwnondf_amovppnemstpsnonwnondnon") exitWith {}; //snake crap
if(animationState _unit == "AovrPercMrunSrasWrflDf_amovpercmsprsnonwnondf_amovppnemstpsnonwnondnon") exitWith {}; //snake crap
