...
_atmstatus ctrlSetStructuredText parseText format [" $%1",[BANK] call life_fnc_numberText];
_cashstatus ctrlSetStructuredText parseText format [" $%1",[CASH] call life_fnc_numberText];
