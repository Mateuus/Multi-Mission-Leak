...
_Btn9 ctrlSetText localize "STR_pInAct_stripSearch";
_Btn9 buttonSetAction "[[],""life_fnc_stripSearch"",life_pInact_curTarget,false] spawn life_fnc_mp; closeDialog 0;";

_Btn10 ctrlSetText "Breathalyze";
_Btn10 buttonSetAction "[life_pInact_curTarget] spawn life_fnc_breathalyzer; closeDialog 0;";

_Btn11 ctrlSetText "Drug Test";
_Btn11 buttonSetAction "[life_pInact_curTarget] spawn life_fnc_drugtestAction; closeDialog 0;";

_Btn12 ctrlShow false;

//Check that you are near a place to jail them.
if(!((player distance (getMarkerPos "nato_hq_1") < 30) OR  (player distance (getMarkerPos "cop_spawn_2") < 30))) then  {
