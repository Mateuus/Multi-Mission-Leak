...
ctrlSetText[3103,"Bobby's Kartanzüge"];

if(life_level < 2) exitWith {["Info: ","Du musst erst Level 2 erreicht haben um Kart-Kleidung kaufen zu können!","#ff1000","#ffffff",7] call life_fnc_texttiles;}; 
