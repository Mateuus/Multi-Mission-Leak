...
closeDialog 0;
hintSilent parseText format["Dein Blutalkohol liegt nun bei<br/> <t size='1.4'><t color='#FF0000'>%1</t></t>",[life_drink] call life_fnc_numberText];
sleep 4;
...
if (life_drink > 0.22) then {
			...
			[0,format[localize "STR_MISC_StPubIntox",profileName]] remoteExecCall ["life_fnc_broadcast",0];
			[getPlayerUID player,profileName,"390"] remoteExecCall ["SOA_fnc_wantedAdd",2];
