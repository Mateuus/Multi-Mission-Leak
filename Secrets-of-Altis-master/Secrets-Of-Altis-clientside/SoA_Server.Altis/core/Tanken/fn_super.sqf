...
switch(true)do
{
	...
	case (_vehicle iskindof "I_G_Offroad_01_F"): {_liter = 0.00900; _completeliter = 85;};
	...
	case (_vehicle iskindof "C_Quadbike_01_F"): {_liter = 0.00900; _completeliter = 25;};
	case (_vehicle iskindof "C_Offroad_02_unarmed_F"): {_liter = 0.00900; _completeliter = 95;};
