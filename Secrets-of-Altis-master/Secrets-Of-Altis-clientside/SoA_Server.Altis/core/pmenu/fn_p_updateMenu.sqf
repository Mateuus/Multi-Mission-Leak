...
*/
private["_dialog","_inv","_lic","_licenses","_near","_near_units","_mstatus","_shrt","_side","_icon","_title","_akku"];
...
_title = _dialog displayCtrl 2016;
_title CtrlSetText format['%1 [Level: %2]',name player, life_level];
_struct = "";
lbClear _inv;
lbClear _near;
lbClear _near_i;
...
_mstatus ctrlSetStructuredText parseText format["<img size='1.3' image='icons\bank.paa'/> <t size='0.8px'>%1€</t><br/><img size='1.2' image='icons\money.paa'/> <t size='0.8'>%2€</t>",[life_beatbankgeld] call life_fnc_numberText,[life_beatgeld] call life_fnc_numberText];
