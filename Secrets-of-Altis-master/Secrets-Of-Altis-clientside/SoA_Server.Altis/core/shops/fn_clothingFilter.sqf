...
_clothes = switch (life_clothing_store) do
{
	...
	case "cop_krawall": {[_selection] call life_fnc_clothing_cop_krawall;};	
	case "reb": {[_selection] call life_fnc_clothing_reb;};
	case "gruppe": {[_selection] call life_fnc_clothing_gruppe;};
	...
	case "med": {[_selection] call life_fnc_clothing_ahw;};
	case "donator": {[_selection] call life_fnc_clothing_donator;};
	case "jagd": {[_selection] call life_fnc_clothing_jagd;};
	case "president": {[_selection] call life_fnc_clothing_president;};
	case "winter": {[_selection] call life_fnc_clothing_winter;};
    case "bandit": {[_selection] call life_fnc_clothing_bandit;};    
};
