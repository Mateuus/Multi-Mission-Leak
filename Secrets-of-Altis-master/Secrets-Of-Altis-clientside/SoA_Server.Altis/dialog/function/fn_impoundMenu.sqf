...
{
	ctrlSetText[2801,localize "STR_Garage_NoVehicles"];
};
...
/*
{
	...
	_price = [_x select 2,__GETC__(life_garage_prices)] call SOA_fnc_index;
	_sPrice = [_x select 2,__GETC__(life_garage_sell)] call SOA_fnc_index;
