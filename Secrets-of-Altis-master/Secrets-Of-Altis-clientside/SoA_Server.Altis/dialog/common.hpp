...
class Life_RscListNBox
{
	...
	colorSelectBackground2[] = {0.4,0,0,0.5};
	colorPicture[] = {1,1,1,1};
	colorPictureSelected[] = {1,1,1,1};
	colorPictureDisabled[] = {1,1,1,1};
	soundSelect[] = {"A3\ui_f\data\sound\RscButton\soundPush.wss",0.1,1};
	soundExpand[] = {"",0.1,1};
	soundCollapse[] = {"",0.1,1};
	period = 1.2;
	maxHistoryDelay = 0.5;
...
class Life_RscText {
	...
	font = "PuristaMedium";
	SizeEx = 0.035;		//"(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	text = "";
	colorText[] = {1, 1, 1, 1.0};
...
idc = -1;
    ...
    soundEnter[] = {"A3\ui_f\data\sound\onover.wss", 0.09, 1};
    soundPush[] = {"A3\ui_f\data\sound\new1.wss", 0.0, 0};
    soundClick[] = {"A3\ui_f\data\sound\RscButton\soundPush.wss", 0.07, 1};
    soundEscape[] = {"A3\ui_f\data\sound\onescape.wss", 0.09, 1};
    action = "";
    text = "";
	tooltipColorText[] = {1,1,1,1};
	tooltipColorBox[] = {1,1,1,1};
...
class Life_RscButton 
{
	...
	colorBackgroundActive[] = {0.4,0,0,1};
	...
	soundClick[] = {"A3\ui_f\data\sound\RscButton\soundPush.wss",0.09,1};
...
class Life_RscButtonMenu : Life_RscShortcutButton {
	...
	w = 0.095589;
	h = 0.0259216;
	onMouseButtonDown = "playsound 'button'";
	...
	soundEnter[] = {"A3\ui_f\data\sound\RscButtonMenu\soundEnter.wss",1,1};
	soundPush[] = {"A3\ui_f\data\sound\RscButtonMenu\soundPush.wss",1,1};
	soundClick[] = {"A3\ui_f\data\sound\RscButton\soundPush.wss",1,1};
	soundEscape[] = {"A3\ui_f\data\sound\RscButtonMenu\soundEscape.wss",1,1};
	textureNoShortcut = "";
};
...
class Life_RscCheckBox2
{
	...
	textureChecked = "icons\checked.paa";
	textureUnchecked = "A3\Ui_f\data\GUI\RscCommon\RscCheckBox\CheckBox_unchecked_ca.paa";
	textureFocusedChecked = "icons\checked.paa";
	textureFocusedUnchecked = "A3\Ui_f\data\GUI\RscCommon\RscCheckBox\CheckBox_unchecked_ca.paa";
	textureHoverChecked = "icons\checked.paa";
	textureHoverUnchecked = "A3\Ui_f\data\GUI\RscCommon\RscCheckBox\CheckBox_unchecked_ca.paa";
	texturePressedChecked = "icons\checked.paa";
	texturePressedUnchecked = "A3\Ui_f\data\GUI\RscCommon\RscCheckBox\CheckBox_unchecked_ca.paa";
	textureDisabledChecked = "icons\checked.paa";
