...
class DWEV_RscControlsGroup {
	...
	class VScrollBar : DWEV_RscScrollBar
	{
		width = 0.021;
		autoScrollEnabled = 1;
	};

	class HScrollBar : DWEV_RscScrollBar
	{
		height = 0.028;
	};
...
class DWEV_RscControlsGroupNoScrollbars : DWEV_RscControlsGroup {
...
class DWEV_RscListNBox
{
	...
	idcLeft = -1;
	idcRight = -1;
	class ListScrollBar: DWEV_RscScrollBar{};
	class ScrollBar: DWEV_RscScrollBar{};
};
...
class DWEV_RscLine : DWEV_RscText {
	idc = -1;
	style = 176;
	x = 0.17;
	y = 0.48;
...
class DWEV_RscTitle : DWEV_RscText {
	style = 0;
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	colorText[] = {0.95, 0.95, 0.95, 1};
};

class DWEV_RscPicture {
	shadow = 0;
	type = 0;
	style = 48;
	sizeEx = 0.023;
...
class DWEV_RscTextMulti : DWEV_RscText
{
	linespacing = 1;
	style = 0 + 16 + 0x200;
};

class DWEV_RscPictureKeepAspect : DWEV_RscPicture
{
	style = 0x30 + 0x800;
};

class DWEV_RscStructuredText {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class DWEV_RscButtonTextOnly : DWEV_RscButton
{
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	colorBackground[] = {1, 1, 1, 0};
...
class DWEV_RscButtonMenu : DWEV_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class DWEV_RscButtonInvisible : DWEV_RscButtonMenu {
...
class DWEV_RscShortcutButtonMain : DWEV_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class DWEV_RscSlider {
	h = 0.025;
	color[] = {1, 1, 1, 0.8};
	colorActive[] = {1, 1, 1, 1};
};

class DWEV_RscXSliderH
{
	style = 1024;
	type = 43;
	shadow = 2;
...
class DWEV_RscBackground : DWEV_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
...
class DWEV_RscMapControl
{
	...
	class LineMarker
	{
		 ...
		 lineLengthMin = 5;
		 lineWidthThick = 0; // 0.014;
		 lineWidthThin = 0; //0.008;
		 textureComboBoxColor = "#(argb,8,8,3)color(1,1,1,0)";
	};
...
class DWEV_RscCombo {
	...
	soundExpand[] = {"",0.1,1};
	colorText[] = {0.95, 0.95, 0.95, 1};
//aktivieren wenn die icons weiß sein sollen.
//	colorPicture[] = {1,1,1,1};
//	colorPictureSelected[] = {1,1,1,1};
//	colorPictureDisabled[] = {1,1,1,1};
	soundCollapse[] = {"",0.1,1};
	...
	class ComboScrollBar : DWEV_RscScrollBar {};
};

class DWEV_RscToolbox {
	colorText[] = {0.95, 0.95, 0.95, 1};
	color[] = {0.95, 0.95, 0.95, 1};
