class DWEV_ticket_give
{
	idd = 2650;
	name = "DWEV_ticket_give";
	movingEnabled = false;
	...
	class controls 
	{
		...
		class ctrl_button_ausstellen: DWEV_RscButtonInvisible
		{
			idc = 507006;
			text = "";
			tooltip = "Bußgeld ausstellen";
			colorBackground[] = {0, 0, 0, 0};
			onButtonClick = "[] call DWEV_fnc_ticketGive";
			x = 0.4625;
			y = 0.45;
			w = 0.075;
			h = 0.075;
...
class DWEV_ticket_pay
{
	idd = 2600;
	name = "DWEV_ticket_pay";
	movingEnabled = false;
	enableSimulation = true;
	onLoad = "[""main"",(side player)] spawn DWEV_fnc_tabletbutton;";
	...
	class controls 
	{
		...
		class ctrl_button_zahlen: DWEV_RscButtonInvisible
		{
			idc = 507006;
			text = "";
			tooltip = "Bußgeld bezahlen";
			colorBackground[] = {0, 0, 0, 0};
			onButtonClick = "[] call DWEV_fnc_ticketPay;";
			x = 0.325;
			y = 0.45;
			w = 0.075;
			h = 0.075;
