class DWEV_ticketme_give
{
	idd = 2850;
	name = "DWEV_ticketme_give";
	movingEnabled = false;
	...
	class controls 
	{
		...
		class ctrl_button_ausstellen: DWEV_RscButtonInvisible
		{
			idc = 507006;
			text = "";
			tooltip = "Quittung ausstellen";
			colorBackground[] = {0, 0, 0, 0};
			onButtonClick = "[] call DWEV_fnc_ticketmeGive";
			x = 0.4625;
			y = 0.45;
			w = 0.075;
			h = 0.075;
...
class DWEV_ticketme_pay
{
	idd = 2800;
	name = "DWEV_ticketme_pay";
	movingEnabled = false;
	enableSimulation = true;
	onLoad = "[""main"",(side player)] spawn DWEV_fnc_tabletbutton;";
	...
	class controls 
	{
		...
		class ctrl_button_zahlen: DWEV_RscButtonInvisible
		{
			idc = 507006;
			text = "";
			tooltip = "Quittung bezahlen";
			colorBackground[] = {0, 0, 0, 0};
			onButtonClick = "[] call DWEV_fnc_ticketmePay;";
			x = 0.325;
			y = 0.45;
			w = 0.075;
			h = 0.075;
		...
		class ctrl_button_ablehnen: DWEV_RscButtonInvisible
		{
			idc = 507008;
			text = "";
			tooltip = "Quittung nicht bezahlen";
			colorBackground[] = {0, 0, 0, 0};
