...
class Personalausweis {
	...
	logoWest = "icons\Polizei128.paa";
	// Feuerwehr-Logo (Pfad) # medical badge destination
	logoIndep = "icons\Feuerwehr128.paa";
	// Sicherheitsdienst-Logo (Pfad) # medical badge destination
	logoEast = "icons\Sicherheit128.paa";
	// Zivilisten-Logo (Pfad), ja Farben können angegeben werden # civilian badge destination, yes you can use color
	logoCiv = "icons\fingerabdruck.paa";
	// Opfor-Logo (Pfad)/Unbekannte Fraktion # opfor badge destination/unkown side
	logoUnkn = "icons\wolfkopf128.paa";
	...
	class persoOrt {
		...
		class 39895 {
			...
			name = "Feres";
			plz = 39895;
			str[] = {{"Ruinenstrasse",8},{"Industriehof",3},{"Sandweg",18}};
		};	
		class 38441 {
			id = 11;
			name = "Frini";
	...
	class persoBild
	{
		class 1
		{
			id = 1;
			name = "Bayh";
			pfad = "textures\persobilder\Bayh.paa";
		};
		class 2
		{
			id = 2;
			name = "Burr";
			pfad = "textures\persobilder\Burr.paa";
		};
		class 3
		{
			id = 3;
			name = "Byrne";
			pfad = "textures\persobilder\Byrne.paa";
		};
		class 4
		{
			id = 4;
			name = "Campbell";
			pfad = "textures\persobilder\Campbell.paa";
		};
		class 5
		{
			id = 5;
			name = "Christou";
			pfad = "textures\persobilder\Christou.paa";
		};
		class 6
		{
			id = 6;
			name = "Coburn";
			pfad = "textures\persobilder\Coburn.paa";
		};
		class 7
		{
			id = 7;
			name = "Collins";
			pfad = "textures\persobilder\Collins.paa";
		};
		class 8
		{
			id = 8;
			name = "Dayton";
			pfad = "textures\persobilder\Dayton.paa";
		};
		class 9
		{
			id = 9;
			name = "Dorgan";
			pfad = "textures\persobilder\Dorgan.paa";
		};
		class 10
		{
			id = 10;
			name = "Doukas";
			pfad = "textures\persobilder\Doukas.paa";
		};
		class 11
		{
			id = 11;
			name = "Gikas";
			pfad = "textures\persobilder\Gikas.paa";
		};
		class 12
		{
			id = 12;
			name = "Halliwell";
			pfad = "textures\persobilder\Halliwell.paa";
		};
		class 13
		{
			id = 13;
			name = "Hasan";
			pfad = "textures\persobilder\Hasan.paa";
		};
		class 14
		{
			id = 14;
			name = "Jesus";
			pfad = "textures\persobilder\Jesus.paa";
		};
		class 15
		{
			id = 15;
			name = "Johnson";
			pfad = "textures\persobilder\Johnson.paa";
		};
		class 16
		{
			id = 16;
			name = "Kanelloupou";
			pfad = "textures\persobilder\Kanelloupou.paa";
		};
		class 17
		{
			id = 17;
			name = "Kelly";
			pfad = "textures\persobilder\Kelly.paa";
		};
		class 18
		{
			id = 18;
			name = "Kirby";
			pfad = "textures\persobilder\Kirby.paa";
		};
		class 19
		{
			id = 19;
			name = "Martinez";
			pfad = "textures\persobilder\Martinez.paa";
		};
		class 20
		{
			id = 20;
			name = "O Brien";
			pfad = "textures\persobilder\O_Brien.paa";
		};
		class 21
		{
			id = 21;
			name = "O Conner";
			pfad = "textures\persobilder\O_Conner.paa";
		};
		class 22
		{
			id = 22;
			name = "O Sullivan";
			pfad = "textures\persobilder\O_Sullivan.paa";
		};
		class 23
		{
			id = 23;
			name = "Reed";
			pfad = "textures\persobilder\Reed.paa";
		};
		class 24
		{
			id = 24;
			name = "Santorum";
			pfad = "textures\persobilder\Santorum.paa";
		};
		class 25
		{
			id = 25;
			name = "Savalas";
			pfad = "textures\persobilder\Savalas.paa";
		};
		class 26
		{
			id = 26;
			name = "Smith";
			pfad = "textures\persobilder\Smith.paa";
		};
		class 27
		{
			id = 27;
			name = "Snowe";
			pfad = "textures\persobilder\Snowe.paa";
		};
		class 28
		{
			id = 28;
			name = "Walsh";
			pfad = "textures\persobilder\Walsh.paa";
		};
		class 29
		{
			id = 29;
			name = "Williams";
			pfad = "textures\persobilder\Williams.paa";
		};
	};
};