...
{
	{
		...
		_x addAction ["Tanken", "[['Car']] call DWEV_fnc_gasVehicleSelection;",""];
		false;
	} count nearestObjects [_x, ["Land_fs_feed_F"], 5];
	false;
} count VIR_fuelPump_locations;

DWEV_fuelTrucks = [	"B_Truck_01_fuel_F",
					"O_Truck_03_fuel_F",
					"O_G_Van_01_fuel_F",
					"O_Truck_02_fuel_F"					
];
