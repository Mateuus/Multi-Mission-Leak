...
if (isNil "DWEV_gas_vehicle") exitWith { hint format "Fahrzeug nicht gefunden!"; closeDialog 0;};
if (isNull DWEV_gas_vehicle OR !alive DWEV_gas_vehicle) exitWith { hint format "Fahrzeug nicht gefunden!"; closeDialog 0;};
...
createDialog "DWEV_gas_refuel";
[] spawn DWEV_fnc_gasVehicleUpdate;