...
if(isNil "_vehicle" OR isNull _vehicle OR !(_vehicle getVariable "lights")) exitWith {};
	...
	_lightRed = [20, 0.1, 0.1]; // ROT
	_lightBlue = [0.1, 0.1, 20]; // BLAU
...
switch (typeOf _vehicle) do
{
	...
	case "O_Heli_Transport_04_medevac_F":			{_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];};
	case "B_MRAP_01_F": 					{_lightleft lightAttachObject [_vehicle, [-1, -2.8, 0.55]];};
	case "C_Van_01_box_F": 					{_lightleft lightAttachObject [_vehicle, [-1, -0.3, 1.4]];};	
...
switch (typeOf _vehicle) do
{
	...
	case "O_Heli_Transport_04_medevac_F":			{_lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.56]];};
	case "B_MRAP_01_F": 					{_lightright lightAttachObject [_vehicle, [1, -2.8, 0.55]];};
	case "C_Van_01_box_F": 					{_lightright lightAttachObject [_vehicle, [1, -0.3, 1.4]];};
