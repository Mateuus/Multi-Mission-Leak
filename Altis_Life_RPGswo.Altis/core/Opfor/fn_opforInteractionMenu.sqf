...
if((_curTarget getVariable["Escorting",false])) then {
	_Btn2 ctrlSetText "Eskorte beenden";
	_Btn2 buttonSetAction "[DWEV_pInact_curTarget] call DWEV_fnc_stopEscorting; closeDialog 0;";
} else {
	_Btn2 ctrlSetText "Eskortieren";
	_Btn2 buttonSetAction "[DWEV_pInact_curTarget] call DWEV_fnc_escortAction; closeDialog 0;";
};
_Btn2 ctrlShow true;

//Put In Car
_Btn3 ctrlSetText "Ins Fahrzeug";
_Btn3 buttonSetAction "[DWEV_pInact_curTarget] call DWEV_fnc_putInCar; closeDialog 0;";
_Btn3 ctrlShow true;

// Kommunikation
_Btn4 ctrlSetText "Kommunikation abnehmen";
_Btn4 buttonSetAction "[DWEV_pInact_curTarget] call DWEV_fnc_removeCommunication; closeDialog 0;";
_Btn4 ctrlShow true;
