...
switch (typeOf _vehicle) do
{
	...
	case "B_Heli_Transport_03_unarmed_F":	{_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];};
	case "O_Heli_Transport_04_F":			{_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];};
	case "B_Heli_Transport_01_F":			{_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];};
	case "O_MRAP_02_F": 					{ _lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];};
	case "I_MRAP_03_F": 					{ _lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];};
	case "I_Truck_02_covered_F":			{_lightleft lightAttachObject [_vehicle, [-1, -0.3, 1.4]];};
	case "O_Heli_Light_02_unarmed_F":		{_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];};
	case "B_Truck_01_fuel_F":			{_lightleft lightAttachObject [_vehicle, [-1, -0.3, 1.4]];};
	};
...
switch (typeOf _vehicle) do
{
	...
	case "B_Heli_Transport_03_unarmed_F":	{_lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.56]];};
	case "O_Heli_Transport_04_F":			{_lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.56]];};
	case "B_Heli_Transport_01_F":			{_lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.56]];};
	case "O_MRAP_02_F": 					{ _lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.56]];};
	case "I_MRAP_03_F": 					{ _lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.56]];};
	case "I_Truck_02_covered_F": 			{_lightright lightAttachObject [_vehicle, [1, -0.3, 1.4]];};
	case "O_Heli_Light_02_unarmed_F":		{_lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.56]];};
	case "B_Truck_01_fuel_F": 			{_lightright lightAttachObject [_vehicle, [1, -0.3, 1.4]];};
};
