...
switch (true) do
{
	case (_veh isKindOf "Car") :
	{
		switch(true) do
		{
			case (damage _veh > 0.07) : {_price = 750;};
			case (damage _veh > 0.04) : {_price = 500;};
			case (damage _veh > 0.03) : {_price = 250;};
			default {_price = 25;};
		};
	...
	case (_veh isKindOf "Air") :
	{
		switch(true) do
		{
			case (damage _veh > 0.15) : {_price = 1500;};
			case (damage _veh > 0.06) : {_price = 1000;};
			case (damage _veh > 0.03) : {_price = 500;};
			default {_price = 25;};
		};
