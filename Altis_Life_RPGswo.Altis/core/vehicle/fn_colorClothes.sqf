...
_texture = [(uniform _vehicle)] call DWEV_fnc_clothesColorCfg;
...
{
	(uniformContainer _vehicle) setVariable["DWEV_Clothes_color",_index,true];
};

waitUntil{sleep 0.3; !isNil {(uniformContainer _vehicle) getVariable "DWEV_Clothes_color"}};
