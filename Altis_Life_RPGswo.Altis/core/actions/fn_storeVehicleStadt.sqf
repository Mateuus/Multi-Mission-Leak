...
{
	_nearVehicles = nearestObjects[getPos (_this select 0),["Car"],30]; //Fetch vehicles within 30m.
...
if(isNil "_vehicle") exitWith {hint "Keine Autos in der Nähe der Garage. Helicopter können hier nicht geparkt werden."};
