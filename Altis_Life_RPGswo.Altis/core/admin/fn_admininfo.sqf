...
_text ctrlSetStructuredText parseText format["Name: %1 (%10)<br/>Bank: %2<br/>Geld: %3<br/>Uniform: %4<br/>Weste: %5<br/>Rucksack: %6<br/>Primary: %7<br/>Handgun: %8<br/><t align='center'>Primary Attachments</t><br/>%9",
getPlayerDName(_unit),[_ret select 0] call DWEV_fnc_numberText,[_ret select 1] call DWEV_fnc_numberText, _uni,_vest,_bp,_prim,_sec,_attach,str(_unit)];