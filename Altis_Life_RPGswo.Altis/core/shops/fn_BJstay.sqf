...
{
	_winnings ctrlSetText "Verloren";
	...
	_bet5KTEXT  ctrlSetText "Setzten";
	_bet10KTEXT ctrlSetText "Setzten";
	_bet25KTEXT ctrlSetText "Setzten";
	_bet50KTEXT ctrlSetText "Setzten";