...
life_action_inUse = true;
 switch(typeOf _animalCorpse) do {
	case "Hen_random_F": {_displayName = "Hühnchen"; _item = "hen_raw";};
	case "Cock_random_F": {_displayName = "Gockel"; _item = "rooster_raw";};
	case "Goat_random_F": {_displayName = "Ziege"; _item = "goat_raw";};
	case "Sheep_random_F": {_displayName = "Schaaf"; _item = "sheep_raw";};
...
_upp = format["Sammle %1",_displayName];
...
if(([true,_item,1] call life_fnc_handleInv)) then {
	...
	titleText [format["Du hast etwas rohes Fleisch von einem/r %1 gesammelt",_displayName],"PLAIN"];
} else {
