...
if ((playerSide == west) && {(_vehicle getVariable ["dbInfo",["","", civilian]]) select 2 == west}) exitWith {
	hint "Du kannst keine Fahrzeuge deiner Kollegen abschleppen";
};
