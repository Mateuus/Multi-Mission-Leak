...
if((SEL(_this,3) == "bm" && !license_civ_bm)) exitWith {hint localize "STR_Shop_NotaBm"; closeDialog 0;};
...
if((SEL(_this,3) in ["asf"] && playerSide != east)) exitWith {hint localize "STR_Shop_NotaASF"; closeDialog 0;};
