...
*/
private ["_num","_color","_action","_smoke1","_smoke2","_light","_flare1","_flare2","_previousVol","_i","_camera","_heli","_jumpers","_smokeOn","_spawnPoint"];
_spawnPoint = life_spawn_point select 0;
_spawnPointJumper = format["%1_jumper", _spawnPoint];
_jumpers = missionNamespace getVariable[_spawnPointJumper,[]];
_jumpers pushBack getPlayerUID player;
missionNamespace setVariable[_spawnPointJumper,_jumpers,true];
...
//setup heli
_heli = missionNamespace getVariable[format["%1_heli",_spawnPoint],objNull];
if (isNull _heli) then {
	...
	missionNamespace setVariable[format["%1_heli",_spawnPoint],_heli,true];
