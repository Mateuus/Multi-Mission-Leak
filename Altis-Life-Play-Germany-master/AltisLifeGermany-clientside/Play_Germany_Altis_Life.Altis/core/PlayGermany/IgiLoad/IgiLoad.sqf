...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Cargo_Veh_Offroad = IL_Supported_Quadbike + ["Box_IND_AmmoVeh_F"];
	IL_Supported_Cargo_NonVeh_Offroad = (IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + IL_Supported_Box_H1 + IL_Supported_Box_H2 + PG_containers);// - ["Land_WaterTank_F"];
	...
	IL_Supported_Cargo_Veh_Kamaz = IL_Supported_Quadbike + PG_containers + IL_Supported_OFFROAD + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_VAN;
	IL_Supported_Cargo_NonVeh_Kamaz = IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + IL_Supported_Box_H1 + IL_Supported_Box_H2 + IL_Supported_Cargo20 + PG_containers;
	...
	IL_Supported_Cargo_Veh_Mohawk = IL_Supported_Quadbike + IL_Supported_OFFROAD + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV;
	IL_Supported_Cargo_NonVeh_Mohawk = IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + ["Box_IND_AmmoVeh_F"];
		...
		{
			{
				...
				else
				{
					...
					if ((_box_num > _slot_num) && !_done) then
					{
						...
						{
							[_v, Format ["""%1"" wurde auf ""%2"" aufgeladen. Freie Plätze: ""%3"".", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName"), abs(_slot_num - _counter)], true] call IL_Vehicle_Chat;
						}
						else
						{
							[_v, Format ["""%1"" wurde auf ""%2"" aufgeladen. Es ist kein weiterer Platz vorhanden.", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName")], true] call IL_Vehicle_Chat;
						};
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	_obj_main addAction [
	"<img image='icons\IgiLoad\unload_para.paa' /><t color=""#b200ff""> Mit Fallschirm abspringen</t>",
	{
	...
	_obj_main addAction [
	"<img image='icons\IgiLoad\unload.paa' /><t color=""#ff0000"">  Fracht abladen</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Frachtrampe schließen</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Frachtladen für Co-Piloten aktivieren</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Frachtladen für Co-Piloten deaktivieren</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Frachtladen von außen aktivieren</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Frachtladen von außen deaktivieren</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Frachtrampe aktivieren</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Frachtrampe deaktivieren</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_CHINOOK) then
{
	...
	if (typeOf _obj_main == "CH_147F") then
	{
		...
		_obj_main addAction [
		"<t color=""#007f0e"">Hinten einsteigen</t>",
		{
			(_this select 1) moveInCargo (_this select 0);
		},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_C130J) then
{
	...
	{
		_obj_main addAction [
		"<t color=""#ff0000"">Seitlich von der Frachtrampe aussteigen</t>",
		{
			[_this select 0, _this select 1, false] call IL_GetOut;
		},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_MH9) then
{
	...
	_obj_main addAction [
	"<img image='icons\IgiLoad\load.paa' /><t color=""#007f0e"">  Fracht links aufladen</t>",
	{
	...
	_obj_main addAction [
	"<img image='icons\IgiLoad\load.paa' /><t color=""#007f0e"">  Fracht rechts aufladen</t>",
	{
	...
	_obj_main addAction [
	"<img image='icons\IgiLoad\unload.paa' /><t color=""#ff0000"">  Fracht links abladen</t>",
	{
	...
	_obj_main addAction [
	"<img image='icons\IgiLoad\unload.paa' /><t color=""#ff0000"">  Fracht rechts abladen</t>",
	{
...
///////////////////////////
	_obj_main addAction [
	"<img image='icons\IgiLoad\unload_para.paa' /><t color=""#b200ff"">  Unload cargo with parachute left MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='icons\IgiLoad\unload_para.paa' /><t color=""#b200ff"">  Unload cargo with parachute right MH-9</t>",
	{
