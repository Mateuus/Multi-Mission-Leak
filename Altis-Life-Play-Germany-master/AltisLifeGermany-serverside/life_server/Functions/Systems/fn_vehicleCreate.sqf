...
_vehicle setVariable["dbInfo",[_uid,_plate,([_this,1,sideUnknown,[west]] call BIS_fnc_param)] , true]; //extended with side for Siren-lights 
//_vehicle addEventHandler["Killed","_this spawn TON_fnc_vehicleDead"]; //Also obsolete function?