...
_query = switch(_side) do { 
 ...
 case civilian: {format["playerCivilianInfo:%1",_uid];}; 
...
//Convert tinyint to boolean (licenses) 
...
switch (_side) do { 
 case west: { 
  _queryResult set[10,([_queryResult select 10,1] call DB_fnc_bool)]; // blacklist 
  _queryResult set[11,([_queryResult select 11,1] call DB_fnc_bool)]; // unblock 
 }; 
 
 case civilian: { 
  //_queryResult set[7,([_queryResult select 7,1] call DB_fnc_bool)]; 
        // civ_mobileprovider is at index 10 
  ...
  _queryResult pushBack (missionNamespace getVariable[format["gang_%1",_uid],[]]); 
    ...
    case east: { 
        //asf_mobileprovider is at index 10 
  _queryResult set[11,([_queryResult select 11,1] call DB_fnc_bool)]; // unblock 
    }; 
 
    case independent: { 
  _queryResult set[13,([_queryResult select 13,1] call DB_fnc_bool)]; // unblock 
    }; 
}; 
