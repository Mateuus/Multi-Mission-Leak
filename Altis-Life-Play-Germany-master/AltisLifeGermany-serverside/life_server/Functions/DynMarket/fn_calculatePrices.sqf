 ...
 { 
  ...
  if(_exit) then { 
   ...
   { 
    ...
    _GROUPITEMSarray = _GROUParray select 1; 
    _GROUPITEMSarrayCount = count _GROUPITEMSarray; 
    ...
    { 
     {  
      ...
      { 
       ...
       _NEWPRICE = _curItemOldPrice-(_itemAmountSold*(_curItemOldPrice/1000)*_itemFactorOfGroup); 
       ...
       { 
        ...
        _curItemAmountSold3 = _x select 2; 
        if (_curItemName3==_curITEMname) then { 
         _NEWPRICE = _curItemPrice3+(_itemAmountSold*(_curItemPrice3/(1000*(_GROUPITEMSarrayCount/2)))*_itemFactorOfGroup); 
         if (_NEWPRICE<_curITEMmin) then {_NEWPRICE=_curITEMmin}; 
         if (_NEWPRICE>_curITEMmax) then {_NEWPRICE=_curITEMmax}; 
