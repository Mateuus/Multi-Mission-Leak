...
class CfgServerSettings
{
	...
	{
		/*Database Selection*/
		Database = "MySQL_PG_AltisLife40"; //Database config name
		/*RCON Settings*/
		RCON = false; //Enabled?
...
class CfgFunctions
{
	...
	class PlayGermany_System
	{
		tag = "PGSERV";
		
        class PlayGermany
        {
            file = "\life_server\Functions\PlayGermany";
            class initLights {};
			class vehicleRepaint {};
			class monitorHeli {};
			class monitorCorpse {};
			class isUIDActive {};
        }; //WTF Missing Simicolon fixed by @ArmALeakTeam
        
		class Smartphone
		{
			file = "\life_server\Functions\PlayGermany\Smartphone";
			class handleMessages {};
			class captureRadioCell {};
			class hideObjectGlobal {};
		};
        
		class Event
		{
			file = "\life_server\Functions\PlayGermany\events";
			class event_race {};
			class Altis_LMS_GhostHotel {};
			class Altis_Rennstrecke {};
			class Altis_Start_Flughafen_Event {};
		};
	};
};
