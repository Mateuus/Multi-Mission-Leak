...
*/
private["_vehicle","_veh","_sp","_typeStr2","_fuelDrop","_startCost","_fired","_speedWarning","_test","_curLevel","_typeStr","_type","_newmarker","_markerlocation","_lastLoc","_counter","_expectedTime","_pass","_payment","_sp","_randomVeh","_vehArray","_vehicle","_veh","_tempNum","_attachment","_vehAttachmentArray","_maxDistance","_minDistance","_attachment2","_attachment3","_attachment4","_attachment5","_attachment6"];
...
_action = [
	format ["%1, This mission cost $%2 to begin: %1. You must complete %3 more jobs to be promoted",_typeStr2,[_minDistance] call DS_fnc_moneyText,(((DS_realEstateArray select 12) + 3) - (DS_infoArray select 13))],
	"Warning!",
	"Continue",
	"No Thanks"
] call BIS_fnc_guiMessage;
...
//Do attachment shit here

//Give them more info here
