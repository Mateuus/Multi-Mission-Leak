...
//_playerlist ctrlSetStructuredText parseText format ["<t color='#848484'>%1</t>",_playerListString];
...
if(!isNil {(group player) getVariable "gangName"})then
	{
	_createBtn ctrlEnable false;
