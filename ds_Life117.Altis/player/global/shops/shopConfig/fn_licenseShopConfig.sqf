...
switch(_shop)do
	...
	case 8://Main civ licenses
		{
			_return = [["DSL_car",350,"carShop","Car License","Buy this to be allowed to legally drive a car"],
			["DSL_truck",1000,"truckShop","Truck License","Buy this to be allowed to legally drive a truck"],
			["DSL_air",4500,"airShop","Pilot License","Buy this to be allowed to legally fly an air vehicle"],
			["DSL_boat",600,"boatShop","Boat License","Buy this to be allowed to legally use a sea vehicle"],
			["DSL_weapons",4000,"gun","Legal Weapon License","Buy this to be allowed to legally carry an approved firearm"]];	
			
			if((DS_infoArray select 13) > 36)then
				{
	...
	case 39://Processing Trainings
		{
			_return = [["DSL_oil",2200,"oilu","Oil Processing Training","Purchase this training to process oil"],
	...
	case 52://Drug Processing Trainings
		{
			_return = [["DSL_weed",7500,"weedu","Weed Processing Training","Purchase this training to process weed"],
	...
	case 58://Rebel Trainings
		{
			_return = [["DSL_rebel",20000,"rebelSmallGun","Rebel Training","Purchase this training to purchase rebel weapons and gear"],
