...
if((player distance hosp1_1_2_1_1_1_2_1_1_1_1 < 10)&&((DS_infoArray select 1) < 1200))exitWith
	{
	closeDialog 0;
	hint "The Kavala Gunshop will not sell a weapon to anybody who hasn't been on the island for at least 20 years (20 hours as civilian). Try another city";
	};

if(DS_doingStuff)exitwith{hint "Exit cos Im doing stuff"};
DS_doingStuff = true;
