...
*/
private["_display","_text","_units","_charge","_chargeStr","_copName","_value","_note"];
...
if(_value == "")exitwith{hint "Enter a reason lazy ass"};
...
[[_copName,_value],"DS_fnc_quickKickPlayer",_unit,false] spawn BIS_fnc_MP;
