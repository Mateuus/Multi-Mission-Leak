...
if(playerSide != civilian)exitwith{hint "Only civilians can use this"};
...
[[(_search select 0),true,[(_infoArray select 2),(_infoArray select 2)]],"DS_fnc_globalTexture",true,false] spawn DS_fnc_MP;

[[(_search select 0),true,(_infoArray select 3)],"HUNT_fnc_vehQuickSave",false,false] spawn BIS_fnc_MP;	
