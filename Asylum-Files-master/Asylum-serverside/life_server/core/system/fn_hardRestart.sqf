...
_bootString = "<t align='center' size='2' color='#ff0000'>Server Restarting</t><br />The server is having issues and will be restarting in <t underline='true'>%1 minute(s)</t>! We recommend that you press Y and click ""SYNC DATA"".  This will be a hard restart, so you will need to join the server again from the server selection screen."; 
[[1, format[_bootString, 10]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP; 
[[format["Server Restarting: The server is having issues and will be restarting in %1 minute(s)! We recommend that you press Y and click ""SYNC DATA"". This will be a hard restart, so you will need to join the server again from the server selection screen.", 10]],"life_fnc_localChatMessage",true,false] spawn life_fnc_MP; 
sleep 300; 
[[1, format[_bootString, 5]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP; 
[[format["Server Restarting: The server is having issues and will be restarting in %1 minute(s)! We recommend that you press Y and click ""SYNC DATA"". This will be a hard restart, so you will need to join the server again from the server selection screen.", 5]],"life_fnc_localChatMessage",true,false] spawn life_fnc_MP; 
sleep 240; 
