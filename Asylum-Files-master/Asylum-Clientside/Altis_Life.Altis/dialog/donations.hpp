class life_donation_menu {
	idd = 7500;
	name= "life_donation_menu";
	movingEnable = false;
	enableSimulation = true;
	onLoad = "[] spawn life_fnc_donation";
	...
	class controls {
		...
		class Life_RewardGroup : Life_RscControlsGroup {
			idc = 200908;
			x = 0.5 - (0.08 * 2);
			y = 0.23;
			w = 1 - ((0.5 - (0.08 * 2)) * 2);
			...
			class Controls
			{
				class Life_RewardText: Life_RscStructuredText
				{
					idc = 7510;
					text = "";
					colorBackground[] = {0, 0, 0, 0};
