...
if(_funds > life_atmmoney) then
{
	...
	//[[69, player, format["Bank was robbed and lost %1", life_atmmoney]],"ASY_fnc_logIt",false,false] spawn life_fnc_MP;
	...
	else
{
	if(life_has_insurance) then
	{
		...
		//[[69, player, format["Bank was robbed and lost 0"]],"ASY_fnc_logIt",false,false] spawn life_fnc_MP;
	}
		else
	{
		...
		["atm","take",_funds] call life_fnc_uC;
		//[[69, player, format["Bank was robbed and lost %1", _funds]],"ASY_fnc_logIt",false,false] spawn life_fnc_MP;
	};
};