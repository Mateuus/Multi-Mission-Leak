...
cop_gear set[
	if(life_coprole == "detective") then {1} else {0},
	[_primary,_handgun,_magazines,_uniform,_vest,_backpack,_items,_primitems,_secitems,_handgunitems,_uitems,_vitems,_bitems]
];