...
{
	if (life_money > 0) then {_seizableMoney = life_money} else {_seizableMoney = 0};
...
[[player,_licenses,_inv,_robber,_runner,life_drug_level,life_alcohol_level,_seizableMoney],"life_fnc_copSearch",_cop,false] spawn life_fnc_MP;