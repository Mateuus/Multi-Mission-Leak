class TrunkMenu
{
	...
	class controlsBackground
	{
		...
		class RscPlayerText : EMonkeys_RscText
		{
			idc = -1;
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
	...
	class Controls
	{
		...
		class TakeItem : EMonkeys_RscButtonMenu
		{
			...
			text = "Nehmen";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call EMonkeys_fnc_vehTakeItem;";
			x = 0.19; y = 0.78;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class StoreItem : EMonkeys_RscButtonMenu
		{
			...
			text = "Lagern";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call EMonkeys_fnc_vehStoreItem;";
			x = 0.57; y = 0.78;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class ButtonClose : EMonkeys_RscButtonMenu {
			...
			text = "Schliessen";
			onButtonClick = "closeDialog 0; [0] call SOCK_fnc_updatePartial;";
			x = 0.1;
			y = 0.9 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
