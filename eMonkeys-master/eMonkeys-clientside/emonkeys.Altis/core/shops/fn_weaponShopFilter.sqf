...
switch (_index) do
{
	case 0:
	{
		_config = [_shop] call EMonkeys_fnc_weaponShopCfg;
		{
			_itemInfo = [_x select 0] call EMonkeys_fnc_fetchCfgDetails;
		...
		//((findDisplay 38400) displayCtrl 38405) ctrlSetText "";
		((findDisplay 38400) displayCtrl 38408) ctrlShow false;		//Verkaufen Bild ausblenden
		((findDisplay 38400) displayCtrl 38406) ctrlEnable false; //Verkaufen Button ausblenden
		((findDisplay 38400) displayCtrl 38407) ctrlShow true; //Kaufen Bild ausblenden
		((findDisplay 38400) displayCtrl 38405) ctrlEnable true; //Kaufen Button ausblenden
	...
	case 1:
	{
		...
		//((findDisplay 38400) displayCtrl 38405) ctrlSetText "";
		((findDisplay 38400) displayCtrl 38407) ctrlShow false; //Kaufen Bild ausblenden
		((findDisplay 38400) displayCtrl 38405) ctrlEnable false; //Kaufen Button ausblenden
		((findDisplay 38400) displayCtrl 38408) ctrlShow true;		//Verkaufen Bild ausblenden
		((findDisplay 38400) displayCtrl 38406) ctrlEnable true; //Verkaufen Button ausblenden
		{
			if(!(_x in _listedItems) && _x != "") then
			{
				_itemInfo = [_x] call EMonkeys_fnc_fetchCfgDetails;
