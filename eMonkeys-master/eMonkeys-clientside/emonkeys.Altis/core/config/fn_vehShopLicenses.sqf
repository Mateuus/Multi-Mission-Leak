...
switch (EMonkeys_veh_shop select 0) do
{
	...
	case "civ_log": {_ret = license_civ_log;};
	case "VIP_car": {_ret = license_civ_driver;};
	case "VIP_lkw": {_ret = license_civ_truck;};
	case "VIP_heli": {_ret = license_civ_air;};
	case "adac_air": {_ret = license_civ_air;};
	case "adac_car": {_ret = license_civ_driver;};
	case "ap_air": {_ret = license_civ_air;};
	case "ap_car": {_ret = license_civ_driver;};
	case "ksk_car": {_ret = license_civ_driver;};
	case "ps_car": {_ret = license_civ_driver;};
	case "lz_car": {_ret = license_civ_driver;};
	case "lz_air": {_ret = license_civ_air;};
	case "jet": {_ret = license_civ_jet;};
	case "cop_ship": 
	{
