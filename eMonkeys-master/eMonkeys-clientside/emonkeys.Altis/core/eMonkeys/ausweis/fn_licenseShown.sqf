...
_ausweis = _this select 1;

if(count _ausweis == 0) exitWith {};

_plname = _ausweis select 1;//1608
_name = _ausweis select 2 select 0;//1601
_vorname = _ausweis select 2 select 1;//1600
_gebdatum = _ausweis select 2 select 2;//1602
_stadtsa = _ausweis select 2 select 3;//1604
_geschle = _ausweis select 2 select 4;//1603
_stadt = _ausweis select 2 select 5;//1605
_pass = _ausweis select 2 select 6;//1201
_playerid = _ausweis select 4;//1607
_erstelld = _ausweis select 3;//1606
_licensetext = "";
_display = "";
