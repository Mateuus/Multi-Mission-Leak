...
_unit getVariable["realname",name _unit],[_ret select 0] call EMonkeys_fnc_numberText,[_ret select 1] call EMonkeys_fnc_numberText, _uni,_vest,_bp,_prim,_sec,_attach];
};
ctrlSetText [5904, getPlayerUID _unit];