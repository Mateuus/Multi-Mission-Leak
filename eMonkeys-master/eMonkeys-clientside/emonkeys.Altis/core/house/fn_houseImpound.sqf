...
private["_name", "_exdata", "_setarr", "_price", "_canbuy", "_house_inventory", "_money_val", "__item", "__count", "__impound_money", "_impound_val", "_illegal_value_cop", "__i_item", "__i_value", "__willimpound","_illegalItems"];
...
_house_inventory = [_exdata, "inventory"] call EMonkeys_fnc_houseExtractDataVal;
...
/////////////////refresh lic
//call command
[ [_name, player, _house_inventory, _illegal_value_cop] , "HOUSE_fnc_DBimpound" ,false, false] call EMonkeys_fnc_MP;