...
//get house name
_house_name = [_house_current_exdata, "name"] call EMonkeys_fnc_houseExtractDataVal;
...
//call command
[ [_house_name, player, EMonkeys_house_current_inv] , "HOUSE_fnc_DBapplyInventory" ,false, false] call EMonkeys_fnc_MP;
