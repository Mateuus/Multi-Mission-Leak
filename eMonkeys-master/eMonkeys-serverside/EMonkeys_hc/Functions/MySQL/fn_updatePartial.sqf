...
{ 
 ...
 { 
  ...
  _text = format ["*** UpdatePartial Bargeld | Spieler ID: %1 | Betrag: %2 |",_uid,_value]; 
 ...
 { 
  ...
  _text = format ["*** UpdatePartial Konto | Spieler ID: %1 | Betrag: %2 |",_uid,_value]; 
  [7,_text]call TON_fnc_log; 
 }; 
 ...
 { 
  ...
  _text = format ["*** UpdatePartial Lizenzen | Spieler ID: %1 | Lizenzen: %2 |",_uid,_value]; 
  [7,_text]call TON_fnc_log; 
 }; 
 ...
 { 
  ...
  { 
   ...
   case east: {_query = format["UPDATE players SET med_gear='%1' WHERE playerid='%2'",_value,_uid];}; 
  }; 
 }; 
 ...
 { 
  ...
  _text = format ["*** UpdatePartial Geld | SpielerID: %1 | Bargeld + Konto: %2 | Bargeld: %3 | Konto: %4 |",_uid,_value1,_value2]; 
  [7,_text]call TON_fnc_log; 
 }; 
 ...
 { 
  _value = [_this,2,0,[0]] call BIS_fnc_param; 
  _value = [_value] call DB_fnc_numberSafe; 
  _query = format["UPDATE players SET donatorlvl='%1', lastdonator = CURRENT_TIMESTAMP WHERE playerid='%2'",_value,_uid]; 
 }; 
}; 
