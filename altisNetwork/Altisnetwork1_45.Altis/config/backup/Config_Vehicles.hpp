class CarShops {
    ...
    */
    ...
    class cop_air {
        side = "cop";
        vehicles[] = {
            { "C_Heli_Light_01_civil_F", { "life_coplevel", "SCALAR", 4 } }, //M-900
            { "B_Heli_Light_01_F", { "life_coplevel", "SCALAR", 5 } }, //Hummingbird
			{ "O_Heli_Light_02_unarmed_F", { "life_coplevel", "SCALAR", 6 } }, //Orca
			{ "B_Heli_Transport_01_F", { "life_coplevel", "SCALAR", 7 } }, //Ghost Hawk
        };
    };
