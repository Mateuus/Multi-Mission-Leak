...
class VirtualShops {
    ...
    class med_market {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "toolkit", "fuelFull", "peach", "defibrillator", "snapgun" , "morphine"};
    };
    ...
    class cop {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "gpstracker", "carC4","donuts", "coffee","panicbutton", "spikeStrip", "waterBottle", "rabbit", "apple", "redgull", "toolkit", "fuelFull", "defusekit", "defibrillator", "snapgun" };
    };
