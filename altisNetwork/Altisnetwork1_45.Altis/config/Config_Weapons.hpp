...
class WeaponShops {
    ...
    class gun {
		...
		level[] = { "", "", -1, "" };
		items[] = {
			{ "hgun_Rook40_F", "", 22500, -1 },
			{ "hgun_ACPC2_F", "", 25000, -1 },
			{ "hgun_Pistol_heavy_01_F", "", 30000, -1 },
			{ "hgun_Pistol_heavy_02_F", "", 35000, -1 },
			{ "SMG_05_F", "", 80000, -1 }
		};
		mags[] = {
			{ "9Rnd_45ACP_Mag", "", 1500 },
			{ "11Rnd_45ACP_Mag", "", 1500 },
			{ "6Rnd_45ACP_Cylinder", "", 1500 },
			{ "16Rnd_9x21_Mag", "", 1500 },
            { "30Rnd_9x21_Mag", "", 1500 },
            { "30Rnd_45ACP_Mag_SMG_01", "", 1500 },
            { "30Rnd_9x21_Mag_SMG_02", "", 1500 },
			{ "30Rnd_9x21_Mag_SMG_02", "Protector 9mm", 1500 }
		};
		accs[] = {
			{ "optic_Arco", "ACRO", 2000 },
			{ "optic_Hamr", "RCO", 2000 },
			{ "optic_Aco", "ACO", 2000 },
			{ "optic_ACO_grn", "ACO - Green", 2000 },
			{ "optic_Aco_smg", "ACO - SMG", 2000 },
			{ "optic_ACO_grn_smg", "ACO - Green SMG", 2000 },
	...
	class g8security {
		name = "G8 Security Armoury";
		side = "civ";
		license = "g8security";
		level[]= { "", "", -1, "" };
		items[] = {
			{ "hgun_Rook40_F", "", 4000 },
			{ "SMG_05_F", "Protector 9mm", 50000 },
			{ "arifle_MX_Black_F", "MX Black", 100000 },
			{ "arifle_ARX_ghex_F", "Type 115", 100000 },
			{ "SMG_02_F", "Sting 9mm", 50000 },
			{ "SMG_01_F", "Vermin 45 ACP", 50000 }
		};
		mags[] = {
			{ "16Rnd_9x21_Mag", "", 50 },
			{ "30Rnd_45ACP_Mag_SMG_01", "Vermin Ammo", 100 },
			{ "30Rnd_65x39_caseless_green", "Type 115 Ammo", 2000 },
			{ "30Rnd_9x21_Mag_SMG_02", "9mm Ammo", 100 },
			{ "30Rnd_65x39_caseless_mag", "MX Ammo", 300 }
		};
		accs[] = {
			{ "muzzle_snds_L", "", 1000 },
			{ "optic_MRCO", "MRCO", 2000 },
			{ "optic_Arco", "ACRO", 2000 },
			{ "optic_Hamr", "RCO", 2000 },
			{ "optic_Aco", "ACO", 2000 },
			{ "optic_ERCO_blk_F", "ERCO", 5000 },
			{ "optic_ACO_grn", "ACO - Green", 2000 },
			{ "optic_Aco_smg", "ACO - SMG", 2000 },
			{ "optic_ACO_grn_smg", "ACO - Green SMG", 2000 },
			{ "optic_Holosight", "Holosight", 2000 },
	...
	class blackmarket {
     ...
     items[] = {
			...
			{ "arifle_SDAR_F", "", 150000, -1},
			{ "arifle_Mk20C_F", "", 190000, -1},
			{ "arifle_TRG21_F", "", 200000, -1},
     		{ "arifle_CTAR_hex_F", "", 240000, -1},
    		{ "hgun_Rook40_F", "", 25000, -1 }
        };
    	mags[] = {
			{ "30Rnd_556x45_Stanag_Tracer_Red", "TRG-21 Ammo", 8000 },
			{ "30Rnd_556x45_Stanag_Tracer_Red", "Mk20C Ammo", 8000 },
			{ "20Rnd_556x45_UW_mag", "SDAR-UW Ammo", 8000 },
			{ "30Rnd_9x21_Red_Mag", "Rook Ammo", 8000 }
    	};
    	accs[] = {
    		{ "optic_Arco", "ARCO", 2000 },
			{ "optic_Aco", "ACO", 2000 },
			{ "optic_ACO_grn", "ACO - Green", 2000 },
			{ "optic_Aco_smg", "ACO - SMG", 2000 },
			{ "optic_Holosight", "Holosight", 2000 },
			{ "optic_Holosight_smg", "Holosight - SMG", 2000 },
			{ "acc_pointer_IR", "IR Pointer", 2000 }
		};
	};
    ...
    class rebel {
		...
		mags[] = {
			...
			{ "6Rnd_GreenSignal_F", "Starter Pistol flares", 45000 },
			{ "30Rnd_9x21_Red_Mag", "Rook Ammo", 2500 }
        };
		accs[] = {
            { "optic_Arco", "ARCO", 10000 },
			{ "optic_Hamr", "RCO", 10000 },
			{ "optic_Aco", "ACO", 10000 },
			{ "optic_ACO_grn", "ACO - Green", 10000 },
			{ "optic_Aco_smg", "ACO - SMG", 10000 },
			{ "optic_ACO_grn_smg", "ACO - Green SMG", 10000 },
			{ "optic_Holosight", "Holosight", 20000 },
			{ "optic_Holosight_smg", "Holosight - SMG", 20000 },
			{ "optic_Yorris", "Yorris", 30000 },
			{ "optic_MRD", "MRD", 30000 },
			{ "acc_flashlight", "Flashlight", 9000 },
			{ "acc_pointer_IR", "IR Pointer", 9000 },
			{ "bipod_01_F_khk", "Khaki Bipod", 10000 },
			{ "bipod_01_F_snd", "Sand Bipod", 10000 },
			{ "bipod_01_F_blk", "Black Bipod", 10000 }
		};
	};
    ...
    class rebel_adv {
        ...
        items[] = {
            ...
            { "NVGoggles", "", 2000, 980 },
            { "ItemRadio", "CellPhone", 300, 50 },
			{ "V_PlateCarrierIA1_dgtl", "Carrier Lite LVL3", 30000, -1},
		    { "V_PlateCarrierIA2_dgtl", "GA Rig LVL3", 30000, -1},
		    { "V_PlateCarrier1_rgr", "Carrier Lite LVL3", 30000, -1},
		    { "V_PlateCarrierL_CTRG", "CTRG Carrier LVL3", 30000, -1},
		    { "V_PlateCarrier_Kerry", "US Carrier LVL3", 30000, -1},
			{ "V_PlateCarrierIA2_dgtl", "GA Carrier LVL3", 30000, -1},
			{ "V_HarnessOGL_gry", "SUICIDE VEST", 1500000, { "", "", -1 } },
			...
			{ "arifle_MX_SW_F", "MX SW", 240000, -1},
			{ "LMG_03_F", "LIM-85", 330000, -1},
			{ "LMG_Mk200_F", "Mk200", 350000, -1},
			{ "SmokeShellRed", "Red Smoke", 50000, -1 }
        };
		mags[] = {
			{ "30Rnd_762x39_Mag_Tracer_F", "AKM Ammo", 4000 },
			{ "30Rnd_580x42_Mag_Tracer_F", "CAR-95 Ammo", 2500 },
			{ "30Rnd_65x39_caseless_mag_Tracer", "MX Ammo", 2500 },
			{ "30Rnd_545x39_Mag_Green_F", "AKS-74U Ammo", 2500 },
			{ "30Rnd_556x45_Stanag_Tracer_Red", "TRG-21 Ammo", 2500 },
			...
			{ "20Rnd_556x45_UW_mag", "SDAR-UW Ammo", 2500 },
			{ "30Rnd_65x39_caseless_green_mag_Tracer", "Katiba Carbine Ammo", 2500 },
			{ "200Rnd_65x39_cased_Box_Tracer", "Mk200 Ammo", 17500 },
			{ "100Rnd_65x39_caseless_mag_Tracer", "MX SW Ammo", 12500 },
			{ "200Rnd_556x45_Box_F", "LIM-85 Ammo", 17500 },
			{ "10Rnd_93x64_DMR_05_Mag", "Cyrus Ammo", 5500 },
			{ "30Rnd_556x45_Stanag_Tracer_Yellow", "SPAR-16 Ammo", 2500 },
			{ "150Rnd_556x45_Drum_Mag_Tracer_F", "SPAR-16S Ammo", 2500 },
...
//-- Public Police
    ...
    class cop_1 {
        ...
        items[] = {
			...
			{ "SMG_05_F", "Protector 9mm", 0 },
            { "SMG_01_F", "Vermin", 0 }
        };
        mags[] = {
			{ "30Rnd_45ACP_Mag_SMG_01", "VerminAmmo", 0 },
			{ "30Rnd_9x21_Mag_SMG_02", "9mm Ammo", 0 },
   ...
   // Officer
	class cop_2 {
		...
		accs[] = {
			...
			{ "bipod_01_F_khk", "Khaki Bipod", 25000 },
			{ "bipod_01_F_snd", "Sand Bipod", 25000 },
			{ "bipod_01_F_blk", "Black Bipod", 25000 }
        };
    };
    // Corporal
    class cop_3 {
    ...
    class cop_4 {
        ...
        items[] = {
			...
			{ "arifle_MX_SW_Black_F", "MXSW", 150000 }
    ...
    class cop_5 {
        ...
        items[] = {
			...
			{ "arifle_MX_Black_F", "MX", 0 },
			{ "SMG_05_F", "Protector 9mm", 0 },
			{ "arifle_MX_SW_Black_F", "MXSW", 100000 },
			{ "HandGrenade_Stone", "Flashbang", 5000 },
			{ "arifle_SPAR_01_blk_F", "Spar16", 100000 },
            { "arifle_ARX_blk_F", "Type 115", 100000 }
        };
        mags[] = {
            { "16Rnd_9x21_Mag", "Tazer Rounds", 0 },
            { "30Rnd_45ACP_Mag_SMG_01", "VerminAmmo", 0 },
    ...
    class cop_6 {
        ...
        items[] = {
			...
			{ "arifle_ARX_blk_F", "ARX", 100000 },
			{ "HandGrenade_Stone", "Flashbang", 5000 },
			{ "arifle_SPAR_02_blk_F", "Spar 16s", 100000 },
            { "arifle_SPAR_01_blk_F", "Spar16", 100000 }
        };
        mags[] = {
            { "16Rnd_9x21_Mag", "Tazer Rounds", 0 },
    ...
    class cop_7 {
        ...
        items[] = {
			...
			{ "arifle_ARX_blk_F", "ARX", 100000 },
            { "arifle_SPAR_01_blk_F", "Spar16", 100000 },
            { "srifle_EBR_F", "MK18", 100000 },
			{ "HandGrenade_Stone", "Flashbang", 5000 },
			{ "arifle_SPAR_02_blk_F", "Spar 16s", 100000 },
            { "arifle_SPAR_03_blk_F", "Spar17", 100000 }
        };
        mags[] = {
            { "16Rnd_9x21_Mag", "Tazer Rounds", 0 },
            { "30Rnd_45ACP_Mag_SMG_01", "VerminAmmo", 0 },
	...
	class cop_SCO19 {
        ...
        items[] = {
            ...
            { "arifle_MXM_Black_F", "MXM", 0 },
			{ "arifle_MX_SW_Black_F", "MXSW", 150000 },
			{ "arifle_ARX_blk_F", "ARX", 150000 },
            { "arifle_SPAR_01_blk_F", "Spar16", 150000 },
            { "srifle_EBR_F", "MK18", 150000 },
			{ "arifle_SPAR_02_blk_F", "Spar 16s", 150000 },
            { "arifle_SPAR_03_blk_F", "Spar17", 150000 }
        };
        mags[] = {
            { "16Rnd_9x21_Mag", "Tazer Rounds", 0 },
            { "30Rnd_45ACP_Mag_SMG_01", "VerminAmmo", 0 },
