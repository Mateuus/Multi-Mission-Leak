...
switch (playerSide) do {
	case west: {
        ...
        //-- SeizeMask
        _Btn9 ctrlSetText localize "STR_pInAct_SeizeMask";
        _Btn9 buttonSetAction "[life_pInact_curTarget] call life_fnc_seizeMask; closeDialog 0;";

        //-- Seize communication (Radio + show hint)
        _Btn10 ctrlSetText localize "STR_pInAct_SeizeComms";
        _Btn10 buttonSetAction "[life_pInact_curTarget] call life_fnc_seizeCommsAction; closeDialog 0;";

		//--Seize Money
		_Btn11 ctrlSetText localize "STR_pInAct_SeizeMoney";
		_Btn11 buttonSetAction "[life_pInact_curTarget] call life_fnc_seizeMoneyAction; closeDialog 0;";
