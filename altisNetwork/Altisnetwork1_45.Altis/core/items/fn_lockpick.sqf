...
*/
private["_curTarget","_distance","_isVehicle","_title","_progressBar","_cP","_titleText","_dice","_badDistance","_cpRate","_progress"];
...
if ([life_currentExpPerks, "perk_locksmith_3"] call mav_ttm_fnc_hasPerk) then {
    _cpRate = 0.011;
} else { 
    _cpRate = 0.01;
};
...
for "_i" from 0 to 1 step 0 do {
    ...
    _cP = _cP + 0.01;
    //_cP = _cP + (0.01 * (missionNamespace getVariable ["mav_ttm_var_lockpickMultiplier", 1])); //Level System
...
["VehicleLockpicked"] spawn mav_ttm_fnc_addExp;//Level System