...
while {true} do
    ...
    */
    ...
    //-- Food Display
    ((uiNamespace getVariable "osefStatusBar")displayCtrl 555563)ctrlSetStructuredText parseText
        format["<t shadow='1' shadowColor='#000000'>%1 %",_hunger];

    //-- Drink Display
    ((uiNamespace getVariable "osefStatusBar")displayCtrl 555561)ctrlSetStructuredText parseText
        format["<t shadow='1' shadowColor='#000000'>%1 %",_thirst];

    //-- Health Display
    ((uiNamespace getVariable "osefStatusBar")displayCtrl 555559)ctrlSetStructuredText parseText
        format["<t shadow='1' shadowColor='#000000'>%1 %",_damage];

    //-- Cash Display  
    ((uiNamespace getVariable "osefStatusBar")displayCtrl 555557)ctrlSetStructuredText parseText
        format["<t shadow='1' shadowColor='#000000'>%1",_cash];
    };
};