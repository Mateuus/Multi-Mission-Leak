...
_header = "The Centeral Altis Bank";
_line = "The Central Altis Bank is being robbed by some rebel(s). The police have urged calmness as they respond to the matter, any civilians are to evacuate the area as police will kill on sight";
