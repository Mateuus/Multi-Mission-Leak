...
if (!isNil "_value") exitWith {
    ...
    [format[localize "STR_NOTF_PickedMoney",[_value] call life_fnc_numberText],false,"fast"] call life_fnc_notification_system;
    CASH = CASH + _value;
...
["Test Money Logging","MoneyLog"] call A3Log;
