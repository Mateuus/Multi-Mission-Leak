...
//Giving unknown errors, disabled for now
//[player,life_settings_enableSidechannel,playerSide,license_civ_guerilla,license_civ_corp] remoteExecCall ["TON_fnc_managesc",RSERV];
