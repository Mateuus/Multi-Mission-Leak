...
diag_log "New Player Banks initialized";
...
diag_log "::Life Client:: Survival Setup";
...
diag_log "::Life Client:: Welcome Script Setup";
[] execVM "scripts\welcome.sqf";

diag_log "::Life Client:: Radio Check";
[] spawn life_fnc_radioCheck; //Call for radioCheck

//--- Auto save
//diag_log "::Life Client:: Starting auto save loop.";
//[] spawn life_fnc_altgearsaving;
