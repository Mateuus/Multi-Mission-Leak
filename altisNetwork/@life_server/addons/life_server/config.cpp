...
class CfgFunctions {
    class MySQL_Database {
        ...
        class MySQL
        {
            ...
            class mresString {};
            class updatePartial {};
			class cellPhoneRequest {}; //SQL Phone
			class saveCellPhone {}; //SQL Phone
			class getRealTime {}; //SQL Phone
        };
    };
    ...
    class Life_System {
        ...
        class Jail_Sys {
            ...
            class jailSys {};
            class jailTimer {}; //-- Custom Jail Times
            class jailPlayer {};//-- Custom Jail Times
        };
