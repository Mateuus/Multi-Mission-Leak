...
class lhm_RscControlsGroup {
	...
	class VScrollBar : lhm_RscScrollBar
	{
		width = 0.021;
		autoScrollEnabled = 1;
	};

	class HScrollBar : lhm_RscScrollBar
	{
		height = 0.028;
	};
...
class lhm_RscControlsGroupNoScrollbars : lhm_RscControlsGroup {
...
class lhm_RscListNBox
{
	...
	idcLeft = -1;
	idcRight = -1;
	class ListScrollBar: lhm_RscScrollBar{};
	class ScrollBar: lhm_RscScrollBar{};
};
...
class lhm_RscTitle : lhm_RscText {
	style = 0;
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	colorText[] = {0.95, 0.95, 0.95, 1};
};

class lhm_RscPicture {
	shadow = 0;
	type = 0;
	style = 48;
	sizeEx = 0.023;
...
class lhm_RscTextMulti : lhm_RscText
{
	linespacing = 1;
	style = 0 + 16 + 0x200;
};

class lhm_RscPictureKeepAspect : lhm_RscPicture
{
	style = 0x30 + 0x800;
};

class lhm_RscStructuredText {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class lhm_RscButtonTextOnly : lhm_RscButton {
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	colorBackground[] = {1, 1, 1, 0};
...
class lhm_RscButtonMenu : lhm_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class lhm_RscShortcutButtonMain : lhm_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class lhm_RscBackground : lhm_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
...
class lhm_RscCombo {
	...
	class ComboScrollBar : lhm_RscScrollBar {};
};

class lhm_RscToolbox {
	colorText[] = {0.95, 0.95, 0.95, 1};
	color[] = {0.95, 0.95, 0.95, 1};
