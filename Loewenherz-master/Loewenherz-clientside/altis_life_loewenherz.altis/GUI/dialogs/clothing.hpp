class lhm_Clothing {
	...
	class controls 
	{
		...
		class ClothingList : lhm_RscListBox 
		{
			idc = 3101;
			text = "";
			sizeEx = 0.035;
			onLBSelChanged = "[_this] call lhm_fnc_changeClothes;";
		...
		class PriceTag : lhm_RscStructuredText
		{
			idc = 3102;
			text = "";
			sizeEx = 0.035;
		...
		class TotalPrice : lhm_RscStructuredText
		{
			idc = 3106;
			text = "";
			sizeEx = 0.035;
		...
		class FilterList : lhm_RscCombo
		{
			idc = 3105;
			colorBackground[] = {0,0,0,0.7};
			onLBSelChanged  = "_this call lhm_fnc_clothingFilter";
			x = (1 / 250 / (safezoneW / safezoneH));
			y = 0.5 - (1 / 25);
			w = 0.318;
			h = 0.035;
		...
		class BuyButtonKey : lhm_RscButtonMenu 
		{
			idc = -1;
			text = "$STR_Global_Buy";
			onButtonClick = "[] call lhm_fnc_buyClothes;";
			x = (1 / 250 / (safezoneW / safezoneH));
			y = 0.54 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
