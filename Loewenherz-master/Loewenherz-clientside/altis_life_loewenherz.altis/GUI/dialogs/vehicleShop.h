class lhm_Vehicle_Shop_v2
{
	...
	class controlsBackground
	{
		...
		class RentCar : lhm_RscButtonMenu
		{
			...
			onButtonClick = "[false] spawn lhm_fnc_vehicleShopBuy;";
		...
		class BuyCar : lhm_RscButtonMenu 
		{
			idc = 2309;
			text = "$STR_Global_Buy";
			onButtonClick = "[true] spawn lhm_fnc_vehicleShopBuy;";
	...
	class controls
	{
		class VehicleList : lhm_RscListBox
		{
			...
			onLBSelChanged = "_this call lhm_fnc_vehicleShopLBChange";
		...
		{
			onLBSelChanged ="[] spawn lhm_fnc_vehicleShopDemoSetTexture";
			idc = 2304;
