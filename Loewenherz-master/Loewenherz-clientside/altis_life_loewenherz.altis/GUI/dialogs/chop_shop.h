class Chop_Shop
{
	...
	class controlsBackground
	{
		...
		class priceInfo : lhm_RscStructuredText
		{
			idc = 39401;
			text = "";
			sizeEx = 0.035;
	...
	class controls
	{
		...
		{
			idc = 39402;
			onLBSelChanged = "_this call lhm_fnc_chopShopSelection";
			sizeEx = 0.04;
			x = 0.11; y = 0.25;
			w = 0.3; h = 0.38;
		};
		
		class BtnSell : lhm_RscButtonMenu
		{
			idc = -1;
			text = "$STR_Global_Sell";
			onButtonclick = "[] spawn lhm_fnc_chopShopSell;";
