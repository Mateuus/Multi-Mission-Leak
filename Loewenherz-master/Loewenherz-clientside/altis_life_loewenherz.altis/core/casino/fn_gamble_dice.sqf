...
{ 
    ...
    _image1 ctrlSetStructuredText parseText format["<img size='2.5' image='core\casino\icons\%1'/>", _icons select _idx1 ];
    _image2 ctrlSetStructuredText parseText format["<img size='2.5' image='core\casino\icons\%1'/>", _icons select _idx2 ];
...
['Dice', _return, _gamble_val, _gamble_win_factor, _jackpot_won] call lhm_fnc_gamble;
