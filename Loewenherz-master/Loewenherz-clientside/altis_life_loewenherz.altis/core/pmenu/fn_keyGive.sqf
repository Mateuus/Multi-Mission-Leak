...
hint format["Du hast %1 den Schluessel fuer deinen %2 gegeben",_unit getVariable["realname",name _unit],typeOf _vehicle];
[[_vehicle,_unit,profileName], "TON_fnc_clientGetKey",_unit,false] call lhm_fnc_mp;