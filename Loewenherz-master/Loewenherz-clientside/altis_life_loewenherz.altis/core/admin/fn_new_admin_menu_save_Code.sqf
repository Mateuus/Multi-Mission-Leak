...
if(_sel == -1) exitWith {hint "Du musst einen Platz in der Listbox auswählen!";};
if(ctrltext _EDIT == "") exitWith {hint "Bitte Namen eingeben!"};
_name = ctrltext _EDIT;


profileNamespace setvariable[format["Saved_skripts_%1",_sel],[_name,(compile Code_temp)]];
lbClear _lb_skripts;
Code_temp = nil;
{
	_var = nil;
