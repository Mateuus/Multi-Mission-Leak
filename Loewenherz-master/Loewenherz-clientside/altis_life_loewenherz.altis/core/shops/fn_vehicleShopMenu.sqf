...
if(!createDialog "lhm_Vehicle_Shop_v2") exitWith {};

lhm_veh_shop = [_shop,_spawnpoints,_shopFlag,_disableBuy]; //Store it so so other parts of the system can access it.
...
_vehicleList = [_shop] call lhm_fnc_vehicleListCfg;
