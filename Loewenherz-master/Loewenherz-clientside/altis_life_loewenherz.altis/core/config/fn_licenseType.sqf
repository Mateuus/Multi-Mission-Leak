...
// LHM Alcohol End
			...
			case "uran": {_var = "license_civ_uran"}; // neu
			case "zigarette": {_var = "license_civ_zigarette"}; // neu
			case "hunter": {_var = "license_civ_hunter"}; //bounty hunter
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_uran": {_var = "uran"}; //neu
			case "license_civ_zigarette": {_var = "zigarette"}; //neu
			case "license_civ_hunter": {_var = "hunter"}; //bounty hunter
			case "license_civ_wood": {_var = "wood"}; //bounty hunter
			default {_var = ""};
		};
	};
};

_ret = [_var,(if(_var != "") then {([_var] call lhm_fnc_varToStr)})];
_ret;