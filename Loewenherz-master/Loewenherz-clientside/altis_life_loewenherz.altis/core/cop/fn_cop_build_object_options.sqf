...
_Btn1 ctrlSetText "Umsetzen";
_Btn1 buttonSetAction "closeDialog 0;[] spawn lhm_fnc_cop_build_object_redeploy;";

_Btn2 ctrlSetText "Entfernen";
_Btn2 buttonSetAction "deleteVehicle cursorTarget; closeDialog 0;";
