...
if(_action) then {
	...
	[[_unit,grpPlayer],"TON_fnc_clientGangLeader",_unit,false] call lhm_fnc_mp; //Boot that bitch!
	[[3,grpPlayer],"TON_fnc_updateGang",false,false] call lhm_fnc_mp; //Update the database.
} else {
