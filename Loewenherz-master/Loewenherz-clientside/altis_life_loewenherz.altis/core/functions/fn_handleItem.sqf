...
_preview = param [7,false,[false]];

//Some checks
if (_item isEqualTo "") exitWith {};
_isgun = false;

_details = [_item] call lhm_fnc_fetchCfgDetails;
    ...
    switch (_details select 6) do {
        ...
        case "CfgVehicles": {
            ...
            if (!isNil "_items") then {
                {[_x,true,true,false,true] call lhm_fnc_handleItem; } forEach _items;
            };
        };
                ...
                switch (_details select 5) do {
                        ...
                        if (_ispack) then {
                            ...
                            if (_override) then{
                                ...
                                if (vest player isEqualTo _item && {!_preview}) then {
                                    ...
                                    if (!isNil "_items") then {
                                        {[_x,true,false,false,true] spawn lhm_fnc_handleItem;} forEach _items;
                                    };
                                };
                            };
                        };
                    ...
                    case 201: {
                        if (_ispack) then {
                            ...
                            private "_type";
                            _type = [_item,201] call lhm_fnc_accType;
                            if (_ongun) then {
                                switch (_type) do {
                    ...
                    case 301: {
                        if (_ispack) then {
                            ...
                            private "_type";
                            _type = [_item,301] call lhm_fnc_accType;
                    ...
                    case 101:{
                        if (_ispack) then {
                            ...
                            private "_type";
                            _type = [_item,101] call lhm_fnc_accType;
