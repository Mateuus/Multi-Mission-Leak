...
diag_log format ["Server: Vehicle Respawn - Activate respawn on Unit %1",_unit]; 
...
_unit setDir _dir; 
_unit setVariable["vehicle_info_owners",[["0","EventVehicle"]],true]; 
 
if (_haveinit) then {[[netID _unit, _unitinit], "fnc_setVehicleInit", true, true] call lhm_fnc_mp;}; 
 
if (_hasname) then {[[netID _unit, _unitname], "fnc_setVehicleVarName", true, true] call lhm_fnc_mp;}; 
