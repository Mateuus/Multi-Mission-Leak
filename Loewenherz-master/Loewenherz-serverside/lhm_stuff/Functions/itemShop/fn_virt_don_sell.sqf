...
_index = [_type,LHM_Sell_Array] call TON_fnc_index; 
if(_index == -1) exitWith {}; 
_price = (LHM_Sell_Array select _index) select 1; 
_var = [_type,0] call lhm_fnc_don_varHandle; 
...
if(([false,_type,_amount] call lhm_fnc_don_handleInv)) then 
{ 
