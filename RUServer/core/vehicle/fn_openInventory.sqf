...
if (isNull _vehicle || !("Land_Wreck_Traw2_F" == typeOf _vehicle || "Land_Wreck_Traw_F" == typeOf _vehicle || _vehicle isKindOf "Car" || _vehicle isKindOf "Air" || _vehicle isKindOf "Ship" || _vehicle isKindOf "Box_IND_Grenades_F" || _vehicle isKindOf "B_supplyCrate_F")) exitWith {}; //Either a null or invalid vehicle type.
