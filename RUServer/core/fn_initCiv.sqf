...
civ_sp_oumere = nearestObjects[getMarkerPos  "civ_sp_oumere", _spawnBuildings,350];
civ_sp_rochelle = nearestObjects[getMarkerPos  "civ_sp_rochelle", _spawnBuildings,350];
