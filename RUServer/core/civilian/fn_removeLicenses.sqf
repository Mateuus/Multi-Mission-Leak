...
switch (_state) do {
    ...
    case 3: {
        if (missionNamespace getVariable LICENSE_VARNAME("gun","civ") || missionNamespace getVariable LICENSE_VARNAME("anwalt","civ")) then {
            missionNamespace setVariable [LICENSE_VARNAME("gun","civ"),false];
            missionNamespace setVariable [LICENSE_VARNAME("anwalt","civ"),false];
            hint localize "STR_Civ_LicenseRemove_2";
        };
    };

    case 4: {
        if (missionNamespace getVariable LICENSE_VARNAME("anwalt","civ")) then {
            missionNamespace setVariable [LICENSE_VARNAME("anwalt","civ"),false];
