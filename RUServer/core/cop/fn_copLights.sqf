...
switch (typeOf _vehicle) do
{
	...
	case "I_MRAP_03_F":
    {
        _lightleft lightAttachObject [_vehicle, [-1.3, 1.85, -0.08]];
    };
...
switch (typeOf _vehicle) do
{
	...
	case "I_MRAP_03_F":
    {
        _lightright lightAttachObject [_vehicle, [1.3, 1.85, -0.08]];
    };
    ...
    case "B_Heli_Transport_01_F":
    {
	 ...
	 case "I_Heli_light_03_unarmed_F":
    {
        _lightright lightAttachObject [_vehicle, [1.23, 4.7, -1.421]];
     };
};
