...
/* Database Related Settings */
    ...
    save_vehicle_items[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","hen","rooster","sheep","goat","defibrillator","toolkit" };
...
/* System Settings */
    ...
    news_broadcast_header_length = 150; //Number of characters that a header can consist of. Anything over this may clip. This depends on the font size and various other factors. Adjust with caution.
    ...
    restricted_uniforms[] = { "U_Rangemaster", "U_IG_Guerilla2_1", "U_IG_Guerilla2_3", "U_B_CombatUniform_mcam_tshirt", "U_B_CombatUniform_mcam_worn", "U_B_survival_uniform" };
    restricted_weapons[] = { "hgun_Pistol_heavy_01_snds_F" };
    ...
    bank_med = 65000; //Amount of cash in bank for new medics
    bank_psm = 70000;
    ...
    seize_exempt[] = { "Binocular", "ItemWatch", "ItemCompass", "ItemGPS", "ItemMap", "ItemRadio", "NVGoggles", "FirstAidKit", "ToolKit", "Chemlight_red", "Chemlight_yellow", "Chemlight_green", "Chemlight_blue" }; //Arma items that will not get seized from player inventories
    seize_uniform[] = { "U_Rangemaster", "U_IG_Guerilla2_1", "U_IG_Guerilla2_3", "U_B_CombatUniform_mcam_tshirt", "U_B_CombatUniform_mcam_worn", "U_B_survival_uniform" }; //Any specific uniforms you want to be seized from players
    seize_vest[] = { "V_Rangemaster_belt", "V_TacVest_blk_POLICE", "V_PlateCarrier1_blk", "V_PlateCarrierSpec_blk",  }; //Any specific vests you want to be seized from players
    seize_headgear[] = { "H_Cap_police", "H_Beret_blk_POLICE", "H_HelmetB_plain_mcamo", "H_HelmetSpecB_blk", "H_Beret_Colonel", "H_MilCap_mcamo", "H_Booniehat_mcamo" }; //Any hats or helmets you want seized from players
    seize_minimum_rank = 1; //Required minimum CopLevel to be able to seize items from players
    license_give_rank = 7; //Required minimum CopLevel to be able to give licenses to cops
    ...
    vehicle_purchase_multiplier_CIVILIAN = 2; //Civilian Vehicle Buy Price = Config_Vehicle price * multiplier
    ...
    vehicle_rental_multiplier_CIVILIAN = .8; //Civilian Vehicle Rental Price = Config_Vehicle price * multiplier
    vehicle_rental_multiplier_COP = .125; //Cop Vehicle Rental Price = Config_Vehicle price * multiplier
    ...
    vehicle_storage_fee_multiplier = .0075; //Pull from garage cost --> Cost takes the playersides Buy Price * multiplier
    ...
    crimes[] = {
        {"STR_Crime_187V","200000","187V"}, //Fhrlsiige Tötung
        {"STR_Crime_187","300000","187"}, //Totschlag
        {"STR_Crime_901","80000","901"}, //Ausbruch
        {"STR_Crime_215","100000","215"}, //Versuchter Autodiebstahl
        {"STR_Crime_213","50000","213"}, //Verwendung von illegalem Sprengstoff
        {"STR_Crime_211","50000","211"}, //Raub
        {"STR_Crime_207","100000","207"}, //Entführung
        {"STR_Crime_207A","75000","207A"}, //Versuchte Entführung
        {"STR_Crime_390","10000","390"}, //Öffentlciher Drogenmissbrauch
        {"STR_Crime_487","150000","487"}, //Autodiebstahl
        {"STR_Crime_488","10000","488"}, //kleiner Diebsathl
        {"STR_Crime_480","100000","480"}, //fahreflcuht
        {"STR_Crime_481","50000","481"}, //Drogenbesitz
        {"STR_Crime_482","50000","482"}, //versuchter SDrogenhadnel
        {"STR_Crime_483","80000","483"}, //Drogenhadnel
        {"STR_Crime_459","200000","459"}, //einbruch
        {"STR_Crime_666","20000","666"}, //Steuerhinterziehung
        {"STR_Crime_667","500000","667"}, //Terrorismuss
        {"STR_Crime_668","15000","668"}, //Jagen ohne lizenz
        {"STR_Crime_1","30000","1"}, //Fhre ohne Führeschein
        {"STR_Crime_2","50000","2"}, //Fahren in dei Falsche Richtung
        {"STR_Crime_3","50000","3"}, //Nichtbeachtung der Signale von Polizei zb.
        {"STR_Crime_4","10000","4"}, //geschwidnigkeistüberschreitung
        {"STR_Crime_5","1000","5"}, //Fahren ohe licht
        {"STR_Crime_6","1000","6"}, //Fahren ohen Helm
        {"STR_Crime_7","1500","7"}, //Parksünder
        {"STR_Crime_8","50000","8"}, //Rebellenfahrzeug
        {"STR_Crime_9","100000","9"}, //Schwerer Diebstahl Ziviel
        {"STR_Crime_10","150000","10"}, //Schwerer Diebstahl Dienstfahrzeug
        {"STR_Crime_11","200000","11"}, //Panzerfahrezgu
        {"STR_Crime_12","50000","12"}, //Fliegen über der Stadt unter 200m
        {"STR_Crime_13","75000","13"}, //Starßensperre
        {"STR_Crime_14","10000","14"}, //Offenes Tragen einer legalen Wafffe in Georgetown zb
        {"STR_Crime_15","80000","15"}, //Rebellenwaffe
        {"STR_Crime_16","50000","16"}, //Illegale Kledung
        {"STR_Crime_17","25000","17"}, //Vermummung
        {"STR_Crime_18","100000","18"}, //Beh. Staatsgewalt
        {"STR_Crime_19","25000","19"}, //fahrerlcuht
        {"STR_Crime_20","10000","20"}, //Belediugn
        {"STR_Crime_21","15000","21"}, //Beamtenbelediugn
        {"STR_Crime_22","80000","22"}, //Drogenhadnel
        {"STR_Crime_23","250000","23"}, //bankeinbruach
        {"STR_Crime_24","400000","24"}, //ZivilistenMord
        {"STR_Crime_25","450000","25"}, //Beamtenmord
        {"STR_Crime_26","150000","26"}, //Organhandel
        {"STR_Crime_27","50000","27"}, //Offroadfahren
        {"STR_Crime_28","50000","28"} //Körperverletzung
    };
};
