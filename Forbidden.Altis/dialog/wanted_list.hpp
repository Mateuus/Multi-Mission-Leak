class life_wanted_menu {
	...
	class controls {
		...
		class ListAllButtonKey : Life_RscButtonMenu {
			...
			onButtonClick = "[1] call life_fnc_kmfuioniyrvhklamsmmgkriwayiinyzlrmkdicsezbqkvlayqwkpyrhnzhc;";
		...
		class AddCrimesButtonKey : Life_RscButtonMenu {
			idc = 2408;
			text = "Add crimes";
			tooltip = "Show add crime menu";
			onButtonClick = "[] call life_fnc_zcrjirnjvkjknotbgqiwlevbcpbynefhupzpukratdevxkixrmrrynyduzi;";
		...
		class ExecuteButtonKey : Life_RscButtonMenu {
			idc = 2409;
			text = "Execute";
			tooltip = "Add the selected crime";
			onButtonClick = "[] call life_fnc_xjfhoigbdxrkxcxjcclbmzgryemaunnzdovjdvbdvtgmsdsrxhushap;";
			x = 0.42 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.845 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
