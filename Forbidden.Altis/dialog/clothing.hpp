class Life_Clothing {
	...
	class controls 
	{
		...
		class ClothingList : Life_RscListBox 
		{
			...
			text = "";
			sizeEx = 0.035;
			onLBSelChanged = "[_this] call life_fnc_vjqqxzfbudgplsakqzdmefzbegnzwdaudrdinxzslwgyphiadjqjqzjuwoc;";
		...
		class FilterList : Life_RscCombo
		{
			idc = 3105;
			colorBackground[] = {0,0,0,0.7};
			onLBSelChanged  = "_this call life_fnc_ekdhxeougfpderhtlusakbqvhvbgfzhkddxaiqdlhqsytuovqn";
			x = 0.0822359 * safezoneW + safezoneX;
		...
		class BuyButtonKey : Life_RscButtonMenu 
		{
			idc = -1;
			text = "$STR_Global_Buy";
			onButtonClick = "[] call life_fnc_nqdtemvhevrimsdgiyvcqratmvdamkgdnuptlncwjlfavsjdivwbtghxeid;";
			x = 0.0822359 * safezoneW + safezoneX;
			y = 0.489992 * safezoneH + safezoneY;
			w = (6.25 / 40);
			h = (1 / 25);
