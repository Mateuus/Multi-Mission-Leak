class Life_vehicle_shop {
	...
	class controls {
		...
		class GetCar : life_RscButtonMenu {
			idc = -1;
			text = "$STR_Global_Buy";
			onButtonClick = "[] spawn life_fnc_auwjvfnyizufbiefchyixkudodreiuyfcilujliejphmgdhvcqqqpvvaidej";
		...
		class GetCarGarage : life_RscButtonMenu {
			...
			onButtonClick = "[] spawn life_fnc_auwjvfnyizufbiefchyixkudodreiuyfcilujliejphmgdhvcqqqpvvaidejSave";
