class TrunkMenu
{
	...
	class Controls
	{
		...
		class TakeItem : Life_RscButtonMenu
		{
			...
			text = "$STR_Trunk_Take";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call life_fnc_ccoixsesoyvxatdjelmxgqozzprujpgdrchcbqqkjilmluxbzjusvyo;";
			x = 0.19; y = 0.78;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class StoreItem : Life_RscButtonMenu
		{
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call life_fnc_xmuonepofabrjctiqwqnpxaupificzzyhskilbfkyaqjuavpct;";
			x = 0.57; y = 0.78;
			w = (6.25 / 40);
			h = (1 / 25);
		};
