...
class Life_RscButtonPerks : Life_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class Life_RscButtonPerkButton : Life_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
	...
	animTextureDefault = "#(argb,8,8,3)color(1,1,1,1)";
	colorBackground[] = {0,0,0,0.8};
	colorBackgroundFocused[] = {0.6,0.6,0.6,0.8};
	colorBackground2[] = {0.4,0.4,0.4,0.8};
	color[] = {1,1,1,1};
	colorFocused[] = {1,1,1,1};
	color2[] = {0,0,0,1};
	colorText[] = {1,1,1,1};
