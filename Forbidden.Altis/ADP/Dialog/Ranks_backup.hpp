...
class ADPRanks
{
	...
	class Controls 
	{
		...
		class ADP_BUTTONCUSTOM12231: ADPRscButtonMenu
		{
			idc = 1782;
		...
		class ADP_BUTTONCUSTOM87: ADPRscButtonMenu
		{
			idc = 1690;
			text = "Rebell Boss"; 
			...
			w = 0.0876563 * safezoneW;
			h = 0.022 * safezoneH;
			tooltip = "Set player to the rebel leader rank";
			theAction = "[2,6] call ADP_fnc_ncazzlexqozsjpqvgtivxzraxmovzxzvzavtfugjcwrjyckykfkll";
			adminlevel = 4;
			reblevel = 6;
		};
		
		class ADP_BUTTONCUSTOM666: ADPRscButtonMenu
		{
			idc = 7231;
			text = "Legionär"; 
			x = 0.613437 * safezoneW + safezoneX;
		...
		class ADP_BUTTONCUSTOM667: ADPRscButtonMenu
		{
			idc = 7232;
			text = "Centurion"; 
			x = 0.613437 * safezoneW + safezoneX;
		...
		class ADP_BUTTONCUSTOM668: ADPRscButtonMenu
		{
			idc = 7233;
			text = "Optio"; 
			x = 0.613437 * safezoneW + safezoneX;
		...
		class ADP_BUTTONCUSTOM88: ADPRscButtonMenu
		{
			idc = 1691;
			text = "Fullvärdig"; 
			x = 0.613437 * safezoneW + safezoneX;
			...
			w = 0.0876563 * safezoneW;
			h = 0.022 * safezoneH;
			tooltip = "Set player to the rebel member rank";
		...
		class ADP_BUTTONCUSTOM89: ADPRscButtonMenu
		{
			...
			w = 0.0876563 * safezoneW;
			h = 0.022 * safezoneH;
			tooltip = "Set player to the rebel recruit rank";
		...
		class ADP_BUTTONCUSTOM90: ADPRscButtonMenu
		{
			...
			w = 0.0876563 * safezoneW;
			h = 0.022 * safezoneH;
			tooltip = "Remove player from the rebel whitelist";
		...
		class ADP_BUTTONCUSTOM14431: ADPRscButtonMenu
		{
			idc = 1781;
