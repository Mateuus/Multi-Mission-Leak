class CompensatePlayer {
	idd = 9920;
	name= "life_admin_compensate_give";
	movingEnable = false;
	enableSimulation = true;
	onLoad = "[] spawn {waitUntil {!isNull (findDisplay 9920)}; ((findDisplay 9920) displayCtrl 9921) ctrlSetText ""Compesate amount:""};";
	...
	class controls {
		...
		class AdminCompensVer : Life_RscButtonMenu {
			...
			onButtonClick = "[] call ADP_fnc_Compensate;";
			x = 0.27;
			y = 0.40;
			w = (6.25 / 40);
			h = (1 / 25);
