/*
	File: fn_Station_Essence.sqf
	Author: NiiRoZz

	Description:
	Add action fuel action in Station Service.
*/
private ["_Station_Essence","_pumpClass","_pump"];
_Station_Essence = [
...
_pumpClass = "Land_fs_feed_F";
{
	...
	_pump addAction [localize "STR_Action_Pump", ES_fnc_FuelStatOpen, 1, 3, true, true, "", ' _this distance _target < 5 && cursorTarget == _target '];
} forEach _Station_Essence;
