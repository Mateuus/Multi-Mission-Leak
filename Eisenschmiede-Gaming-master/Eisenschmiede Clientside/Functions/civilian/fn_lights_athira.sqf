if (ES_kw_athira) exitWith {hint "Du hast das Kraftwerk bereits ausgeschaltet"};
...
if(playerSide == civilian) then
{
	...
	[[0,format["!!! %1 hat das Kraftwerk in Athira ausgeschaltet !!!", name player]],"ES_fnc_broadcast",west,false] spawn ES_fnc_MP;
	sleep 300;
	ES_kw_athira = false;
};