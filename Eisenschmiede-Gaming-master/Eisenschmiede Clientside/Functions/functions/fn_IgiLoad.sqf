...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Vehicles_HEMTT = ["B_Truck_01_mover_F","B_Truck_01_covered_F", "B_Truck_01_transport_F", "B_Truck_01_box_F", "Marinir_Truck_01_box_FG", "Marinir_Truck_01_transport_FG", "Marinir_Truck_01_covered_FG", "B_mas_mar_Truck_01_covered_F", "B_mas_mar_Truck_01_transport_F"];
	...
	IL_Supported_Barrel = ["Land_BarrelEmpty_F", "Land_BarrelEmpty_grey_F", "Land_BarrelSand_F", "Land_BarrelSand_grey_F", "Land_BarrelTrash_F", "Land_BarrelTrash_grey_F", "Land_BarrelWater_F", "Land_BarrelWater_grey_F"];//, "Land_MetalBarrel_empty_F", "MetalBarrel_burning_F"];
	...
	IL_Supported_Cargo_Veh_Offroad = IL_Supported_Quadbike + IL_Supported_Veh_Ammo;
	IL_Supported_Cargo_NonVeh_Offroad = (IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + IL_Supported_Box_H1 + IL_Supported_Box_H2 + IL_Supported_Veh_Ammo);// - ["Land_WaterTank_F"];
	...
	IL_Supported_Cargo_NonVeh_Kamaz = IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Veh_Ammo + IL_Supported_Tank + IL_Supported_Box_H1 + IL_Supported_Box_H2 + IL_Supported_Cargo20;
	IL_Supported_Cargo_Kamaz = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_Cargo_NonVeh_Kamaz;
	
	IL_Supported_Cargo_Veh_HEMTT = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_Hunter + IL_Supported_Ifrit + IL_Supported_Strider + IL_Supported_Hatchback;
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Load cargo on CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Lastfahrzeug auf CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='icons\unload_para.paa' /><t color=""#b200ff""> Eject</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\unload.paa' /><t color=""#ff0000"">  Entladen von CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='icons\unload_para.paa' /><t color=""#b200ff"">  Fahrzeug rauswerfen mit Fallschirm</t>",
	{
	...
	_obj_main addAction [
	"<img image='icons\unload_all_para.paa' /><t color=""#a50b00"">  Unload ALL cargo with parachute</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#ffffff"">Deaktivieren Co-Pilot Lade von aussen</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#ffffff"">Deaktivieren Lade von aussen</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_CHINOOK) then
{
	...
	{
		_obj_main addAction [
		"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Load cargo on Chinook</t>",
		{
		...
		_obj_main addAction [
		"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Lastfahrzeug auf Chinook</t>",
		{
		...
		_obj_main addAction [
		"<img image='Images\Icons\unload.paa' /><t color=""#ff0000"">  Entladen von Chinook</t>",
		{
			[_this select 0] call IL_Do_Unload;
		},[],IL_Action_LU_Priority,false,true,"",
...
//		"('Cargo' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (((getPosATL _target) select 2) >= IL_Para_Jump_ATL) && (_target animationPhase 'ramp_bottom' < 0.1) && (_target getVariable 'usable_ramp')"
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Load cargo on C-130J</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Lastfahrzeug auf C-130J</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\unload.paa' /><t color=""#ff0000"">  Unload cargo from C-130J</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_C17) then
{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Load cargo on C17</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Lastfahrzeug auf C17</t>",
	{
		[_this select 0, IL_Supported_Cargo_C17] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	...
	_obj_main addAction [
	"<img image='Images\Icons\unload.paa' /><t color=""#ff0000"">  Entladen von C17</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_MH9) then
{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Load cargo on left MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Load cargo on right MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\unload.paa' /><t color=""#ff0000"">  Entladen von links MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\unload.paa' /><t color=""#ff0000"">  Entladen von rechts MH-9</t>",
	{ 
...
///////////////////////////
	_obj_main addAction [
	"<img image='icons\unload_para.paa' /><t color=""#b200ff"">  Fahrzeug rauswerfen mit Fallschirm links MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='icons\unload_para.paa' /><t color=""#b200ff""> Fahrzeug rauswerfen mit Fallschirm rechts MH-9</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_OFFROAD) then
{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Load cargo on Offroad</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Lastfahrzeug auf Offroad</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\unload.paa' /><t color=""#ff0000"">  Entladen von Offroad</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_VAN) then
{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Load cargo on VAN</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Lastfahrzeug auf VAN</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\unload.paa' /><t color=""#ff0000"">  Entladen von VAN</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_KAMAZ) then
{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Load cargo on ZAMAK</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Lastfahrzeug auf ZAMAK</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\unload.paa' /><t color=""#ff0000"">  Entladen von ZAMAK</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_TEMPEST) then
{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Load cargo on TEMPEST</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Lastfahrzeug auf TEMPEST</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\unload.paa' /><t color=""#ff0000"">  Entladen von TEMPEST</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_HEMTT) then
{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Load cargo on HEMTT</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\load.paa' /><t color=""#007f0e"">  Lastfahrzeug auf HEMTT</t>",
	{
	...
	_obj_main addAction [
	"<img image='Images\Icons\unload.paa' /><t color=""#ff0000"">  Entladen von HEMTT</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
