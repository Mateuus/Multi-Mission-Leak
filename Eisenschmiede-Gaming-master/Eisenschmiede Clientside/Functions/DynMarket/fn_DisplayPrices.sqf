...
if (!isNil "DYNMARKET_pricesOld") then {_itemArrayOld = DYNMARKET_pricesOld select (([_type,DYNMARKET_prices] call ES_fnc_index))} else {_itemArrayOld=["",0];};

_index = [_type,DYNMARKET_prices] call ES_fnc_index;
