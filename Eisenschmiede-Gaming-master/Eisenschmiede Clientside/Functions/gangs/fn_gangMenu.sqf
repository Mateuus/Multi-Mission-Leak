...
if(isNull (findDisplay 2620)) then {
	if(!(createDialog "ES_My_Gang_Diag")) exitWith {}; //NOOOOOOOOOOOOOOOOOOOOOOOoooooooooooooOOOOOOOOOOOOOOOOOOOOOOOOOOO00000000000000oooooo
};
...
(CONTROL(2620,2629)) ctrlSetText format ["Name: %1",_gangName];
(CONTROL(2620,9876)) ctrlSetText format ["Max. Member: %1",_gangMax];
(CONTROL(2620,601)) ctrlSetText format[(localize "STR_GNOTF_Funds")+ " $%1",[_gangBank] call ES_fnc_numberText];
