...
class ES_RscControlsGroup {
	...
	class VScrollBar : ES_RscScrollBar
	{
		width = 0.021;
		autoScrollEnabled = 1;
	};
	
	class HScrollBar : ES_RscScrollBar
	{
		height = 0.028;
	};
...
class ES_RscControlsGroupNoScrollbars : ES_RscControlsGroup {
...
class ES_RscListNBox
{
	...
	autoScrollDelay = 5;
	autoScrollRewind = 0;
	class ListScrollBar: ES_RscScrollBar{};
	class ScrollBar: ES_RscScrollBar{};
};
...
class ES_RscTextMulti : ES_RscText
{
	linespacing = 1;
	style = 0 + 16 + 0x200;
};

class ES_RscPictureKeepAspect : ES_RscPicture 
{
	style = 0x30 + 0x800;
};

class ES_RscStructuredText {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class ES_RscButtonTextOnly : ES_RscButton {
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	colorBackground[] = {1, 1, 1, 0};
...
class ES_RscButtonMenu : ES_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class ES_RscButtonInvisible : ES_RscButtonMenu {
...
class ES_RscShortcutButtonMain : ES_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class ES_RscBackground : ES_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
...
class ES_RscCombo {
	...
	class ComboScrollBar : ES_RscScrollBar {};
};
