...
_vehicleColor = SEL(SEL(M_CONFIG(getArray,"CfgVehicles",_className,"textures"),SEL(_dataArr,1)),0);
...
(CONTROL(2800,2803)) ctrlSetStructuredText parseText format[
	...
	",
[_retrievePrice] call ES_fnc_numberText,
[_sellPrice] call ES_fnc_numberText,
