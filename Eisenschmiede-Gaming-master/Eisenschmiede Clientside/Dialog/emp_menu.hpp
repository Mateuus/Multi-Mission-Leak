class nanoEMPConsole {
	...
	onLoad = "[] spawn ES_fnc_openEmpMenu;";
	...
	class controls {
		...
		class PlayerBInfo : ES_RscStructuredText
		{
			idc = 2903;
			text = "";
			x = 0.42;
		...
		class Refresh : ES_RscButtonMenu {
			idc = -1;
			text = "Suchen";
			onButtonClick = "[] spawn ES_fnc_scanVehicles;";
		...
		/*class WarnEMP : ES_RscButtonMenu {
			idc = 2030;
			text = "Warnen";
			onButtonClick = "";
		...
		class ExecEMP : ES_RscButtonMenu {
			idc = 2070;
			text = "Auslösen";
			onButtonClick = "[] spawn ES_fnc_empVehicle;";
		...
		class WarnEMP : ES_RscButtonMenu {
			idc = 2060;
			text = "Warnen";
			onButtonClick = "[] spawn ES_fnc_warnVehicle;";
