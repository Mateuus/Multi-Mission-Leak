...
class uuiMHz {
 ...
 class VScrollBar : GhsUvGNr
 {
 width = 0.021;
 autoScrollEnabled = 1;
 };

 class HScrollBar : GhsUvGNr
 {
 height = 0.028;
 };
...
class CPmaa
{
 ...
 idcLeft = -1;
 idcRight = -1;
 class ListScrollBar: GhsUvGNr{};
 class ScrollBar: GhsUvGNr{};
};
...
class ryeG
{
 ...
 colorHover[] = { 1, 1, 1, 0.7 }; 
 colorPressed[] = { 1, 1, 1, 0.7 }; 
...
class Cccrn
{
 ...
 class LineMarker {
 lineWidthThin = 0.008000;
 lineWidthThick = 0.014000;
 lineDistanceMin = 0.000030;
 lineLengthMin = 5;
 };
