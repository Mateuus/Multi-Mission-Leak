...
class OE_Life_Browse_Gang_Diag {
	idd = 2520;
...
class OE_Life_Create_Group_Diag {
	idd = 2520;
...
class OE_Life_Gang_Prompt
{
	...
	class controls 
	{
		...
		class life_gang_browse : Life_RscButtonMenu {
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "closeDialog 0; createDialog ""OE_Life_Browse_Gang_Diag""";
		...
		class life_gang_create_button : Life_RscButtonMenu {
			...
			text = "$STR_Gang_Create";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "closeDialog 0; createDialog ""OE_Life_Create_Group_Diag""; ctrlShow[2522,true]";
