		...
		if (isDedicated) then
			{
				...
				if(D41_ChanceN <= 5) then
					{
						...
						if(D41_WMod == 1)	then {D41_Nebel = [0.4, 0.1,10];		D41_Regen = 0.2;	D41_Vorschau = 0.3;};
						if(D41_WMod == 2)	then {D41_Nebel = [0.3, 0.1,10];		D41_Regen = 0.2;	D41_Vorschau = 0.2;}; //geht so, akzeptabler Nebel
						if(D41_WMod == 3)	then {D41_Nebel = [0.3, 0.1,15];	D41_RegenCounter = 0;}; //Dicht
						if(D41_WMod == 4)	then {D41_Nebel = [0.3, 0.1,15];	D41_Regen = 0.2;	D41_Vorschau = 0.4;};
						if(D41_WMod == 5)	then {D41_Nebel = [0.2, 0.1,15];	D41_RegenCounter = 0;}; //geht so, akzeptabler Nebel
						if(D41_WMod == 6)	then {D41_Nebel = [0.2, 0.1,30];	D41_RegenCounter = 0;};
						if(D41_WMod == 7)	then {D41_Nebel = [0.2, 0.1,30];	D41_Regen = 0.2;	D41_Vorschau = 0.5;};
						if(D41_WMod == 8)	then {D41_Nebel = [0.1, 0.1,30];	D41_RegenCounter = 0;}; //geht so, akzeptabler Nebel
				...
				if(D41_ChanceN >=6 && D41_ChanceN <= 35 && D41_RegenCounter == 0) then
					{
						...
						if(D41_WMod == 7)	then {D41_Nebel = 0.1;	D41_Wellen = 1;		D41_Vorschau = 0.5; D41_Wind = [2, 4, true];	D41_Regen = 0.2;};
						if(D41_WMod == 8)	then {D41_Nebel = 0.1;	D41_Wellen = 1;		D41_Vorschau = 0.4; D41_Wind = [3, 2, true];	D41_Regen = 0.2;};
						if(D41_WMod == 9)	then {D41_Nebel = 0.1;	D41_Wellen = 1;		D41_Vorschau = 0.4; D41_Wind = [2, 1, true];	D41_Regen = 0.1;};
					};
				...
				if(D41_ChanceN >=36 && D41_ChanceN <= 90) then
				{
					...
					D41_WMod = round(random 9);
					if(D41_WMod == 0)	then {D41_Vorschau = 0.9;	D41_Wind = [3, 0, true];};
					if(D41_WMod == 1)	then {D41_Vorschau = 0.9;	D41_Wind = [0, 3, true];};
					if(D41_WMod == 2)	then {D41_Vorschau = 0.7;	D41_Wind = [2, 3, true];};
					if(D41_WMod == 3)	then {D41_Vorschau = 0.7;	D41_Wind = [3, 2, true];};
					if(D41_WMod == 4)	then {D41_Vorschau = 0.6;	D41_Wind = [0, 3, true];};
					if(D41_WMod == 5)	then {D41_Vorschau = 0.6;	D41_Wind = [2, 0, true];};
					if(D41_WMod == 6)	then {D41_Vorschau = 0.5;	D41_Wind = [2, 2, true];};
					if(D41_WMod == 7)	then {D41_Vorschau = 0.5;	D41_Wind = [2, 0, true];};
					if(D41_WMod == 8)	then {D41_Vorschau = 0.4;	D41_Wind = [0, 2, true];};
					if(D41_WMod == 9)	then {D41_Vorschau = 0.4;	D41_Wind = [1, 1, true];};
