...
if(_type == "country1") then {
	if(license_country2) then {
		license_country2 = false;
		hint "Your Pyrgos Utd. Passport has been revoked."; 
	};
};

if(_type == "country2") then {
	if(license_country1) then {
		license_country1 = false;
		hint "Your Neochori Fed. Passport has been revoked."; 
	};
};
