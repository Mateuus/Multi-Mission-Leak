...
switch (_var) do
{
	...
	case "license_cop2_air": {(localize "STR_License_Cop2Air")};
	case "license_cop2_car": {(localize "STR_License_Cop2Car")};
	case "license_country1": {(localize "STR_License_Country1")};
	case "license_country2": {(localize "STR_License_Country2")};
	case "license_civ_vigilante": {(localize "STR_License_Vigilante")};
