...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "cop2_air": {_var = "license_cop2_air"};
			case "cop2_car": {_var = "license_cop2_car"};
			case "country1": {_var = "license_country1"};
			case "country2": {_var = "license_country2"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_cop2_air": {_var = "cop2_air"};
			case "license_cop2_car": {_var = "cop2_car"};
			case "license_country1": {_var = "country1"};
			case "license_country2": {_var = "country2"};
