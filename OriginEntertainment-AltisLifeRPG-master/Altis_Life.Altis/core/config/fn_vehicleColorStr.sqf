...
switch (_vehicle) do
{
	...
	case "C_Offroad_01_F" :
	{
		switch (_index) do
		{
			...
			case 15: {_color = "ShelbyRed"};
			case 16: {_color = "ShelbyBlue"};
			case 17: {_color = "ShelbyWhite"};
		};
	};
	...
	case "C_Hatchback_01_sport_F":
	{
		switch(_index) do
		{
			...
			case 5: {_color = "Green"};
			case 6: {_color = "Med"};
			case 7: {_color = "Nature"};
			case 8: {_color = "OrangeCube"};
		};
	};
