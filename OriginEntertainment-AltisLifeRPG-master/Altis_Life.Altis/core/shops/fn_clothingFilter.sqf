...
_clothes = switch (life_clothing_store) do
{
	...
	case "cop2": {[_selection] call life_fnc_clothing_cop2;}; //Kai
	case "news": {[_selection] call life_fnc_clothing_news;};//Kai
	case "law": {[_selection] call life_fnc_clothing_law;};	//Kai
};
