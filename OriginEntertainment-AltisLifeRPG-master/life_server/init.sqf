...
life_radio_east = radioChannelCreate [[0, 0.95, 1, 0.8], "Side Channel", "%UNIT_NAME", []];  //Kai
...
[] execVM "\life_server\Functions\DynMarket\fn_config.sqf";  //Kai
