...
_query = switch(_side) do {
	...
	case east: {_returnCount = 9; format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, cop2_licenses, cop2level, cop2_gear FROM players WHERE playerid='%1'",_uid];};
};
