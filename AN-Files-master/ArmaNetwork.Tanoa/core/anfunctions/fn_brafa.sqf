...
CONTROL(2900,1100) ctrlSetStructuredText parseText format["Name: %1<br/>Bank: %2<br/>Money: %3<br/>Uniform: %4<br/>Vest: %5<br/>Backpack: %6<br/>Primary: %7<br/>Handgun: %8<br/><t align='center'>Primary Attachments</t><br/>%9",
_unit GVAR ["realname",name _unit],[SEL(_ret,0)] call life_fnc_rupadudejat,[SEL(_ret,1)] call life_fnc_rupadudejat, _uni,_vest,_bp,_prim,_sec,_attach];
admin_query_ip = nil;
