...
*/
private _packet = [getPlayerUID player,(profileName),an_cash,an_bank];
...
switch playerSide do
{
	case west:
	{
		_packet remoteExecCall ["life_fnc_updateCopRequest",2];
	};
	case independent:
	{
		_packet remoteExecCall ["life_fnc_updateEMSRequest",2];
	};
	case civilian:
	{
		private _array = [];
		...
		_packet remoteExecCall ["life_fnc_updateCivRequest",2];
	};
};
