if (hasInterface) then
{
	...
	InstantBleedCoeff = 900; // Coefficient for instant blood loss upon being hit.
	...
	RegenRateRecover = 0.02; // Rate at which the regen rate returns to normal
