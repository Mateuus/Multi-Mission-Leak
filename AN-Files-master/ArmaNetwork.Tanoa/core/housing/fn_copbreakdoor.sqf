...
if(!([_uid] call life_fnc_steguzachap)) exitWith {hint localize "STR_House_Raid_OwnerOff"};
...
[[2,"STR_House_Raid_NOTF",true,[(_house getVariable "house_owner") select 1]],"life_fnc_brusathusek",true,false] call life_fnc_MP;

player switchMove "AinvPknlMstpSnonWnonDnon_medic_1";
for "_i" from 0 to 1 step 0 do {
	if(animationState player != "AinvPknlMstpSnonWnonDnon_medic_1") then {
		[[player,"AinvPknlMstpSnonWnonDnon_medic_1"],"life_fnc_yufanuyaw",true,false] call life_fnc_MP;
