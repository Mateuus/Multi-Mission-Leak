	...
	class controls {
		...
		*/
		...
		class ButtonMyGang : Life_RscButtonMenu {
			idc = 2011;
			text = "$STR_PM_MyGang";
			onButtonClick = "if(isNil ""life_action_gangInUse"") then {if(isNil {(group player) getVariable ""gang_owner""}) then {createDialog ""Life_Create_Gang_Diag"";} else {[] spawn life_fnc_hucruphu;};};";
		...
		class ButtonGovernor : Life_RscButtonMenu {
			idc = -1;
			text = "Moves Menu";
