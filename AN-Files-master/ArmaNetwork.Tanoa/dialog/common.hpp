...
class Life_RscButtonMenuClose: LIfe_RscButtonMenu
{
...
class notification: Life_RscControlsGroupNoScrollbars
{
	idc = -1;
    ...
    class controls 
    {
        ...
        {
            idc = 102;
            text = "Testing One Two Three Four Five Six Seven Eight Nine Ten Eleven Twelve Thirteen"; //--- ToDo: Localize;
            x = 0;//.0101562 * safezoneW + safezoneX;
            y = 0;//.214 * safezoneH + safezoneY;
            w = 0.283594 * safezoneW;
            h = 0.022 * safezoneH;
