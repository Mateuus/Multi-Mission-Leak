...
switch(playerSide) do {
	case west: {
		...
		_vehicle setVariable["emergencyVehicle",true,true];
	...
	case civilian:
	{
		...
		if(player getVariable["undercoverOfficer",false]) then
		{
			_vehicle setVariable["emergencyVehicle",true,true];
			_vehicle setVariable["copCar",true,true];
		};
	...
	case independent:
	{
		...
		_vehicle setVariable["emergencyVehicle",true,true];
		_vehicle setVariable["medicCar",true,true];
	};
};

//Set all doors to closed
_vehicle setVariable["openLF",false,true];
_vehicle setVariable["openRF",false,true];
_vehicle setVariable["openLM",false,true];
_vehicle setVariable["openRM",false,true];
_vehicle setVariable["openLB",false,true];
_vehicle setVariable["openRB",false,true];
_vehicle setVariable["openL",false,true];
_vehicle setVariable["openR",false,true];
_vehicle setVariable["openMohawkL",false,true];
_vehicle setVariable["openMohawkR",false,true];
_vehicle setVariable["openTrunk",false,true];
