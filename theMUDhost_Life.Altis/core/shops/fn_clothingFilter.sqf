...
_clothes = switch (life_clothing_store) do
{
	...
	case "journalist": {[_selection] call life_fnc_clothing_journalist;};
	case "c3": {[_selection] call life_fnc_clothing_c3;};
	case "bh": {[_selection] call life_fnc_clothing_bh;};
	case "uc": {[_selection] call life_fnc_clothing_uc;};
};
