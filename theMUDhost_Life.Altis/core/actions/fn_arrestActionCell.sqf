...
if(!(_unit getVariable "restrained") && !(_unit getVariable "zipTie")) exitWith {}; //He's not restrained.
...
if(isNull _unit) exitWith {}; //Not valid
detach _unit;
[[_unit,false,_time],"life_fnc_jailCell",_unit,false] spawn life_fnc_MP;
