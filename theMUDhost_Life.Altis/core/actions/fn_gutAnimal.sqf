...
life_action_inUse = true;
 switch(typeOf _animalCorpse) do {
	case "Hen_random_F": {_displayName = "Chicken"; _item = "chicken_meat";};
	case "Cock_random_F": {_displayName = "Rooster"; _item = "chicken_meat";};
	case "Goat_random_F": {_displayName = "Goat"; _item = "goat_meat";};
	case "Sheep_random_F": {_displayName = "Sheep"; _item = "sheep_meat";};
	case "Rabbit_F": {_displayName = "Rabbit"; _item = "rabbit_meat";};
...
if(([true,_item,1] call life_fnc_handleInv)) then {
	...
	titleText [format["You have collected some %1 meat",_displayName],"PLAIN"];
} else {
