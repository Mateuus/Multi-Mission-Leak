...
if(isNull _vehicle OR !(_vehicle isKindOf "Car" OR _vehicle isKindOf "Air" OR _vehicle isKindOf "Ship" OR _vehicle isKindOf "House_F" OR (typeOf _vehicle in["IG_supplyCrate_F","Box_NATO_Grenades_F","Land_Cargo40_cyan_F","Land_Cargo40_red_F"]))) exitWith { hint "Something went wrong here.";}; //Either a null or invalid vehicle type.
