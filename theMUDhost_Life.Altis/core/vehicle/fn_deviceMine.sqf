...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","rye_1","hops_1","yeast_1","orange_1","orange_2","orange_3","orange_4","strawberry_1","strawberry_2","strawberry_3","strawberry_4","blueberry_1","blueberry_2","blueberry_3","blueberry_4"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["orange_1","orange_2","orange_3","orange_4"]): {"orange"};
	case (_zone in ["strawberry_1","strawberry_2","strawberry_3","strawberry_4"]): {"strawberry"};
	case (_zone in ["blueberry_1","blueberry_2","blueberry_3","blueberry_4"]): {"blueberry"};
