...
*/
private["_curTarget","_distance","_isVehicle","_title","_progressBar","_cP","_titleText","_dice","_badDistance","_alarmchance"];
...
if(_alarmchance >= 70) then
{
	hint "You have tripped the vehicles alarm!";
	[[_curTarget],"life_fnc_CarAlarm",nil,true] spawn life_fnc_MP;
};
