...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "taxi": {_var = "license_civ_taxi"}; //Taxi License
			...
			case "joint": {_var = "license_civ_marijuana"};
			case "bh": {_var = "license_civ_bh"};
			case "c3": {_var = "license_civ_c3"};
			case "lawyer": {_var = "license_civ_lawyer"};
			case "undercover": {_var = "license_civ_uc"};
			
			// Passports
			case "passportEast": {_var = "license_civ_passportEast"};
			case "passportWest": {_var = "license_civ_passportWest"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_taxi": {_var = "taxi"}; //Taxi License
