class Life_my_smartphone {
	...
	class controls {
		...
		class TaxiMenu : Life_RscButtonMenu {
			idc = 887893;
			text = "TAXI MENU"; //--- ToDo: Localize;
			onButtonClick = "if (license_civ_taxi) then { [] spawn life_fnc_openTaxiMenu; } else { hint ""You are NOT a taxi driver!""; };";
		...
		class CallTaxi : Life_RscButtonMenu {
			idc = 887894;
...
class Life_smartphone_notruf {
	...
	class controls {
		...
		class AlertMsgAll : life_RscButtonMenu
		{
			idc = 888902;
			text = "$STR_CELL_AlertMsgAll";
			colorBackground[] = {0.584, 0.086, 0.086,1.0};
		...
		class WarMsgAll : life_RscButtonMenu
		{
			idc = 888901;
			text = "$STR_CELL_WarMsgAll";
			colorBackground[] = {0.584, 0.086, 0.086,1.0};
		...
		class PurgeMsgAll : life_RscButtonMenu
		{
			idc = 888900;
			text = "$STR_CELL_PurgeMsgAll";
			colorBackground[] = {0.584, 0.086, 0.086,1.0};
