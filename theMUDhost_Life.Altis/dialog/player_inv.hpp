...
class playerSettings {
	...
	class controls {
		...
		*/
		...
		class ButtonSkills : Life_RscButtonMenu {
			idc = 2026;
			text = "$STR_PM_Skills";
		...
		class ButtonUCDuty : Life_RscButtonMenu {
			idc = 2027;
			text = "$STR_PM_UCDuty";
			onButtonClick = "[] call life_fnc_goUndercover;";
			x = 0.1;
			y = 0.850;
			w = (6.25 / 40);
			h = (1 / 25);
		...
		class ButtonUCWanted : Life_RscButtonMenu {
			idc = 2028;
			text = "$STR_PM_UCWanted";
			onButtonClick = "[] call life_fnc_wantedMenu";
			x = 0.1 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.850;
			w = (6.25 / 40);
