...
*/
	...
	player createDiaryRecord["serverrules",
		[
			"Donators",
				"
				Donators must follow the following rules or lose your donation status:<br/><br/>
				
				1. Do NOT give other players your weapons, clothing, vehicles or money.<br/>
				2. Always make sure your vehicles are stored in garages when not in use.<br/>
				3. Donations are only valid for 60 days.<br/>
				4. Abuse of donator percs will get you removed, and no refunds shall be issues.<br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Arresting and Ticketing",
				...
				3. If a civilian is wanted for more than $50,000, you may arrest them. Do not kill them, unless the situation falls under the 'Use of Lethal Force' section.<br/><br/>
	...
	player createDiaryRecord ["controls",
		[
			"",
				...
				Left Shift + O: Use Zip Ties (Does Not Work On Cops<br/>
				"
		]
	];