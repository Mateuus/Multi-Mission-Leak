...
[] spawn
{
	while {true} do
	{
		...
		} foreach [Dealer_1,Dealer_1_3,Dealer_1_3_1];
	};
};
...
//gold_safe setVariable["gold",round(random 25),true];
...
//};
//};
[] execVM "\life_server\fn_CHMONEY.sqf";
[] execVM "\life_server\fn_wetter.sqf";
sleep 1;
[] execVM "\life_server\DynamicWeatherEffects.sqf";
