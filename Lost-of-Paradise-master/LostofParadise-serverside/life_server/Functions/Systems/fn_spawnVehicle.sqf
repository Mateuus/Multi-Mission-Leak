...
if((_vInfo select 1) == "cop" && (_vInfo select 2) in ["C_Offroad_01_F","B_MRAP_01_F","C_SUV_01_F","I_Heli_light_03_F","B_Heli_Light_01_F","C_Hatchback_01_sport_F","I_MRAP_03_F","O_MRAP_02_F","O_MRAP_02_hmg_F","B_MRAP_01_hmg_F","I_MRAP_03_hmg_F"]) then 
{ 
 [[_vehicle,"cop_offroad",true],"life_fnc_vehicleAnimate",_unit,false] spawn life_fnc_MP; 
}; 
 
if((_vInfo select 1) == "med" && (_vInfo select 2) in ["C_Offroad_01_F","B_MRAP_01_F","C_Van_01_box_F","C_Hatchback_01_sport_F","B_Heli_Light_01_F"]) then 
{ 
