...
_maxAnimals = [_this,2,200,[0]] call BIS_fnc_param; 
if(_zoneName == "") exitWith {}; 
_animalList = ["Sheep_random_F","Goat_random_F","Hen_random_F","Cock_random_F","Rabbit_F","Alsatian_Black_F","Alsatian_Sand_F"]; 
