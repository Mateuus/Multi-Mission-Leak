...
if(life_6cash < life_ticket_val) exitWith
{
	if(life_atm5cash < life_ticket_val) exitWith 
	{
	...
	life_atm5cash = life_atm5cash - life_ticket_val;
...
life_6cash = life_6cash - life_ticket_val;
life_ticket_paid = true;
