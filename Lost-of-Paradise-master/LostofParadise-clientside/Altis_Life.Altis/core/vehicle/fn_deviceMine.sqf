...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","blei_1","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","pils_1","atomarea_1","frog_1","gold_1","meth_1","heroin_1","silber_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["pils_1"]): {"pilsu"};
	case (_zone in ["atomarea_1"]): {"brennstabu"};
	case (_zone in ["frog_1"]): {"frogu"};
