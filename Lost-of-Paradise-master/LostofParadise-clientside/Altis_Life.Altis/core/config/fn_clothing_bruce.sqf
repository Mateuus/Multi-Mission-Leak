...
switch (_filter) do
{
	...
	case 0:
	{
		...
		["U_C_man_sport_1_F",nil,1000],
		["U_C_man_sport_3_F",nil,1000],
		["U_C_man_sport_2_F",nil,1000],
		["U_C_Man_casual_4_F",nil,1000],
		["U_C_Man_casual_5_F",nil,1000],
		["U_C_Man_casual_6_F",nil,1000],
		["U_C_Poor_2","Rag tagged clothes",250],
		["U_IG_Guerilla2_2","Green stripped shirt & Pants",650],
		["U_IG_Guerilla3_1","Brown Jacket & Pants",735],
		["U_C_Man_casual_2_F",nil,2500],
		["U_C_Man_casual_3_F",nil,2500],
		["U_C_Man_casual_1_F",nil,2500],
		["U_IG_Guerilla2_3","The Outback Rangler",1200],
		["U_C_HunterBody_grn","The Hunters Look",1500],
		["U_C_WorkerCoveralls","Mechanic Coveralls",2500],
		["U_OrestesBody","Surfing On Land",1100],
		["U_NikosBody","Freizeit",1200],
		["U_Marshal","Marschal",2000],
		["U_NikosAgedBody","Anzug",8000],
		["U_I_C_Soldier_Bandit_4_F",nil,8000],
		["U_I_C_Soldier_Bandit_1_F",nil,8000],
		["U_I_C_Soldier_Bandit_2_F",nil,8000],
		["U_I_C_Soldier_Bandit_5_F",nil,8000],
		["U_I_C_Soldier_Bandit_3_F",nil,8000]
		];
	};
