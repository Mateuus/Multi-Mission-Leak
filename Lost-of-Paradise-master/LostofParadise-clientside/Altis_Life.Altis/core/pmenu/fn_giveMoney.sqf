...
if(parseNumber(_amount) > life_6cash) exitWith {hint "You don't have that much to give!";ctrlShow[2001,true];};
if(isNull _unit) exitWith {ctrlShow[2001,true];};
...
life_6cash = life_6cash - (parseNumber(_amount));
[0] call SOCK_fnc_updatePartial;
[[_unit,_amount,player],"life_fnc_receiveMoney",_unit,false] spawn life_fnc_MP;
[[player, _unit, _amount, 1, life_atm5cash, life_6cash],"TON_fnc_handleDBLog",false] spawn life_fnc_MP; //By Nukefliege
