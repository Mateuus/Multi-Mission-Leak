...
if(_action) then {
	_house setVariable["house_sold",true,true];
		hint "Haus wird verkauft kleinen moment...";
		sleep 10;
	...
	hint "Haus wurde verkauft das Geld wird dir gleich ausgezahlt...";
		sleep 10;
	life_atm5cash = life_atm5cash + (round((_houseCfg select 0)/2));
