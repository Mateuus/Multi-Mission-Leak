...
if(!(_curTarget in life_2vehicles) OR isNil {_curTarget getVariable "house_owner"}) then {
if(_curTarget in life_2vehicles) then {life_2vehicles = life_2vehicles - [_curTarget];};
