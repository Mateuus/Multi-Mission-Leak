...
if(life_atm5cash < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-life_atm5cash)] call life_fnc_numberText];};
