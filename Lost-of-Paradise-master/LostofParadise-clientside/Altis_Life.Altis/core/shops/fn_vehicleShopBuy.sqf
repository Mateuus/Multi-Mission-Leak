...
if(life_6cash < _basePrice) exitWith {hint format[localize "STR_Shop_Veh_NotEnough",[_basePrice - life_6cash] call life_fnc_numberText];};
if(!([_className] call life_fnc_vehShopLicenses) && _className != "") exitWith {hint localize "STR_Shop_Veh_NoLicense"};
