...
//Set Ticket Button
_Btn5 ctrlSetText  "Strafzettel ausstellen";
_Btn5 buttonSetAction "[life_pInact_curTarget] call life_fnc_ticketAction;";

_Btn6 ctrlSetText  "Ins Gefängnis stecken";
...
//SeizeWeapons Button
_Btn8 ctrlSetText  "Seize Waffen";
