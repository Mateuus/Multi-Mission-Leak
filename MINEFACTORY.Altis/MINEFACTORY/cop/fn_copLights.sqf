...
switch (typeOf _vehicle) do
{
	...
	{
		_lightleft lightAttachObject [_vehicle, [-0.03, -0, 0.2]];
	};
	
	case "C_Van_01_box_F":
	{
		_lightleft lightAttachObject [_vehicle, [-0.8, 1.8, -0.25]];
	};
	
	case "O_Truck_02_box_F":
	{
		_lightleft lightAttachObject [_vehicle, [-1.15, -4.7, -1.2]];
	};
	
	case "I_MRAP_03_F":
	{
		_lightleft lightAttachObject [_vehicle, [-0.87, 2.2, -0.75]];
	};
	...
	{
		_lightleft lightAttachObject [_vehicle, [-0.87, 3.1, 0.5]];
	};
	
	case "B_Truck_01_mover_F":
	{
		_lightleft lightAttachObject [_vehicle, [-0.77, 4.55, -0.18]];
	};
