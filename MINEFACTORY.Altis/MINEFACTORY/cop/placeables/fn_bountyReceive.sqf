...
if(_val == _total) then {
	...
	titleText[format[ "Du hast ein Kopfgeld von $%1 für das Töten eines gesuchten Verbrechers erhalten, für eine Festnahme hättest du $%2 bekommen.",[_val] call life_fnc_numberText,[_total] call life_fnc_numberText],"PLAIN"];
};
