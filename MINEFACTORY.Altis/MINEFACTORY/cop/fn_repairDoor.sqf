...
if(EQUAL(_door,0)) exitWith {hint  "Du bist nicht in der Nähe einer Tür!"}; //Not near a door to be broken into.
_doorN = _building GVAR [format["bis_disabled_Door_%1",_door],0];
if(EQUAL(_doorN,1)) exitWith {hint  "Die Tür ist bereits verriegelt!"};
life_action_inUse = true;

closeDialog 0;
//Setup the progress bar
disableSerialization;
_title =  "Tür wird repariert...";
