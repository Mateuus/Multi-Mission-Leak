...
if(EQUAL(count _sellers,0)) exitWith {hint  "Niemand hat hier kürzlich etwas verkauft."}; //No data.
...
hint parseText format[( "Die folgenden Leute haben kürzlich an diesen Dealer verkauft.")+ "<br/><br/>%1",_names];
