...
class vInteraction_Civ
{
	...
	class controlsBackground
	{
		...
		{
			idc = 1100;
			text = "<t size='1.2' align='center'>Aktion ...</t>"; //--- ToDo: ;
		...
		{
			idc = 1200;
			text = "MINEFACTORY\icons\vInteraction\repair.paa";
		...
		{
			idc = 1201;
			text = "MINEFACTORY\icons\vInteraction\pullout.paa";
		...
		{
			idc = 1204;
			text = "MINEFACTORY\icons\vInteraction\DLC.paa";
			x = 12 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = 1205;
			text = "MINEFACTORY\icons\vInteraction\boat.paa";
			x = 12 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = 1206;
			text = "MINEFACTORY\icons\vInteraction\device.paa";
			x = 17 * GUI_GRID_W + GUI_GRID_X;
			y = 13 * GUI_GRID_H + GUI_GRID_Y;
			w = 4 * GUI_GRID_W;
			h = 3 * GUI_GRID_H;
		...
		{
			idc = 1207;
			text = "MINEFACTORY\icons\vInteraction\flip.paa";
			x = 17 * GUI_GRID_W + GUI_GRID_X;
			y = 9 * GUI_GRID_H + GUI_GRID_Y;
			w = 4 * GUI_GRID_W;
			h = 3 * GUI_GRID_H;
