...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Vehicles_CHINOOK = ["B_Heli_Transport_03_F","B_Heli_Transport_03_unarmed_F"];
	IL_Supported_Vehicles_MH9 = ["B_Heli_Light_01_F", "B_mas_mar_Heli_Light_01_F","B_Heli_Transport_01_F"];
	...
	IL_Supported_Supply_Crate = ["I_supplyCrate_F", "IG_supplyCrate_F", "O_supplyCrate_F", "I_supplyCrate_F", "C_supplyCrate_F"];
	...
	IL_Supported_Cargo_Veh_CHINOOK = IL_Supported_Cargo_Veh_HEMTT;
...
if (isnil "IL_Procedures") then
{
	...
	IL_Init_Veh =
	{
		...
		if (_obj_type in IL_Supported_Vehicles_CHINOOK) then
		{
			...
			if ((isNil {_obj getVariable "can_copilot"}) || (_force)) then {_obj setVariable["can_copilot", IL_Can_CoPilot, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -2.00, true];};
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload_para.paa' /><t color=""#b200ff""> Eject</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Unload cargo with parachute</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload_all_para.paa' /><t color=""#a50b00"">  Unload ALL cargo with parachute</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_CHINOOK) then
{
	...
	[_obj_main] call IL_Init_Veh;
		...
		"('cargo' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (((getPosATL _target) select 2) >= IL_Para_Jump_ATL)"
		];
		
		_obj_main addAction [
		"<img image='MINEFACTORY\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from Huron</t>",
		{
			[_this select 0] call IL_Do_Unload;
		},[],IL_Action_LU_Priority,false,true,"",
		...
		"(_target getVariable 'box_num' < 0) && ((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot'))) && (_target getVariable 'can_load') && (((getPosATL _target) select 2) >= IL_Para_Drop_ATL)"
		];
...
/*		
		...
		"((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-6,-3], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target animationPhase 'Door_rear_source' == 0) && (_target getVariable 'can_load')"
		];
		...
		"((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-6,-3], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target animationPhase 'Door_rear_source' == 1) && (_target getVariable 'can_load')"
		];
*/		
		_obj_main addAction [
		"<t color=""#0000ff"">Enable loading for Co-Pilot</t>",
...
//		"('cargo' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (((getPosATL _target) select 2) >= IL_Para_Jump_ATL) && (_target animationPhase 'ramp_bottom' < 0.1) && (_target getVariable 'usable_ramp')"
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on C-130J</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on C-130J</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from C-130J</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_C17) then
{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on C17</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on C17</t>",
	{
		[_this select 0, IL_Supported_Cargo_C17] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from C17</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_MH9) then
{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on left MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on right MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from left MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from right MH-9</t>",
	{ 
...
///////////////////////////
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Unload cargo with parachute left MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Unload cargo with parachute right MH-9</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_OFFROAD) then
{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on Offroad</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on Offroad</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from Offroad</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_VAN) then
{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on VAN</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on VAN</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from VAN</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_KAMAZ) then
{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on ZAMAK</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on ZAMAK</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from ZAMAK</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_TEMPEST) then
{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on TEMPEST</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on TEMPEST</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from TEMPEST</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_HEMTT) then
{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on HEMTT</t>",
	{
	...
	_obj_main addAction [
	"<img image='MINEFACTORY\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on HEMTT</t>",
	{
