...
if((_house GVAR [format["bis_disabled_Door_%1",_door],0]) == 0) exitWith {hint  "Die Tür ist bereits offen!"};

life_action_inUse = true;

//Setup the progress bar
disableSerialization;
_title =  "Türschloss wird aufgebrochen";
...
[2,"%1 dein Haus wird von der Polizei durchsucht!",true,[(_house GVAR "house_owner") select 1]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
