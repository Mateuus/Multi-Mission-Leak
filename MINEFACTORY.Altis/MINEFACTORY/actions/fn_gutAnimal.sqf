...
switch(typeOf _animalCorpse) do {
	case "Hen_random_F": {_displayName =  "Hähnchen"; _item = "hen_raw";};
	case "Cock_random_F": {_displayName =  "Hahn"; _item = "rooster_raw";};
	case "Goat_random_F": {_displayName =  "Ziege"; _item = "goat_raw";};
	case "Sheep_random_F": {_displayName =  "Schaf"; _item = "sheep_raw";};
	case "Rabbit_F": {_displayName =  "Hase"; _item = "rabbit_raw";};
	default {_displayName = ""; _item = "";};
};

if(EQUAL(_displayName,"")) exitWith {life_action_inUse = false;};

_upp = format[ "Ausnehmen %1",_displayName];
...
if(([true,_item,1] call life_fnc_handleInv)) then {
	...
	titleText[format[( "Sie haben %1 Roh Fleisch gesammelt"),_displayName],"PLAIN"];
} else {
