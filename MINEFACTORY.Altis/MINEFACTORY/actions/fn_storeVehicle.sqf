...
if(isNil "_vehicle") exitWith {hint  "Es befindet sich kein Fahrzeug in der Nähe des NPC."};
if(isNull _vehicle) exitWith {};


_storetext =  "Das Fahrzeug wurde in der Garage geparkt.";
...
hint  "Der Server versucht, das Fahrzeug zu speichern...";
