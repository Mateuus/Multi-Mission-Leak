...
*/
private "_value";
if((time - life_action_delay) < 1.5) exitWith {hint  "Du führst bereits eine Aktion aus. Bitte warte, bis diese beendet ist.Delay"; _this SVAR ["inUse",false,true];};
...
if(!isNil "_value") exitWith {
	...
	titleText[format[ "Du hast %1 %2 gesammeltMoney",[_value] call life_fnc_numberText],"PLAIN"];
	ADD(CASH,_value);
