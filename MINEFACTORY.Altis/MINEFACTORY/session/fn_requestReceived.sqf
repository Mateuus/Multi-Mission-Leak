...
if(life_session_tries > 3) exitWith {cutText[ "Es gab einen Fehler beim Versuch, deinen Client einzurichten.","BLACK FADED"]; 0 cutFadeOut 999999999;};

0 cutText [ "Empfangene Daten vom Server... Überprüfe...","BLACK FADED"];
