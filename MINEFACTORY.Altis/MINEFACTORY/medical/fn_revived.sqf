...
[format[ "%1 hat dich wiederbelebt und dafür eine Gebühr von $%2 von deinem Bankkonto eingezogen.",_medic,[_reviveCost] call life_fnc_numberText]] spawn life_fnc_nachricht;
...
life_corpse SVAR ["saniweg",nil,true];
life_corpse SVAR ["medicanfrage",nil,true];
[life_corpse] remoteExecCall ["life_fnc_corpse",RANY];
...
player SVAR ["saniweg",nil,true];
player SVAR ["medicanfrage",nil,true];
