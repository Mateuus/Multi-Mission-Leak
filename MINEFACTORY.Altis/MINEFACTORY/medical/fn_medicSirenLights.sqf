...
if(!(typeOf _vehicle in ["C_Offroad_01_F","B_Quadbike_01_F","C_Hatchback_01_F","C_Hatchback_01_sport_F","C_Van_01_box_F","O_Truck_02_box_F","I_MRAP_03_F","B_MRAP_01_F","O_Truck_02_covered_F","B_Truck_01_mover_F","C_SUV_01_F","B_Heli_Light_01_F","B_Heli_Transport_01_F"])) exitWith {}; //Last chance check to prevent something from defying humanity and creating a monster.
