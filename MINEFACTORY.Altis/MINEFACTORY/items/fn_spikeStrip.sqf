...
life_action_spikeStripDeploy = player addAction[ "Nagelband platzieren",{if(!isNull life_spikestrip) then {detach life_spikeStrip; life_spikeStrip = ObjNull;}; player removeAction life_action_spikeStripDeploy; life_action_spikeStripDeploy = nil;},"",999,false,false,"",'!isNull life_spikestrip'];
...
life_action_spikeStripPickup = player addAction[ "Nagelband zusammenpacken",life_fnc_packupSpikes,"",0,false,false,"",
