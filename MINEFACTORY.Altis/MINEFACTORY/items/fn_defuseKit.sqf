...
if(!(_vault GVAR ["chargeplaced",false])) exitWith {hint  "Es gibt keine Sprengladung am Tresor?"};

life_action_inUse = true;
//Setup the progress bar
disableSerialization;

_title =  "Sprengladung wird entschärft...";
...
[0,"Die Sprengladung wurde entschärft"] remoteExecCall ["life_fnc_broadcast",west];