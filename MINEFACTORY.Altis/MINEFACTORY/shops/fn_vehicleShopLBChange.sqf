...
private["_control","_index","_className","_classNameLife","_basePrice","_vehicleInfo","_colorArray","_ctrl","_trunkSpace","_maxspeed","_horsepower","_passengerseats","_fuel","_armor"];
...
( "Kofferraumgröße:")+ " %6<br/>" +
( "Tankgröße:")+ " %7<br/>" +
( "Panzerungsbewertung:")+ " %8",
