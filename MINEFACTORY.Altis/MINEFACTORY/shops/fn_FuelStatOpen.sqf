...
if (count _vehicleList < 1) exitwith {hint  "Es ist kein Fahrzeug in der Nähe...";life_action_inUse = false;};
...
ctrlsettext [20322,format [ "Price per Liter : $%1",life_fuelPrices]];
