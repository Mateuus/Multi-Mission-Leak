...
if(isNull life_trunk_vehicle OR !alive life_trunk_vehicle) exitWith {hint  "Das Fahrzeug existiert entweder nicht oder wurde zerstört."};
if(!alive player) exitwith {closeDialog 0;};
if((life_trunk_vehicle getVariable ["trunk_in_use_by",player]) != player) exitWith {  closeDialog 0; hint  "Der Kofferraum dieses Fahrzeuges wird bereits benutzt, nur eine Person kann auf ihn zugreifen."; };
