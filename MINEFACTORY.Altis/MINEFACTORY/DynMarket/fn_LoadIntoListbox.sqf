...
if (isNil "DYNMARKET_prices") then {[getPlayerUID player] remoteExec ["TON_fnc_playerLogged", 2];;hint "Empfange Preise vom Server..";sleep 1;};
...

{
	...
	_itemDisplayName =  _itemDisplayName;
