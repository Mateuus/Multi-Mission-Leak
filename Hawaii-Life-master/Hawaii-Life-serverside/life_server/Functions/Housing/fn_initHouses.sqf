...
_query = format["SELECT houses.id, houses.pid, houses.pos, players.name, houses.security FROM houses, players WHERE players.playerid = houses.pid AND houses.owned='1'"]; 
