...
switch (_side) do { 
 case west: { 
  if(_bool) then { 
   ...
   life_radio_frac radioChannelAdd [_unit]; 
  } else { 
   life_radio_west radioChannelRemove [_unit]; 
   life_radio_frac radioChannelRemove [_unit]; 
  }; 
 }; 
 ...
 case civilian: { 
  if(_bool) then { 
   ...
   life_radio_thw radioChannelAdd [_unit]; 
  } else { 
   life_radio_civ radioChannelRemove [_unit]; 
   life_radio_thw radioChannelRemove [_unit]; 
  }; 
 }; 
