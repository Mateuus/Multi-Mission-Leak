...
_query = switch(_side) do { 
 ...
 case civilian: {_returnCount = 16; format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, civ_licenses, arrested, civ_gear, civ_stats, level, expcount, kills, deaths, civTime FROM players WHERE playerid='%1'",_uid];}; 
