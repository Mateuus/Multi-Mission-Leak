...
class CfgRemoteExec {
    class Functions {
		...
		F(life_fnc_passview,CLIENT)
		F(life_fnc_vehicleEmpd,CLIENT)
		F(life_fnc_vehicleWarned,CLIENT)
		F(life_fnc_TakePhone,CLIENT)
		F(life_fnc_wantedInfo,CLIENT)
		F(life_fnc_sendMSG,CLIENT)
		F(life_fnc_getMSG,CLIENT)
		...
		F(HC_fnc_handleDBLog,HC)
		F(HC_fnc_startJackpot,HC)
        ...
        F(HC_fnc_houseCleanup,HC)
        F(HC_fnc_deleteDBContainer,HC)
        F(HC_fnc_upgradeSecurity,HC)
        ...
        F(HC_fnc_pickupAction,HC)
		F(HC_fnc_vehicleDead,HC)
		F(HC_fnc_playerLogged,HC)
		F(HC_fnc_getUpdate,HC)
		...
		F(life_fnc_vehicleRepair,ANYONE)
    };
