...
class WeaponShops {
	...
	class sgt {
        ...
        level[] = { "", "", -1, "" };
        items[] = {
            { "arifle_SPAR_01_snd_F", "",160000, -1 },
            { "arifle_SPAR_03_snd_F", "",550000, -1 },
            { "arifle_AK12_F", "",600000, -1 },
            { "srifle_DMR_03_tan_F", "",700000, -1 },
            { "NONE", "---------------------------------------------------------------------------",0, -1 },
            { "NONE", "Zubehör",0, -1 },
            { "NONE", "---------------------------------------------------------------------------",0, -1 },
            { "acc_flashlight", "",500, -1 },
            { "acc_pointer_IR", "",500, -1 },
            { "optic_Holosight_blk_F", "",5000, -1 },
            { "optic_Holosight", "",5000, -1 },
            { "optic_MRCO", "",7500, -1 },
            { "optic_Hamr", "",7500, -1 },
            { "optic_Arco_blk_F", "",7500, -1 },
            { "optic_Arco", "",7500, -1 },
            { "optic_Erco_blk_F", "",7500, -1 },
            { "optic_Erco_snd_F", "",7500, -1 },
            { "optic_AMS", "",12500, -1 },
            { "optic_AMS_snd", "",12500, -1 },
            { "muzzle_snds_B", "",35000, -1 },
            { "muzzle_snds_B_snd_F", "",35000, -1 },
            { "muzzle_snds_M_snd_F", "",35000, -1 },
            { "bipod_01_F_blk", "",40000, -1 },
            { "bipod_01_F_snd", "",40000, -1 },
            { "NONE", "---------------------------------------------------------------------------",0, -1 },
            { "NONE", "Kleine Kaliber",0, -1 },
			{ "NONE", "---------------------------------------------------------------------------",0, -1 },
    ...
    class cop_2ndchief {
        ...
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 10, "Du musst Deputy Chief sein!" };
        items[] = {
            { "hgun_P07_snds_F","Taser Pistole",500, -1 },
            { "arifle_SDAR_F","Tazer Rifle",15000, -1 },
            { "SMG_05_F", "",5000, -1 },
    ...
    class cop_chief {
        ...
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 11, "Du musst Chief o. Police sein!" };
        items[] = {
            { "hgun_P07_snds_F","Taser Pistole",500, -1 },
            { "arifle_SDAR_F","Tazer Rifle",15000, -1 },
            { "SMG_05_F", "",5000, -1 },
