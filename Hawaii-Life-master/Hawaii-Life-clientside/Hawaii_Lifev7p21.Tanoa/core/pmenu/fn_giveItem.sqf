...
_val = ctrlText 2010;
ctrlShow[2002,false];
if((lbCurSel 2022) isEqualTo -1) exitWith {hint "No one was selected!";
ctrlShow[2002,true];};
_unit = lbData [2022,lbCurSel 2022];
_unit = call compile format["%1",_unit];

if((lbCurSel 2005) isEqualTo -1) exitWith {hint "You didn't select an item you wanted to give.";ctrlShow[2002,true];};
