...
/*
	...
	Blah blah.
*/
private["_group","_hideout","_action","_cpRate","_cP","_progressBar","_title","_titleText","_ui","_marker"];
_hideout = (nearestObjects[getPosATL player,["Land_Temple_Native_01_F"],25]) select 0;
...
_marker setMarkerText format["Gang Versteck(%1)",grpPlayer GVAR "gang_name"];