...
life_clothing_buy = true;

(findDisplay 3100) displaySetEventHandler ["KeyDown","if((_this select 1) isEqualTo 1) then {closeDialog 0; [] call life_fnc_playerSkins;life_clothing_buy = false;}"]; //Fix Custom Skin after ESC
