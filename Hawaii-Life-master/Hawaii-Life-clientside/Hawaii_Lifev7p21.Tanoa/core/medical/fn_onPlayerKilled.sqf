...
_unit spawn {
	private["_RespawnBtn","_Timer","_requestBtn"];
	disableSerialization;
...
//Create a thread for something?
	...
	life_respawn_timer2 = time + (life_respawn_timer * 60);
	_RespawnBtn ctrlEnable false;
	waitUntil {_Timer ctrlSetText format[localize "STR_Medic_Respawn",[(life_respawn_timer2 - time),"MM:SS.MS"] call BIS_fnc_secondsToString];
	round(life_respawn_timer2 - time) <= 0 OR isNull _this};
