...
//Magic Parachute
life_actions pushBack [player addAction	["<t color='#FF00FF'>Fallschirm Öffnen</t>",life_fnc_openParachute,"",1,false,true,"",'vehicle player == player && (getPos player) select 2 > 2.5']];