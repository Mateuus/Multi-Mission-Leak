if (!life_clothing_buy) then {
	[] call SOCK_fnc_updateRequest;
};
life_loggingOUT = true;
...
[0,format["Spieler %1 ging in die Lobby",profileName]] remoteExecCall ["life_fnc_broadcast",-2];
...
[
    format[
    "<t size='1.3' color='#FFB124'>Auf Wiedersehen!</t><br/>Besuche uns wieder %1. <br/><t size='1.1'>Hawaii-life.net</t>",_name],
    0,
    0.2,
    10,
    0,
