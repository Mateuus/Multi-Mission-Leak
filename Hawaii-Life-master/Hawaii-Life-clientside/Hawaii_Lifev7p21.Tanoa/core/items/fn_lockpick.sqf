...
if(_curTarget isKindOf "House_F") exitWith {hint "Du kannst damit kein Haus knacken!"};
if((playerSide isEqualTo civilian) && (player distance (getMarkerPos "save_air") < 120)) exitWith {hint "Du darfst in einer Save-Zone keine Autos knacken.";};
if((playerSide isEqualTo civilian) && (player distance (getMarkerPos "save_katkoula") < 290)) exitWith {hint "Du darfst in einer Save-Zone keine Autos knacken.";};
if((playerSide isEqualTo civilian) && (player distance (getMarkerPos "save_george") < 290)) exitWith {hint "Du darfst in einer Save-Zone keine Autos knacken.";};
