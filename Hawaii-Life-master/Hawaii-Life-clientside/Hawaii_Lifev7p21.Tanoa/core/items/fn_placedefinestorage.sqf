...
*/
switch(true) do {
	case ((typeOf life_container_activeObj) isEqualTo "B_supplyCrate_F"): {[] call life_fnc_placestorageBig};
	case ((typeOf life_container_activeObj) isEqualTo "Box_IND_Grenades_F") : {[] call life_fnc_placestorageSmall};
	default {_type = ""};
};
