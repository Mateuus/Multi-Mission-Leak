...
if(!(["life_fnc_",_functionName] call BIS_fnc_inString) && {!(["DB_fnc_",_functionName] call BIS_fnc_inString)} && {!(["TON_fnc_",_functionName] call BIS_fnc_inString)} &&
...
if(_functionName isEqualTo "bis_fnc_execvm") then {
