...
if(playerSide isEqualTo west || playerSide isEqualTo civilian && {EQUAL(LIFE_SETTINGS(getNumber,"save_civ_weapons"),1)}) then {
...

{
	...
	"pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtleSoup","hen","rooster","sheep","goat","banane","ananas","painkillers","handcuffs","handcuffkeys","protestSign","sechouse","gpstracker","zyankalikapsel","morphium","beer","bottledwhiskey","bottledshine","wheel","engine","fueltank","hull","Avionics","HRotor","VRotor"
];
