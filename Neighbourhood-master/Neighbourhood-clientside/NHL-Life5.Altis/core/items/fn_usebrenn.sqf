...
hint "Du baust deine Destillieranlage auf";	 
  //Land_CanisterOil_F  Land_Bucket_F 
		...
		_fass addaction ["Maische herstellen",{play_fuckyou = false; []call life_fnc_maische; play_fuckyou = true;},"",0,false,true,"","play_fuckyou"]; 
		...
		_eimer addaction ["Schnaps destillieren",{play_fuckyou = false; []call life_fnc_desti; play_fuckyou = true;},"",0,false,true,"","play_fuckyou"];
		...
		_fasser allowDamage false;
		_mauer allowDamage false;
		_zelt allowDamage false;
		_stapel allowDamage false;
		_motor allowDamage false;
		_fass allowDamage false;
		_leitung allowDamage false;
		_eimer allowDamage false;
