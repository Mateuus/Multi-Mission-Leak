...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","zigaretten_1","silber_1","gold_1","meth_1","wein_1","zigarren_1","sprengstoff_1","lsd_1","kohle_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["wein_1"]): {"weinu"};
	case (_zone in ["zigaretten_1"]): {"zigarettenu"};
	case (_zone in ["zigarren_1"]): {"zigarettenu"};
	case (_zone in ["sprengstoff_1"]): {"sprengstoffu"};
	case (_zone in ["lsd_1"]): {"lsdu"};
	case (_zone in ["kohle_1"]): {"kohle"};
	default {""};
};
