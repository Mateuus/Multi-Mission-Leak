...
//level
if(life_erfahrung <= 250) exitWith {hint "Du musst Level 2 erreichen um das Kraftwerk kontrollieren zu können!"};
...
titleText["Das Kraftwerk wurde erfolgreich übernommen.","PLAIN"];
_flagTexture = [
