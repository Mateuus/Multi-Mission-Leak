...
[[0,format["Während du offline warst, hast du Items im Wert von $%1 im NHL-Auktionshaus verkauft",[_total]call life_fnc_numberText]],"life_fnc_broadcast",player,false] spawn life_fnc_MP;
