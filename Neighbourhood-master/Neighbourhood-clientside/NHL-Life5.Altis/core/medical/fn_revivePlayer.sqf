...
*/
private["_target","_revivable","_targetName","_ui","_progressBar","_titleText","_cP","_title","_defi"];
...
[player, "revive", 20] call life_fnc_globalsound;
...
_defi = "Land_Defibrillator_F" createvehicle [0,0,0];
_defi setpos (player modelToWorld [-0.8,0.3,0]); 
...
[4,_target] call life_fnc_lade_leitstelle;
sleep 0.6;
