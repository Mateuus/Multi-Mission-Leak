...
hint format["Du hast dauerhaft die Schlüssel für %1 der Gang entzogen",typeOf _vehicle];
[[_vehicle, getPlayerUID player, 1], "TON_fnc_insertHouseGangKey",false,false] call life_fnc_MP;