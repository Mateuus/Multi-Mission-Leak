...
_Btn9 ctrlSetText "Beschlagnahmen";
...
_Btn11 ctrlSetText "Geld geben";
_Btn11 buttonSetAction "[life_pInact_curTarget] call life_fnc_giveMoneyAction;";

_Btn12 ctrlSetText "Items Geben";
_Btn12 buttonSetAction "[life_pInact_curTarget] spawn life_fnc_giveItemAction;";

_Btn13 ctrlSetText "Schlüssel Geben";
_Btn13 buttonSetAction "[life_pInact_curTarget] spawn life_fnc_giveKeyAction;";

//Check that you are near a place to jail them.
if(!((player distance (getMarkerPos "Police_Hq_1") < 100) OR  (player distance (getMarkerPos "staatsknast") < 100) )) then 
{
