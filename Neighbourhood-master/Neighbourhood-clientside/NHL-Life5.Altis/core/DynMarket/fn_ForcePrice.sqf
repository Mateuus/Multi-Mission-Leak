...
if ((_tochangeNameText=="")||(_tochangePriceText=="")) exitWith {hint parseText "<t color='#FF0000'>--ERROR--</t><br/><t color='#FF0000'>Falsche Eingabe</t>";};
...
if (_exists) then {
	hint parseText "<t color='#01DF01'>--UPDATED--</t><br/><t color='#01DF01'>Erfolgreich angepasst. Preis wird nach der Nächsten Aktuallisierung angepasst!</t>";
	[[_tochangeNameText,_tochangePriceNumber],"TON_fnc_changePrice",false,false] spawn life_fnc_MP;
} else {
	hint parseText "<t color='#FF0000'>--ERROR--</t><br/><t color='#FF0000'>Das Item gibt es nicht, richtig geschrieben?</t>";
};