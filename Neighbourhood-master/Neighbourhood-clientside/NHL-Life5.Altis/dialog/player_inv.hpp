	...
	class controls {
		...
		*/
		...
		class ButtonAdminMenu : Life_RscButtonMenu {
			...
			onButtonClick = "closeDialog 0;[] spawn life_fnc_openMenu;";
		...
		class ButtonLeitstelle : Life_RscButtonMenu {
			idc = 9900;
			text = "Leitstelle";
			onButtonClick = "createDialog 'play_leitstelle';disableSerialization;waitUntil {!isNull (findDisplay 2610100)};[0,0] call life_fnc_lade_leitstelle;";
			x = 0.1 + (6.25 / 19.8) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.8 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
		...
		class ButtonErfahrung : Life_RscButtonMenu {
			idc = 4444;
			text = "Erfahrung";
			onButtonClick = "[] spawn life_fnc_showLevel;";
			//x = 0.26 + (6.25 / 19.8) + (1 / 250 / (safezoneW / safezoneH));
			x = 0.26 + (6.25 / 19.8) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.805;
			w = (6.25 / 40);
		...
		class ButtonHelp : Life_RscButtonMenu {
            idc = 99630;
            //shortcuts[] = {0x00050000 + 2};
            text = "Hilfe";
            colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call life_fnc_Help;";
			x = 0.11;
			y = 0.70;
			w = (5.75 / 40);
			h = (1 / 25);
