...
if([civilian,getPos player,50] call life_fnc_nearUnits) exitWith {titleText["Du musst mindestens 50 Meter von anderen Personen entfernt sein.","PLAIN"]};
