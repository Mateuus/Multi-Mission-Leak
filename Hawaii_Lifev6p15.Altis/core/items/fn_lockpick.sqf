...
if((playerSide == civilian) && (player distance (getMarkerPos "save_kav") < 310)) exitWith {hint "Du darfst in einer Save-Zone keine Autos knacken.";};
if((playerSide == civilian) && (player distance (getMarkerPos "save_athira") < 220)) exitWith {hint "Du darfst in einer Save-Zone keine Autos knacken.";};
if((playerSide == civilian) && (player distance (getMarkerPos "save_flug") < 130)) exitWith {hint "Du darfst in einer Save-Zone keine Autos knacken.";};
