...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","mushrooms_1", "khat_1","flowers_1"];
_zone = "";
...
switch(true) do {
	...
	case (_zone in ["mushrooms_1"]): {_gather = ["mushrooms",2];};
	case (_zone in ["khat_1"]): {_gather = ["khat",2];};
	case (_zone in ["flowers_1"]): {_gather = ["flowers",2];};
	default {""};
};
//gather check??
