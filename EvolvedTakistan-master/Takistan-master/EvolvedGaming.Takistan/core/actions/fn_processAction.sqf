...
_itemInfo = switch (_type) do {
	...
	case "diesel": {["oil_unprocessed","oil_diesel",1500,(localize "STR_Process_Diesel")];};
	case "jet": {["oil_unprocessed","oil_jet",5200,(localize "STR_Process_Jet")];};
	case "heavy": {["oil_unprocessed","oil_heavy",4200,(localize "STR_Process_Heavy")];};
	case "gas": {["gas_unprocessed","gas_processed",2200,(localize "STR_Process_Oil")];};
	...
	case "wood": {["wood","lumber",350,(localize "STR_Process_Wood")];};
	case "hashish": {["marijuana","hashish",2750,(localize "STR_Process_Hashish")];};
	case "morphine": {["heroin_processed","morphine",3750,(localize "STR_Process_Morphine")];};
	case "krokodil": {["morphine","krokodil",4750,(localize "STR_Process_Krokodil")];};
	default {[];};
};
