...
lbClear _units;
CONTROL(2700,2701) ctrlSetStructuredText parseText format["<img size='1.7' image='\eg_sndimg\icons\bank.paa'/> $%1<br/><img size='1.6' image='\eg_sndimg\icons\money.paa'/> $%2",[BANK] call life_fnc_numberText,[CASH] call life_fnc_numberText];
