...
switch (_shop) do
{
	case "reb":
	{
		ctrlSetText[2505,"Takistan Rebel Shop"];
		ctrlShow[2503,false];
		ctrlShow[2513,false];
		ctrlShow[2514,false];
	};
	...
	case "cop":
	{
		ctrlSetText[2505,"Takistan Cop Shop"];
		ctrlShow[2503,false];
	};
	
	case "gun":
	{
		ctrlSetText[2505,"Takistan Gun Store"];
		ctrlShow[2503,false];
		ctrlShow[2513,false];
		ctrlShow[2514,false];
	};
	...
	case "dive":
	{
		ctrlSetText[2505,"Takistan Diving Shop"];
		ctrlShow[2503,false];
		ctrlShow[2510,false];
		ctrlShow[2511,false];
		ctrlShow[2513,false];
	...
	case "gen":
	{
		ctrlSetText[2505,"Takistan General Store"];
		ctrlShow[2503,false];
	};
