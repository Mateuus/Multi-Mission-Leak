...
_log = format["%1 (%2) hat %3 für %4$ verkauft [GARAGE].", player getVariable["realname", name player], getPlayerUID player, str(_vehicle), [_sellPrice]call life_fnc_numberText];
