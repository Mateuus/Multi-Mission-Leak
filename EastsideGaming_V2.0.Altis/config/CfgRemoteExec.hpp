...
class CfgRemoteExec {
    class Functions {
		...
		F(ESG_fnc_loadoutReceived,CLIENT)
		F(ESG_fnc_insertLoadout,CLIENT)
		F(ESG_fnc_dataLoadout,CLIENT)
		...
		F(ESG_fnc_ausweisrecall,CLIENT)
		F(ESG_fnc_ausweis_zeigen,CLIENT)
		F(ESG_fnc_clientgetback,CLIENT)
		F(ESG_fnc_fuelKillVehicle,CLIENT)
		F(ESG_fnc_warnVehicle,CLIENT)
		F(ESG_fnc_respawnhim,CLIENT)
		F(ESG_fnc_sosMarker,CLIENT)
		F(ESG_fnc_augenbinde,CLIENT)
		...
		F(ESG_fnc_whitelist,SERVER)
		F(ESG_fnc_checkausweis,SERVER)
		F(ESG_fnc_sidechatsay,SERVER)
		F(life_fnc_jailTimer,SERVER)
		F(ESG_fnc_logging,SERVER)
