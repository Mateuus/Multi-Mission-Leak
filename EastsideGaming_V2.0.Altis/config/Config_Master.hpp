...
/* System Settings */
    ...
    escapeMenu_displayText = "Eastside-Gaming.de"; //Text displayed in the escape menu. Make it short.. around 20 characters.
    ...
    sendtoJail_locations[] = { "cop_spawn_air", "cop_spawn_athira", "cop_spawn_kavala"}; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    jail_forceWalk = true;
    ...
    crimes[] = {
		...
		{"STR_Crime_1005","20000","1005"},
		{"STR_Crime_1006","20000","1006"}
    };
};
