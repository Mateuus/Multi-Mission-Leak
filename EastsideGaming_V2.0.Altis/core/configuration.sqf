...
ESG_skill = [
  ...
  0, //Stabilisierung
  0, //Sammeln Früchte
  0, //Verarbeiten Früchte
  0, //Sammeln Drogen
  0, //Verarbeiten Drogen
  0, //Sammeln Schwarzarbeit
  0, //Verarbeiten Schwarzarbeit
  0, //Sammeln Erze
  0, //Verarbeiten Erze
  0, //Knacken von Fahrzeugen
  0, //Bolzenschneider
  0, //Beschlagnahmen
  0, //Wiederbeleben
  0, //Häuser aufbrechen
...
esg_settings_gras = profileNamespace getVariable ["esg_gras",false];
