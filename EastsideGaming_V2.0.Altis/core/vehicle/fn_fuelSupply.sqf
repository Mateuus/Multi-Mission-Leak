...
_t2 = "Fertig";
waitUntil {
    if (!alive _vehicle || isNull _vehicle) exitWith {_t2 = "Abgebrochen"; true};
    if (isEngineOn _vehicle) exitWith {_t2 = "Abgebrochen"; titleText[localize "STR_FuelTank_Stopped","PLAIN"]; true};
    if (isNil {_vehicle getVariable "fuelTankWork"}) exitWith {_t2 = "Abgebrochen"; titleText[localize "STR_FuelTank_Stopped","PLAIN"]; true};
    if (player distance _vehicle > 20) exitWith {_t2 = "Abgebrochen"; titleText[localize "STR_FuelTank_Stopped","PLAIN"]; true};
    ...
    if (_fuelState isEqualTo 0 || _fuelFeedState <= 0) exitWith {_t2 = "Abgebrochen"; true};
