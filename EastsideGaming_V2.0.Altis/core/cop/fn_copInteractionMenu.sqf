...
if (player getVariable ["isEscorting",false]) then {
    { _x ctrlShow false; } forEach [_Btn0,_Btn1,_Btn2,_Btn3,_Btn4,_Btn6,_Btn7,_Btn8,_Btn9];
};
...
_Btn3 buttonSetAction "[player] remoteExecCall [""life_fnc_licenseCheck"",life_pInact_curTarget]; closeDialog 0;";
