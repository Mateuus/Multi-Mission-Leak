...
_invtitle = CONTROL(2001,2009);
_servstatus = CONTROL(2001,2024);
_struct = "";
lbClear _inv;
lbClear _near;
lbClear _near_i;
...
_invtitle ctrlSetStructuredText parseText format["<t align='left'>%1</t><t align='right'>Gewicht: %2/%3</t>",(player getVariable ["realname",name player]),life_carryweight, life_maxWeight];
_servstatus ctrlSetStructuredText parseText format["<t color='#345EBF'>Polizei: %1</t><br/><t color='#b0000d'>Feuerwehr: %2</t><br/>Zivilisten: %3<br/><t color='#00C25E'>Insgesamt: %4</t>",west countSide playableUnits,independent countSide playableUnits, civilian countSide playableUnits, count playableUnits];
...
",_struct];
_h = ctrlTextHeight _lic;
_w = (ctrlPosition _lic) select 2;
_lic ctrlSetPosition [0,0,_w,_h];
_lic ctrlCommit 0;