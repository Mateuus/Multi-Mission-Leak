...
if (_action) then {
	...
	_log = format["%1 (%2) hat ein Haus (Name: %3 | Position: %4) für %5$ gekauft.", player getVariable["realname", name player], getPlayerUID player, _houseName, getPosATL _house, [(_houseCfg select 0)]call life_fnc_numberText];
