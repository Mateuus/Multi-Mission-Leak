...
if (_action) then {
    ...
    for "_i" from 0 to 1 step 0 do {
        ...
        if (_cP >= 1) exitWith {};
        if (!alive player) exitWith {life_action_inUse = false; _t2 = "Abgebrochen";};
        if (life_interrupted) exitWith {life_interrupted = false; life_action_inUse = false; _t2 = "Abgebrochen";};
