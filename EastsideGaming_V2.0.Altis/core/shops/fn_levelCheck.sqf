...
if((["license_civ",_itemConfig]call bis_fnc_instring) && (playerSide in [west,independent])) exitWith {true};
if((["license_cop",_itemConfig]call bis_fnc_instring) && (playerSide isEqualTo independent)) exitWith {true};
