...
switch (playerSide) do {
    case civilian: {
		_initalPrice = M_CONFIG(getNumber,"LifeCfgVehicles",_classNameLife,"price_civ");
        _buyMultiplier = LIFE_SETTINGS(getNumber,"vehicle_purchase_multiplier_CIVILIAN");
        _rentMultiplier = LIFE_SETTINGS(getNumber,"vehicle_rental_multiplier_CIVILIAN");
    };
    case west: {
		_initalPrice = M_CONFIG(getNumber,"LifeCfgVehicles",_classNameLife,"price_cop");
    ...
    case independent: {
		_initalPrice = M_CONFIG(getNumber,"LifeCfgVehicles",_classNameLife,"price_med");
...
(CONTROL(2300,2303)) ctrlSetStructuredText parseText format [
    ...
    (localize "STR_Shop_Veh_UI_HPower")+ " %4 PS<br/>" +
