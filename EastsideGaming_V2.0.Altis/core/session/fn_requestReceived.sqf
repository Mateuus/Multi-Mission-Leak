...
switch (playerSide) do {
    case west: {
		...
		_idDB = _this select 12;
		ESG_loadout = _this select 13;
		_ausweis = _this select 14;
		ESG_skill = _this select 19;
    };
    ...
    case civilian: {
        ...
        ife_thirst = ((_this select 9) select 1);
		...
		_idDB = _this select 13;
		ESG_loadout = _this select 14;
		_ausweis = _this select 15;
		ESG_skill = _this select 19;
    };
    ...
    case independent: {
        ...
        player setDamage ((_this select 9) select 2);
		_idDB = _this select 11;
		ESG_loadout = _this select 12;
		_ausweis = _this select 13;
		ESG_skill = _this select 19;
    };
};
...
CONST(ESG_DBID, parseNumber(_idDB));
ESG_ausweis = _ausweis;
