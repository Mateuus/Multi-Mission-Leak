...
class truckColorSelectorUI
{
	...
	class Controls
	{
		class _CT_XSLIDER1
		{
			...
			onSliderPosChanged = "[_this,true] call life_fnc_updateUI; false";
		};
		...
		class _CloseButton: Life_RscButtonMenu
		{
			idc = 17505;
			type = 16;				
		...
		class _ActionButton: _CloseButton
		{
			idc = 17506;
