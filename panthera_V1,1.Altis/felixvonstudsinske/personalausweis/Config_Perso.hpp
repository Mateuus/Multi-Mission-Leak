...
class Personalausweis {
	...
	aenderungspreis = 50000; // Preis zum Ändern des Persos # price to change your id card
	...
	*/
	staatsbuergerschaften[] = {
		{"Staat Altis","felixvonstudsinske\personalausweis\persobilder\Personalausweis_altis_de.paa"},
		{"Bundesrepublik Deutschland","felixvonstudsinske\personalausweis\persobilder\Personalausweis_german_de.paa"}
	};
	erlaube_Indp_aendern = 0; // Fraktion erlauben Persodaten zu ändern
	erlaube_East_aendern = 0;
	erlaube_West_aendern = 0;
	...
	erlaubeMehrereNamen_indep = 0; // 1=Erlaube Nutzung anderer Namen, als im Perso hinterlegt # allow player to use different names as in database, 0=verbieten, disallow
	erlaubeMehrereNamen_west = 0; // 1=Erlaube Nutzung anderer Namen, als im Perso hinterlegt # allow player to use different names as in database, 0=verbieten, disallow
	erlaubeMehrereNamen_east = 0; // 1=Erlaube Nutzung anderer Namen, als im Perso hinterlegt # allow player to use different names as in database, 0=verbieten, disallow
	erlaubeMehrereNamen_civ = 0; // 1=Erlaube Nutzung anderer Namen, als im Perso hinterlegt # allow player to use different names as in database, 0=verbieten, disallow
	erlaubteZeichen[] = { 
		/*
	...
	*/
	...
	class persoBild
	{
		class 1
		{
			id = 1;
			name = "Bayh";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Bayh.jpg";
		};
		class 2
		{
			id = 2;
			name = "Burr";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Burr.jpg";
		};
		class 3
		{
			id = 3;
			name = "Byrne";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Byrne.jpg";
		};
		class 4
		{
			id = 4;
			name = "Campbell";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Campbell.jpg";
		};
		class 5
		{
			id = 5;
			name = "Christou";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Christou.jpg";
		};
		class 6
		{
			id = 6;
			name = "Coburn";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Coburn.jpg";
		};
		class 7
		{
			id = 7;
			name = "Collins";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Collins.jpg";
		};
		class 8
		{
			id = 8;
			name = "Dayton";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Dayton.jpg";
		};
		class 9
		{
			id = 9;
			name = "Dorgan";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Dorgan.jpg";
		};
		class 10
		{
			id = 10;
			name = "Doukas";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Doukas.jpg";
		};
		class 11
		{
			id = 11;
			name = "Gikas";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Gikas.jpg";
		};
		class 12
		{
			id = 12;
			name = "Halliwell";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Halliwell.jpg";
		};
		class 13
		{
			id = 13;
			name = "Hasan";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Hasan.jpg";
		};
		class 14
		{
			id = 14;
			name = "Jesus";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Jesus.jpg";
		};
		class 15
		{
			id = 15;
			name = "Johnson";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Johnson.jpg";
		};
		class 16
		{
			id = 16;
			name = "Kanelloupou";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Kanelloupou.jpg";
		};
		class 17
		{
			id = 17;
			name = "Kelly";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Kelly.jpg";
		};
		class 18
		{
			id = 18;
			name = "Kirby";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Kirby.jpg";
		};
		class 19
		{
			id = 19;
			name = "Martinez";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Martinez.jpg";
		};
		class 20
		{
			id = 20;
			name = "O Brien";
			pfad = "felixvonstudsinske\personalausweis\persobilder\O_Brien.jpg";
		};
		class 21
		{
			id = 21;
			name = "O Conner";
			pfad = "felixvonstudsinske\personalausweis\persobilder\O_Conner.jpg";
		};
		class 22
		{
			id = 22;
			name = "O Sullivan";
			pfad = "felixvonstudsinske\personalausweis\persobilder\O_Sullivan.jpg";
		};
		class 23
		{
			id = 23;
			name = "Reed";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Reed.jpg";
		};
		class 24
		{
			id = 24;
			name = "Santorum";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Santorum.jpg";
		};
		class 25
		{
			id = 25;
			name = "Savalas";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Savalas.jpg";
		};
		class 26
		{
			id = 26;
			name = "Smith";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Smith.jpg";
		};
		class 27
		{
			id = 27;
			name = "Snowe";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Snowe.jpg";
		};
		class 28
		{
			id = 28;
			name = "Walsh";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Walsh.jpg";
		};
		class 29
		{
			id = 29;
			name = "Williams";
			pfad = "felixvonstudsinske\personalausweis\persobilder\Williams.jpg";
		};
	};
};
