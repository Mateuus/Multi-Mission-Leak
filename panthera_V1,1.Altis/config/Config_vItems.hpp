...
class VirtualShops {
    ...
    class market {
        ...
        side = "civ";
        conditions = "";
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "banana", "pickaxe", "axe", "shovel", "toolkit", "fuelFull", "peach", "storagesmall", "storagebig", "rabbit_raw", "hen_raw", "rooster_raw", "sheep_raw", "goat_raw" };
    };
    ...
    class rebel {
        ...
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "axe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge"};
    };
	...
	class wood {
        ...
        side = "civ";
        conditions = "";
        items[] = { "wood_processed" };
    };
	
	class schrott {
        name = "STR_Shops_Schrott";
        side = "civ";
        conditions = "";
        items[] = { "schrott2" };
    };
	...
	class coal {
        ...
        side = "civ";
        conditions = "";
        items[] = { "coal", "coal2", "coal3" };
    };
	
	class treasures {
        name = "STR_Shops_Treasures";
        side = "civ";
        conditions = "";
        items[] = { "pearl", "goldcoin", "fossile", "treasure" };
    };
...
class VirtualItems {
	...
	class wood_unprocessed {
        variable = "woodUnprocessed";
    ...
    class wood_processed {
        variable = "woodProcessed";
	...
	class schrott2 {
        variable = "schrott2";
        displayName = "STR_Item_Schrott2";
        weight = 3;
        buyPrice = -1;
        sellPrice = 1800;
        illegal = false;
        edible = -1;
        icon = "icons\ico_schrott2.paa";
    };
	
	class cpu {
        variable = "cpu";
        displayName = "STR_Item_Cpu";
        weight = 2;
        buyPrice = -1;
        sellPrice = 3800;
        illegal = false;
        edible = -1;
        icon = "icons\ico_cpu.paa";
    };
	...
	class coal2 {
        variable = "coal2";
        displayName = "STR_Item_Coal2";
        weight = 2;
        buyPrice = -1;
        sellPrice = 2400;
        illegal = false;
        edible = -1;
        icon = "icons\ico_coal2.paa";
    };
	
	class coal3 {
        variable = "coal3";
        displayName = "STR_Item_Coal3";
        weight = 1;
        buyPrice = -1;
        sellPrice = 7000;
        illegal = false;
        edible = -1;
        icon = "icons\ico_coal3.paa";
    };
	...
	class fossile {
        variable = "fossile";
        displayName = "STR_Item_Fossile";
        weight = 4;
        buyPrice = -1;
        sellPrice = 3830
        illegal = true;
        edible = -1;
        icon = "icons\fossile.paa";
    };
