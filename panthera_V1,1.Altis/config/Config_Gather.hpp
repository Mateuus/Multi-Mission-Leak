...
*/
    ...
    class Minerals {
		...
		class treasure_diving {
            amount = 2;
            zones[] = { "treasure_diving_1", "treasure_diving_2" };
            item = "shovel";
            mined[] = { {"pearl",0,50},{"goldcoin",50,75},{"fossile",75,97},{"treasure",97,100} };
            zoneSize = 30;
        };
    };
};