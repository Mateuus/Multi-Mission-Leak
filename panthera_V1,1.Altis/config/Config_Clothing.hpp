...
class Clothing {
    class bruce {
        ...
        uniforms[] = {
			...
			{ "U_B_HeliPilotCoveralls", "Pilot", 1200, { "", "", -1 } },
        ...
        backpacks[] = {
            ...
            { "B_Bergen_dgtl_f", "", 66500, { "", "", -1 } }, //Apex DLC
            { "B_Bergen_tna_f", "", 66500, { "", "", -1 } } //Apex DLC
        };
    };
    ...
    class cop {
        ...
        uniforms[] = {
            ...
            { "U_B_CombatUniform_mcam_tshirt", "", 350, { "life_coplevel", "SCALAR", 4 } },
            { "U_B_CombatUniform_mcam_worn", "", 550, { "life_coplevel", "SCALAR", 4 } },
            { "U_B_survival_uniform", "", 1250, { "life_coplevel", "SCALAR", 4 } }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_Cap_police", "", 25, { "", "", -1 } },
    ...
    class med_clothing {
        ...
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
            { "U_BG_Guerilla2_1", "EMS Uniform", 50, { "", "", -1 } }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_Cap_blu", "", 10, { "", "", -1 } }
