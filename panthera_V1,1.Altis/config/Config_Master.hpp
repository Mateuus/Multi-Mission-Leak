...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "pickaxe", "axe", "shovel", "fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit" }; //Array of virtual items that can be saved on your player.
    ...
    save_vehicle_items[] = { "pickaxe", "axe", "shovel", "fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit" };
...
/* System Settings */
	...
	vehicle_impound_fee_multiplier = .4; //Pull from impound Garage cost --> Cost takes the playersides Buy Price * multiplier
    ...
    vehicle_storage_fee_multiplier = .005; //Pull from garage cost --> Cost takes the playersides Buy Price * multiplier
