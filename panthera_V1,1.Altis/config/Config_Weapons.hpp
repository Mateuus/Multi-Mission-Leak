...
class WeaponShops {
    ...
    class gun {
        ...
        items[] = {
			...
			{ "srifle_DMR_06_olive_F", "", 150000, -1, { "", "", -1 } },
    ...
    class rebel {
        ...
        items[] = {
			...
			{ "LMG_Mk200_F", "", 2000000, 7500, { "", "", -1 } },
			{ "srifle_EBR_F", "", 200000, 7500, { "", "", -1 } },
        ...
        accs[] = {
			...
			{ "optic_DMS", "", 7500, 100, { "", "", -1 } },
            { "acc_flashlight", "", 1000, 100, { "", "", -1 } },
			{ "optic_AMS", "", 1000, 100, { "", "", -1 } }
        };
    };
    ...
    class cop_basic {
        ...
        items[] = {
			...
			{ "SatchelCharge_Remote_Mag", "", 250, 100, {"life_coplevel", "SCALAR", 3 } },
