...
_role2names = ["Zeeanq Licious","Talyn Dane","Rexstar9"];
_role3 = "Teamspeak Admin";
_role3names = ["Talyn Dane"];
_role4 = "Head Support Leitung";
_role4names = ["Tim Taylor"];
_role5 = "Supportleitung";
_role5names = ["Jack Brown","Cube"];
_role6 = "Supporter";
_role6names = ["Rico"];
_role7 = "Tester";
_role7names = ["Poul Wayts","Rico"];
_role8 = "Scripting";
_role8names = ["Cris","Zeeanq Licious","Rexstar9"];
_role9 = "Designe by";
_role9names = ["Talyn Dane"];
_role10 = "Polizei Leitung";
_role10names = ["Kent Block"];
