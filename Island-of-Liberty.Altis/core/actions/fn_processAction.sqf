...
_itemInfo = switch (_type) do {
	...
	case "bretter": {[[["holz",1]],[["bretter",1]],450,(localize "STR_Process_Moebel")];};
	...
	case "mash": {[[["pilze",1]],[["mash",1]],500,(localize "STR_Process_Mash")];};
	case "cement": {[[["rock",1]],[["cement",1]],350,(localize "STR_Process_Cement")];};
	case "uranium_cleaned": {[[["uranium_ore",1]],[["uranium_cleaned",1]],5350,(localize "STR_Process_reinigen")];};
	case "uranium_processed": {[[["uranium_cleaned",1]],[["uranium_processed",1]],7350,(localize "STR_Process_verarbeiten")];};
	case "uranium_enriched": {[[["uranium_processed",1]],[["uranium_enriched",1]],10350,(localize "STR_Process_anreichern")];};
	case "uranium_fuelrod": {[[["uranium_enriched",1]],[["uranium_fuelrod",1]],12350,(localize "STR_Process_brennstabherstellen")];};
	case "uranium_dirty": {[[["uranium_enriched",1]],[["uranium_dirty",1]],16350,(localize "STR_Process_uranstrecken")];};
	case "rye": {[[["rye",1]],[["lsd",1]],350,(localize "STR_Process_Rye")];};
	case "metal": {[[["metal",1]],[["nplate",1]],5000,(localize "STR_MIS_Nplate")];};
	case "artefact": {[[["artefact",1]],[["artefactg",1]],8000,(localize "STR_MIS_Nplate")];};
...
if(_hasLicense) then {
	[player,"drogenmaschine", 31] call life_fnc_globalSound;
	while{true} do {
		sleep  0.28;
		_cP = _cP + 0.01;
