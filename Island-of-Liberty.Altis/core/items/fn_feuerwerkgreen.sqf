...
life_action_feuerwerkDeploy = player addAction["<t color='#009900'>Feuerwerk aufstellen</t>",{if(!isNull life_feuerwerk) then {detach life_feuerwerk; life_feuerwerk = ObjNull;}; player removeAction life_action_feuerwerkDeploy; life_action_feuerwerkDeploy = nil;},"",999,false,false,"",'!isNull life_feuerwerk'];
...
[getPos _feuerwerk, 'random','green'] remoteExec ["life_fnc_callFireworks",0];
