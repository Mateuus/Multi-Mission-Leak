...
life_action_feuerwerkDeploy = player addAction["<t color='#C0C0C0'>Feuerwerk aufstellen</t>",{if(!isNull life_feuerwerk) then {detach life_feuerwerk; life_feuerwerk = ObjNull;}; player removeAction life_action_feuerwerkDeploy; life_action_feuerwerkDeploy = nil;},"",999,false,false,"",'!isNull life_feuerwerk'];
...
[getPos _feuerwerk, 'random','white'] remoteExec ["life_fnc_callFireworks",0];
