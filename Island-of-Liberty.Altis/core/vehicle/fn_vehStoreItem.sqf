...
if((_ctrl == "artefact" || _ctrl == "artefactg" || _ctrl == "artefactb") && {!(life_trunk_vehicle isKindOf "Ship")}) exitWith {hint "Sie können die Artefakte im Boot transportieren!"};
...
if(!(typeOf life_trunk_vehicle in ["C_Van_01_fuel_F","O_Truck_02_fuel_F","O_Truck_03_fuel_F","B_Truck_01_fuel_F"]) && _ctrl in ["oil_unprocessed","oil_processed"]) exitWith {hint "Du kannst das da nicht einfach reinleeren! Du brauchst schon einen Tankwagen"};
