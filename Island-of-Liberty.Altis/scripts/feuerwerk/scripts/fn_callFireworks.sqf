if (isServer || isDedicated) then {
	...
	_launchSound = ["launch1","launch2","launch3","launch4","launch5","launch6","launch7"] call BIS_fnc_selectRandom;
	_whistlingSound = ["whistling1","whistling2","whistling3","whistling4"] call BIS_fnc_selectRandom;
	_bangSound = ["bang01","bang02","bang03","bang04","bang05","bang06","bang07","bang08","bang10","bang11"] call BIS_fnc_selectRandom;
	_singleFizz = ["fizz_single_type1_1","fizz_single_type1_2","fizz_single_type1_3","fizz_single_type1_4","fizz_single_type2_1","fizz_single_type2_2","fizz_single_type2_3","fizz_single_type2_4"];
	...
	[_firing_position,_type,_initial_velocity,_explosion_power,_glitter_count,_color,_explosion_fragments_array,_explosion_subfragments_array,_randomSleep,_randomSleepLong,_randomLaunch,_launchSound,_whistlingSound,_bangSound,_singleFizz,_groupFizz,_randomSleepShort] remoteExec ["life_fnc_fireworks",0]; //, "life_fnc_fireworks"] spawn life_fnc_MP;
};
