...
*/
private["_vehicle","_vehicleLife","_vid","_pid","_unit","_price","_price","_storageFee","_purchasePrice","_cops"];
...
{
if(((_x getVariable "rank") > 5) || ((_x getVariable "swatrank") > 0)) then {
_cops = _cops + 1;
};
...
if((_cops < 3) && (_vehicleLife in ["I_Plane_Fighter_03_CAS_F","O_Plane_CAS_02_F","B_Plane_CAS_01_F","B_T_VTOL_01_armed_F","O_Heli_Light_02_F"])) then {
