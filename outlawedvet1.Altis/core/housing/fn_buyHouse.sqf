...
if(player distance (getMarkerPos "Private Military Corperation_1") < 250) exitWith { hint "You are NOT allowed to buy houses close to the Private Military Corperation";};
if(player distance (getMarkerPos "BlackMarket_1") < 250) exitWith { hint "You are NOT allowed to buy houses close to the Blackmarket";};
if(player distance (getMarkerPos "gold_bar_dealer_1_2") < 90) exitWith { hint "You are NOT allowed to buy houses close to the Treasure buyer";};
if(player distance (getMarkerPos "gold_bar_dealer_1_1_2") < 90) exitWith { hint "You are NOT allowed to buy houses close to the Treasure buyer";};
