...
switch (playerSide) do {
    case west: {
		...
		CONST(life_swatlevel,(_this select 15));
		CONST(life_armylevel,(_this select 16));
        CONST(life_medicLevel,0);
        life_blacklisted = _this select 9;
		
		life_tempban = _this select 12;
		life_dayban = _this select 13;
		life_permban = _this select 14;
		...
		life_playtime = ((_this select 17) select 0);
    };
    ...
    case civilian: {
		...
		life_tempban = _this select 13;
		life_dayban = _this select 14;
		life_permban = _this select 15;
		life_combatlog = _this select 16;
		...
		life_playtime = ((_this select 19) select 2);
    };
    ...
    case independent: {
		...
		life_playtime = ((_this select 16) select 1);
		
		life_tempban = _this select 11;
		life_dayban = _this select 12;
		life_permban = _this select 13;
		life_is_arrested = _this select 14;
		life_combatlog = _this select 15;
    };
};

//RPG error scale check and fix.
if ((life_hunger > 100) || (life_hunger < 0)) then {
life_hunger = 50;
};

if ((life_thirst > 100) || (life_thirst < 0)) then {
life_thirst = 50;
};
