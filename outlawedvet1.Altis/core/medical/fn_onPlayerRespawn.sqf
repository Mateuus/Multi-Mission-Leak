...
//diag_log format["onplayer killed gear: %1",life_save_gear];
//Life_containers = _containers;
//diag_log format["onplayer killed gear: %1",Life_containers];
...
if (LIFE_SETTINGS(getNumber,"enable_stamina") isEqualTo 0) then {player enablestamina false;};
if (LIFE_SETTINGS(getNumber,"enable_setcustomaimcoef") isEqualTo 1) then {player setCustomAimCoef 0.15;};
