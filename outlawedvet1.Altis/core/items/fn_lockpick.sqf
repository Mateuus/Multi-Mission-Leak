...
if(playerSide != civilian) exitWith { hint "This is illegal equipment, you aren't supposed to use this."};
if ((getMarkerPos "campnorth") distance player < 400) exitWith {hint "You can not steal a vehicle in rebel camp!";};
if ((getMarkerPos "campsouth") distance player < 400) exitWith {hint "You can not steal a vehicle in rebel camp!";};
