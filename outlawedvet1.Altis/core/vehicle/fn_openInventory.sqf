...
if (isNull _vehicle OR !(("Land_Wreck_Traw_F" == typeOf _vehicle) OR ("Land_Wreck_Traw2_F" == typeOf _vehicle) OR ("Land_WoodenBox_F" == typeOf _vehicle) OR _vehicle isKindOf "Car" || _vehicle isKindOf "Air" || _vehicle isKindOf "Ship" || _vehicle isKindOf "Tank" || _vehicle isKindOf "Box_IND_Grenades_F" || _vehicle isKindOf "B_supplyCrate_F")) exitWith {}; //Either a null or invalid vehicle type.
