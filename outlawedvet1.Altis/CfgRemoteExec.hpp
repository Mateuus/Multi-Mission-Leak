...
class CfgRemoteExec {
    class Functions {
		...
		F(life_fnc_adminactions,CLIENT)
		F(life_fnc_adminaapromotions,CLIENT)
		F(life_fnc_adminaspromotions,CLIENT)
		F(life_fnc_adminrevive,CLIENT)
		F(life_fnc_adminreactions,CLIENT)
		F(life_fnc_adminrapromotions,CLIENT)
		F(life_fnc_adminrspromotions,CLIENT)
		F(life_fnc_bankfast,CLIENT)
		F(life_fnc_swatcommander,CLIENT)
		F(life_fnc_armycommander,CLIENT)
		F(life_fnc_medicshoot,CLIENT)
		F(life_fnc_blacklistShootCop,CLIENT)
		F(life_fnc_autoSave,CLIENT)
		F(life_fnc_jihad,CLIENT)
		F(life_fnc_lmenu,CLIENT)
		F(life_fnc_lprice,CLIENT)
		F(life_fnc_lactions,CLIENT)
		F(life_fnc_admin,CLIENT)
		
		
        /* Server only functions */
        F(BIS_fnc_execVM,SERVER)
        F(DB_fnc_insertRequest,SERVER)
        F(DB_fnc_queryReq,SERVER)
		...
		F(life_fnc_releaseplayer,ANYONE)
		F(life_fnc_setupCellPhone,CLIENT)
		F(life_fnc_AAN,ANYONE)
		...
		F(life_fnc_lockcarsound,ANYONE)
