...
while {true} do 
    ...
    ((uiNamespace getVariable "osefstatusbar")displayCtrl 555556)ctrlSetStructuredText parseText 
            format["<t shadow='1' shadowColor='#000000'><img size='1.6' shadowColor='#000000' image='icons\statusbar\ico_players.paa' color='#FFFFFF'/>%1 <img size='1.6' shadowColor='#000000' image='icons\statusbar\ico_players.paa' color='#3399FF'/>%2 <img size='1.6' shadowColor='#000000' image='icons\statusbar\ico_players.paa' color='#009933'/>%3 <img size='1.6' shadowColor='#000000' image='icons\statusbar\ico_map.paa'/>%4 <img size='1.6' shadowColor='#000000' image='icons\statusbar\ico_hunger.paa' color='%6'/>%5 <img size='1.6' shadowColor='#000000' image='icons\statusbar\ico_thirst.paa' color='%8'/>%7 <img size='1.6' shadowColor='#000000' image='icons\statusbar\ico_damage.paa' color='%10'/>%9 <img size='1.6' shadowColor='#000000' image='icons\statusbar\ico_fps.paa' color='%12'/>%11 <img size='1.6'  shadowColor='#000000' image='icons\statusbar\ico_restart.paa' color='%14'/>%13</t>",_CivplayHUD,_WestplayHUD,_IndepplayHUD, format["%1/%2",_xx,_yy], _hunger, _colourHunger, _thirst, _colourThirst, _damage, _colourDamage, _FpsHud, _colourFps, _UpTimeHUD, _colourUpTimeHUD,_players,_energyPercent,_colourDefault];
			
    ((uiNamespace getVariable "osefstatusbar")displayCtrl 555557)ctrlSetStructuredText parseText 
            format["<t shadow='1' shadowColor='#000000'><img size='1.6' shadowColor='#000000' image='icons\ico_money.paa'/> %1",_cash];
			
    ((uiNamespace getVariable "osefstatusbar")displayCtrl 555558)ctrlSetStructuredText parseText 
            format["<t shadow='1' shadowColor='#000000'><img size='1.6' shadowColor='#000000' image='icons\ico_bank.paa'/> %1",_bank];
    }; 
};
