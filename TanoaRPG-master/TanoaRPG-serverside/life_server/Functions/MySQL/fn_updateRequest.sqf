...
*/ 
if(!isNull life_hc_inUse) exitWith {_this remoteExec ["DB_fnc_updateRequest", life_hc_inUse]}; 
...
switch (_side) do { 
 ...
 case east: {_query = format["UPDATE players SET name='%1', cash='%2', bankacc='%3', adac_licenses='%4', adac_gear='%6' WHERE playerid='%5'",_name,_cash,_bank,_licenses,_uid,_gear];}; 
}; 
