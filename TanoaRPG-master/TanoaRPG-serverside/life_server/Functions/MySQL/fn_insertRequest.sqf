...
*/ 
if(!isNull life_hc_inUse) exitWith {_this remoteExec ["DB_fnc_insertRequest", life_hc_inUse]}; 
 
private["_uid","_name","_side","_money","_bank","_licenses","_handler","_thread","_queryResult","_query","_alias"]; 
_uid = [_this,0,"",[""]] call BIS_fnc_param; 
_name = [_this,1,"",[""]] call BIS_fnc_param; 
_money = [_this,2,50000,[""]] call BIS_fnc_param; 
_bank = [_this,3,150000,[""]] call BIS_fnc_param; 
...
if(typeName _queryResult == "STRING") exitWith {[] remoteExec ["XAS_fnc_dataQuery",(owner _returnToSender),false];}; 
if(count _queryResult != 0) exitWith {[] remoteExec ["XAS_fnc_dataQuery",(owner _returnToSender),false];}; 
...
[] remoteExec ["XAS_fnc_dataQuery",(owner _returnToSender),false];