...
_bank = [_this,3,650000,[""]] call BIS_fnc_param; 
...
if(typeName _queryResult == "STRING") exitWith {[] remoteExec ["XAS_fnc_dataQuery",_returnToSender,false];}; //NEU DA HC OHNE OWNER 
if(count _queryResult != 0) exitWith {[] remoteExec ["XAS_fnc_dataQuery",_returnToSender,false];}; //NEU DA HC OHNE OWNER 
...
[] remoteExec ["XAS_fnc_dataQuery",_returnToSender,false]; //NEU DA HC OHNE OWNER