...
if(isNull _unit) exitWith {}; //NEU DA HC OHNE OWNER 
_id = _unit; //NEU DA HC OHNE OWNER 
//_id = owner _unit; //NEU DA HC OHNE OWNER 
 
_ret = [_unit] call tanoarpg_fnc_wantedPerson; 
[_ret,_bad,_time] remoteExec ["tanoarpg_fnc_jailMe",_id,false];