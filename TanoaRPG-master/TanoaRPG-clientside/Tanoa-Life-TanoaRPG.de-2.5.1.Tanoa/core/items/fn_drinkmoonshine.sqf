...
closeDialog 0;
hintSilent parseText format["Dein Blutalkoholpegel beträgt nun <br/> <t size='1.4'><t color='#FF0000'>%1</t></t> Promille",[life_drink] call tanoarpg_fnc_numberText];
sleep 4;
...
if (life_drink > 0.22) then {
			...
			[0,format[localize "STR_MISC_StPubIntox",profileName]] remoteExec ["tanoarpg_fnc_broadcast", -2, false];
			[getPlayerUID player,profileName,"390"] remoteExec ["tanoarpg_fnc_wantedAdd", 2, false];
