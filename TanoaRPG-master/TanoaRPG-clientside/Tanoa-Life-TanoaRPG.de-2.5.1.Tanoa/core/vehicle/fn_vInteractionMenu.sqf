...
_Btn1 buttonSetAction "[life_vInact_curTarget] spawn tanoarpg_fnc_repairTruck;";

//Disable Showing of Button 7
...
//Abschleppen für den ADAC|Medics
if(playerSide == independent) then {
	_Btn5 ctrlShow true;
	_Btn5 ctrlSetText localize "STR_vInAct_Impound";
	_Btn5 buttonSetAction "[life_vInact_curTarget] spawn tanoarpg_fnc_impoundAction;";

	_Btn7 ctrlShow true;
	_Btn7 ctrlEnable true;
	_Btn7 ctrlSetText localize "STR_vInAct_Registration";
	_Btn7 buttonSetAction "[life_vInact_curTarget] spawn tanoarpg_fnc_searchVehAction;";

	_Btn4 ctrlSetText localize "STR_vInAct_PullOut";
	_Btn4 buttonSetAction "[life_vInact_curTarget] spawn tanoarpg_fnc_pulloutAction;";
	if(count crew _curTarget == 0) then {_Btn4 ctrlEnable false;};
};

if(playerSide == west) then {
	_Btn2 ctrlSetText localize "STR_vInAct_Registration";
	_Btn2 buttonSetAction "[life_vInact_curTarget] spawn tanoarpg_fnc_searchVehAction;";

	_Btn3 ctrlSetText localize "STR_vInAct_SearchVehicle";
	_Btn3 buttonSetAction "[life_vInact_curTarget] spawn tanoarpg_fnc_vehInvSearch;";
	...
	if(_curTarget isKindOf "Ship") then {
		...
		_Btn6 buttonSetAction "[] spawn tanoarpg_fnc_pushObject; closeDialog 0;";
	...
	_Btn7 buttonSetAction "[life_vInact_curTarget] spawn tanoarpg_fnc_impoundActionPerm;";

} else {

	if(_curTarget isKindOf "Ship") then {
		_Btn2 ctrlSetText localize "STR_vInAct_PushBoat";
		_Btn2 buttonSetAction "[] spawn tanoarpg_fnc_pushObject; closeDialog 0;";
	...
	if(typeOf _curTarget == "O_Truck_03_device_F") then {
		...
		_Btn3 buttonSetAction "[life_vInact_curTarget] spawn tanoarpg_fnc_deviceMine";
