...
if(local _vehicle) then {
	...
	{
	case "C_Offroad_01_F": {[_vehicle, "color", 3, true] remoteExec ["TEX_fnc_setObjVar", 2, false]; };
	case "C_Hatchback_01_F": {[_vehicle, "color", 1, true] remoteExec ["TEX_fnc_setObjVar", 2, false]; };
	case "C_Hatchback_01_sport_F": {[_vehicle, "color", 1, true] remoteExec ["TEX_fnc_setObjVar", 2, false]; };
	case "C_SUV_01_F": {[_vehicle, "color", 1, true] remoteExec ["TEX_fnc_setObjVar", 2, false]; };
	case "C_Van_01_box_F": {[_vehicle, "color", 1, true] remoteExec ["TEX_fnc_setObjVar", 2, false]; };
	case "C_Van_01_transport_F": {[_vehicle, "color", 1, true] remoteExec ["TEX_fnc_setObjVar", 2, false]; };
	};
};

//Fetch texture from our present array.
_texture = [(typeOf _vehicle)] call tanoarpg_fnc_vehicleColorCfg;
