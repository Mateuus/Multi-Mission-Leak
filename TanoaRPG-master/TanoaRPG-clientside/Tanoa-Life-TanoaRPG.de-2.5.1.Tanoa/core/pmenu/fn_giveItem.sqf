...
if(!([_val] call TEX_fnc_isnumber)) exitWith {hint "You didn't enter an actual number format.";ctrlShow[2002,true];};
...
if(!([false,_item,(parseNumber _val)] call tanoarpg_fnc_handleInv)) exitWith {hint "Couldn't give that much of that item, maybe you don't have that amount?";ctrlShow[2002,true];};
[_unit,_val,_item,player] remoteExec ["tanoarpg_fnc_receiveItem", _unit, false];
