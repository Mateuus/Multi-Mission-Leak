...
if(!([_val] call TEX_fnc_isnumber)) exitWith {};
if(_unit == _from) exitWith {}; //Bad boy, trying to exploit his way to riches.

hint format["%1 has given you $%2",_from getVariable["realname",name _from],[(parseNumber (_val))] call tanoarpg_fnc_numberText];
