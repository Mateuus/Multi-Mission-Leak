...
_door = [_house] call tanoarpg_fnc_nearestDoor;
...
[2,"STR_House_Raid_NOTF",true,[(_house getVariable "house_owner") select 1]] remoteExec ["tanoarpg_fnc_broadcast", -2, false];
