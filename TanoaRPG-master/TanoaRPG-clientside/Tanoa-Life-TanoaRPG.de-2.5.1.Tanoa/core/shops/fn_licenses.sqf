...
_longname = ([_shortname, 0] call tanoarpg_fnc_licenseType) select 0;
_displayname = ([_shortname, 0] call tanoarpg_fnc_licenseType) select 1;
_price = [_shortname] call tanoarpg_fnc_licensePrice;
