...
{
	case "bruce": {[_selection] call tanoarpg_fnc_clothing_bruce;};
	case "cop": {[_selection] call tanoarpg_fnc_clothing_cop;};
	case "reb": {[_selection] call tanoarpg_fnc_clothing_reb;};
	case "dive": {[_selection] call tanoarpg_fnc_clothing_dive;};
	case "medic": {[_selection] call tanoarpg_fnc_clothing_medic;};
	case "pe": {[_selection] call tanoarpg_fnc_clothing_pe;};
	case "adac": {[_selection] call tanoarpg_fnc_clothing_adac;};
	case "imperium": {[_selection] call tanoarpg_fnc_clothing_imperium;};
	case "cart": {[_selection] call tanoarpg_fnc_clothing_cart;};
	case "ateam": {[_selection] call tanoarpg_fnc_clothing_ateam;};
	case "qt": {[_selection] call tanoarpg_fnc_clothing_qt;};
};

if(count _clothes == 0) exitWith {};
{
	_details = [_x select 0] call tanoarpg_fnc_fetchCfgDetails;
