...
for "_i" from 0 to (count life_vehicles)-1 do
{
	...
	{
		_price = [_veh] call tanoarpg_fnc_impoundPrice;
		switch (true) do
		{
		...
		_color = [(typeOf _veh),(_veh getVariable "Life_VEH_color")] call tanoarpg_fnc_vehicleColorStr;
		...
		_cars lbAdd format["%1 %2 - Cost: $%3",_name,_text,[_price] call tanoarpg_fnc_numberText];
