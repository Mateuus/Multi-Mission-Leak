...
if(!(createDialog "life_spawn_selection")) exitWith {[] call tanoarpg_fnc_spawnMenu;};
(findDisplay 38500) displaySetEventHandler ["keyDown","_this call tanoarpg_fnc_displayHandler"];

_spCfg = [playerSide] call tanoarpg_fnc_spawnPointCfg;
...
[((findDisplay 38500) displayCtrl 38502),1,0.1,getMarkerPos (_sp select 0)] call tanoarpg_fnc_setMapPosition;
