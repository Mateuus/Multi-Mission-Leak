...
{
	_vehicleInfo = [_x select 2] call tanoarpg_fnc_fetchVehInfo;
...
/*
{
	...
	_price = [_x select 2,__GETC__(life_garage_prices)] call TEX_fnc_index;
	_sPrice = [_x select 2,__GETC__(life_garage_sell)] call TEX_fnc_index;
	...
	_control lbAdd format["%1 - %4 Fee: $%2 || %5: $%3", _displayName,[_price] call tanoarpg_fnc_numberText,[_sPrice] call tanoarpg_fnc_numberText,localize "STR_Garage_SFee",localize "STR_Garage_SellPrice"];
