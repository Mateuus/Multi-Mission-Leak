class nanoEMPConsole {
	...
	//onLoad = "[] spawn tanoarpg_fnc_openEmpMenu;";
	...
	class controls {
		...
		class Refresh : Life_RscButtonMenu {
			idc = -1;
			text = "Suchen";
			onButtonClick = "[] spawn tanoarpg_fnc_scanVehicles;";
		...
		class ExecEMP : Life_RscButtonMenu {
			idc = 2070;
			text = "Auslösen";
			onButtonClick = "[] spawn tanoarpg_fnc_empVehicle;";
		...
		class WarnEMP : Life_RscButtonMenu {
			idc = 2060;
			text = "Warnen";
			onButtonClick = "[] spawn tanoarpg_fnc_warnVehicle;";
