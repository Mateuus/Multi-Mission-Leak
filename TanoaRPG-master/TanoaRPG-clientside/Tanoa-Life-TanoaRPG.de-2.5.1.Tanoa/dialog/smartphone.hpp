class Life_my_smartphone {
	...
	onLoad = "[] spawn tanoarpg_fnc_smartphone;";
	...
	class controls {
		...
		{
			idc = 88881;
			onLBSelChanged = "[2] spawn tanoarpg_fnc_smartphone;";
		...
		{
			idc = 88882;
			onLBSelChanged = "[(lbCurSel 88882)] call tanoarpg_fnc_showMsg;";
			//sizeEx = 0.04;
			sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
		...
		class CloseLoadMenu : Life_RscButtonMenu {
			...
			onButtonClick = "closeDialog 0;[] call tanoarpg_fnc_p_updateMenu";
		...
		class DeleteMessages : Life_RscButtonMenu {
			...
			onButtonClick = "[3] call tanoarpg_fnc_smartphone;";
			colorBackground[] = { 0.584, 0.086, 0.086, 1.0 };
			x = 0 + 0.7 - (6.25 / 40);
			y = 0.25 + (1 / 25) + 0.51;
			w = (6.25 / 20);
...
class Life_smartphone_schreiben
{
	...
	movingEnable = false;
	enableSimulation = true;
	onLoad = "[0,(lbData[88881,(lbCurSel 88881)])] spawn tanoarpg_fnc_newMsg;";
	...
	class controls {
		...
		class Absenden : Life_RscButtonMenu {
			...
			onButtonClick = "[1,-1,(ctrlText 88884)] call tanoarpg_fnc_newMsg;";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 1.0};
			x = 0.6 - (6.25 / 40) + 0.088;
			y = 0.3 + (1 / 25)  - 0.048;
			w = (6.25 / 40);
		...
		class AdminMsg : life_RscButtonMenu 
		{
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 1.0};
			onButtonClick = "[5,-1,(ctrlText 88884)] call tanoarpg_fnc_newMsg;";
...
class Life_smartphone_notruf {
	...
	movingEnable = false;
	enableSimulation = true;
	onLoad = "[6] spawn tanoarpg_fnc_newMsg;";
	...
	class controls {
		...
		class TxtCopButton : life_RscButtonMenu 
		{
			...
			colorBackground[] = {0.584, 0.086, 0.086,1.0};
			onButtonClick = "[2,-1,(ctrlText 888894)] call tanoarpg_fnc_newMsg;";
		...
		class TxtCopToAllButton : life_RscButtonMenu 
		{
			idc = 888905;
			text = "$STR_CELL_PoliceTextToAll";
			colorBackground[] = {0.584, 0.086, 0.086,1.0};
			onButtonClick = "[9,-1,(ctrlText 888894)] call tanoarpg_fnc_newMsg;";
		...
		class TxtAdminButton : life_RscButtonMenu 
		{
			...
			colorBackground[] = {0.584, 0.086, 0.086,1.0};
			onButtonClick = "[3,-1,(ctrlText 888894)] call tanoarpg_fnc_newMsg;";
		...
		class AdminMsgAll : life_RscButtonMenu 
		{
			...
			colorBackground[] = {0.584, 0.086, 0.086,1.0};
			onButtonClick = "[7,-1,(ctrlText 888894)] call tanoarpg_fnc_newMsg;";
		...
		class EMSReq : life_RscButtonMenu
		{
			...
			colorBackground[] = {0.584, 0.086, 0.086,1.0};
			onButtonClick = "[4,-1,(ctrlText 888894)] call tanoarpg_fnc_newMsg;";
		...
		class ImperiumReq : life_RscButtonMenu
		{
			idc = 888900;
			text = "$STR_CELL_ImperiumRequest";
			colorBackground[] = {0.584, 0.086, 0.086,1.0};
			onButtonClick = "[8,-1,(ctrlText 888894)] call tanoarpg_fnc_newMsg;";
		...
		class TxtImpToAllButton : life_RscButtonMenu 
		{
			idc = 888994;
			text = "$STR_CELL_ImperiumTextToAll";
			colorBackground[] = {0.584, 0.086, 0.086,1.0};
			onButtonClick = "[10,-1,(ctrlText 888894)] call tanoarpg_fnc_newMsg;";
