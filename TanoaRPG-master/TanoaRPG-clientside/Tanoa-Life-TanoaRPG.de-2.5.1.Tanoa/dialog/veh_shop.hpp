class Life_vehicle_shop {
	...
	class controls {
		...
		class VehicleList : Life_RscListBox 
		{
			...
			sizeEx = 0.035;
			colorBackground[] = {0,0,0,0};
			onLBSelChanged = "[_this] call tanoarpg_fnc_vehicleColorList";
		...
		class GetCar : life_RscButtonMenu {
			idc = -1;
			text = "$STR_Global_Buy";
			onButtonClick = "[] spawn tanoarpg_fnc_vehicleShopBuy";
		...
		class GetCarGarage : life_RscButtonMenu {
			...
			onButtonClick = "[] spawn tanoarpg_fnc_vehicleShopBuySave";
