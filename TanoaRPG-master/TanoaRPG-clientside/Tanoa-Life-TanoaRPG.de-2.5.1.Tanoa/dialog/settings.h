class SettingsMenu
{
	...
	class controls
	{
		...
		class VD_onfoot_slider : life_RscXSliderH 
		{
			idc = 2901;
			text = "";
			onSliderPosChanged = "[0,_this select 1] call tanoarpg_fnc_s_onSliderChange;";
		...
		class VD_car_slider : life_RscXSliderH 
		{
			idc = 2911;
			text = "";
			onSliderPosChanged = "[1,_this select 1] call tanoarpg_fnc_s_onSliderChange;";
		...
		class VD_air_slider : life_RscXSliderH 
		{
			idc = 2921;
			text = "";
			onSliderPosChanged = "[2,_this select 1] call tanoarpg_fnc_s_onSliderChange;";
		...
		class SideChatONOFF : PlayerTagsONOFF
		{
			idc = 2971;
			tooltip = "";
			action = "[] call tanoarpg_fnc_sidechat;";
			y = 0.48;
		};
