...
class marketView
{
	...
	class controlsBackground
	{
		...
		{
			idc = 1100;
			text = "<t size='1.2' align='center'>TanoaRPG Markt</t>";
		...
		{
			idc = 1101;
			text = "<t align='center'>Preisentwicklung</t>";
			x = 17 * GUI_GRID_W + GUI_GRID_X;
	...
	class controls
	{
		...
		class listResources: RscListbox
		{
			...
			w = 10.5 * GUI_GRID_W;
			h = 19.5 * GUI_GRID_H;
			onLBSelChanged = "[] spawn tanoarpg_fnc_refreshMarketView";
		};
	};
};
