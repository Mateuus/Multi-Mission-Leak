...

{
	...
	_textDisabled = if (isLocalized "STR_chvd_disabled") then {localize "STR_chvd_disabled"} else {"Wyłączone"};
	_ctrl lbAdd _textDisabled;
	
	_textDynamic = if (isLocalized "STR_chvd_dynamic") then {localize "STR_chvd_dynamic"} else {"Dynamiczny"};
...

{
	...
	_textHigh = if (isLocalized "STR_chvd_high") then {localize "STR_chvd_high"} else {"Wysokie"};
	_ctrl lbAdd _textHigh;
	_textVeryHigh = if (isLocalized "STR_chvd_veryHigh") then {localize "STR_chvd_veryHigh"} else {"Bardzo Wysokie"};
