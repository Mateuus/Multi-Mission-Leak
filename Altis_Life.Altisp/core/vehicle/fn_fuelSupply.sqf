...
_pgText ctrlSetText format["Zbiornik paliwa %1 Ltr / %2 Ltr",_fuelState,_fuelSpace];
...
waitUntil {
	...
	_fuelLevel = (1 / _fuelSpace) * _fuelState;
	_progress progressSetPosition _fuelLevel;
	_pgText ctrlSetText format["Zbiornik paliwa %1 Ltr / %2 Ltr  ( $ %3 / Ltr )",_fuelState,_fuelSpace,_price];
