...
_vehicle spawn {
	...
	if( _this getVariable ["trunk_in_use_by",""] != getPlayerUID player )  exitWith {_this setVariable["trunk_in_use",false,true]; closeDialog 0; hint "Na tym serwie nie ma bugowania"};
	uiSleep 0.2;
	if( _this getVariable ["trunk_in_use_by",""] != getPlayerUID player )  exitWith {_this setVariable["trunk_in_use",false,true]; closeDialog 0; hint "Na tym serwie nie ma bugowania"};
	uiSleep 0.2;
	if( _this getVariable ["trunk_in_use_by",""] != getPlayerUID player )  exitWith {_this setVariable["trunk_in_use",false,true]; closeDialog 0; hint "Na tym serwie nie ma bugowania"};
