...
_log = format ["%1, %2, %3, %4, %5", name player, getPlayerUID player, name _unit, getPlayerUID _unit,[(parseNumber(_amount))] call life_fnc_numberText2];
[_log, "HandLog"] remoteExecCall ["A3Log", 2];
