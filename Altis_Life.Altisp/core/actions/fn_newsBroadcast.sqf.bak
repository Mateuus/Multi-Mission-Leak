...
switch (playerside) do {
 ...
 CONTROL(100100,100103) ctrlSetStructuredText parseText format["Wymagany poziom: %1<br/>Następna dostępna transmisja: %2",[_msgRank] call life_fnc_numberText,_broadcastDelay];
 };
 case civilian: {
