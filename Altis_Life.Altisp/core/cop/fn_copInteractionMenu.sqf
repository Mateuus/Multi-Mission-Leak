...
//if(!((player distance (getMarkerPos "police_hq_1") < 30) OR  (player distance (getMarkerPos "police_hq_2") < 30) OR  (player distance (getMarkerPos "marker_266") < 30) OR (player distance (getMarkerPos "cop_spawn_3") < 30) OR (player distance (getMarkerPos "cop_spawn_5") < 30))) then  {
if(!(player distance (getMarkerPos "jail_marker_input") < 30)) then  {
