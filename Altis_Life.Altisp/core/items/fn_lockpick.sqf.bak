...
*/
private["_curTarget","_distance","_isVehicle","_title","_progressBar","_cP","_titleText","_dice","_badDistance","_vehicle"];
...
if(_curTarget GVAR "NPC") exitWith {hint localize "STR_NPC_Protected"};
...
[player,_message]remoteExec["life_fnc_CarAlarmSound",_vehicle,false];
[_curTarget]remoteExec["life_fnc_CarAlarmSound",_vehicle,false];
[_curTarget]remoteExec["life_fnc_CarAlarmSound",nil,false];
	_dice = random(100);
	if(_dice < 30) then {
