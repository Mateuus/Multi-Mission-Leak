...
if (isnil "IL_Variables") then
{
	...
	//Load and unload (not para) maksymalna prędkość km/h
	IL_LU_Speed = 10;
	//Load and unload (not para) maksymalna wysokość in m
	IL_LU_Alt = 3;
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  załaduj pojazd na CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload_para.paa' /><t color=""#b200ff""> Wyrzucać</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Rozładuj ładuneko Od CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Rozładuj ładunek z spadochronem</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload_all_para.paa' /><t color=""#a50b00"">  Zdejmij WSZYSTKIE ładunki z spadochronem</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Włącz ładowanie z zewnątrz</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Wyłącz ładowanie z zewnątrz</t>",
	{
...
///////////////////////////
	_obj_main addAction [
	"<img image='IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Rozładuj ładunek z spadochronem left MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Unload Rozładuj ładunek z spadochronem right MH-9</t>",
	{
