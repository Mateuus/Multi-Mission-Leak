...
if(argent_liquide < _betamt) exitWith {hint format["Tu n'as pas assez d'argent pour jouer (%1€)",_betamt];};
...
switch ( _betamt ) do 
{
	case 50:  { _bet10KTEXT ctrlSetText ""; _bet25KTEXT ctrlSetText ""; _bet50KTEXT ctrlSetText ""; };
	case 100: { _bet5KTEXT ctrlSetText ""; _bet25KTEXT ctrlSetText ""; _bet50KTEXT ctrlSetText ""; };
	case 250: { _bet10KTEXT ctrlSetText ""; _bet5KTEXT ctrlSetText ""; _bet50KTEXT ctrlSetText ""; };
	case 500: { _bet10KTEXT ctrlSetText ""; _bet25KTEXT ctrlSetText ""; _bet5KTEXT ctrlSetText ""; };
...
{ 
	_win = 2 * _betamt;
	argent_liquide = argent_liquide + _win;
...
else
{
	...
	if( _number == 13 ) then
	{
		...
		{		
			...
			_winnings = _display displayCtrl 6001;
			_winnings ctrlSetText "Tu perds. La banque a fait BlackJack.";
			_bet1 ctrlEnable true;
			_bet2 ctrlEnable true;
			_bet3 ctrlEnable true;
			_bet4 ctrlEnable true;
