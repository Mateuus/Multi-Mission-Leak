...
{
	_winnings ctrlSetText "Tu perds. La banque gagne !";
	...
	_bet5KTEXT  ctrlSetText "MISE";
	_bet10KTEXT ctrlSetText "MISE";
	_bet25KTEXT ctrlSetText "MISE";
	_bet50KTEXT ctrlSetText "MISE";
