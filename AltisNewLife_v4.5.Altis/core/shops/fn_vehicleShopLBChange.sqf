...
"Prix en location : <t color='#8cff9b'>%1€</t><br/>Prix en achat : <t color='#8cff9b'>%2€</t><br/>Vitesse max: %3 km/h<br/>Puissance : %4<br/>Passagers : %5<br/>Capacité : %6<br/>Réservoir : %7<br/>Resistance : %8",
...
if(_className in (ANL_SETTINGS(getArray,"ANL_Location"))) then {
