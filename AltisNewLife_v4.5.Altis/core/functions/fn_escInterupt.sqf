...
_escSync = {
	...
	_syncManager = {
		...
		_abortButton ctrlSetText "Quitter";
		_abortButton ctrlCommit 0;
	};
...
while {true} do
{
	...
	_abortButton = (findDisplay 49) displayCtrl 104;
	_ctrlSave = (findDisplay 49) displayCtrl 103;
	...
	_ctrlSave ctrlSetText "www.altisnewlife.fr";
	_respawnButton ctrlEnable false;
	_respawnButton ctrlSetText "ts.altisnewlife.fr";
