...
switch (typeOf _vehicle) do {
  case "B_Quadbike_01_F": {
    _lightLeftF lightAttachObject [_vehicle, [-0.25, 1.1, -0.11]];      //  Left/Right , Front/Back , Lower/Higher
  };
  case "C_Offroad_01_F": {
    _lightLeftF lightAttachObject [_vehicle, [-0.88, 2.33, -0.35]];     //  Left/Right , Front/Back , Lower/Higher
  };
  case "B_G_Offroad_01_F": {
    _lightLeftF lightAttachObject [_vehicle, [-0.88, 2.33, -0.35]];     //  Left/Right , Front/Back , Lower/Higher
  };
  case "C_Hatchback_01_F": {
    _lightLeftF lightAttachObject [_vehicle, [-0.7, 1.8, -0.55]];       //  Left/Right , Front/Back , Lower/Higher
  };
  case "C_Hatchback_01_sport_F": {
    _lightLeftF lightAttachObject [_vehicle, [-0.7, 1.8, -0.55]];       //  Left/Right , Front/Back , Lower/Higher
  };
  case "C_SUV_01_F": {
    _lightLeftF lightAttachObject [_vehicle, [-0.9, 2.0, -0.55]];       //  Left/Right , Front/Back , Lower/Higher
  };
}; 
// Right front
