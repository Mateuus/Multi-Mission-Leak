closeDialog 0;
hint "Je crois que je vais voir la vie autrement !";
[[0,format["%1 se drogue avec de l'opium pour oublier ces problemes !!!",name player]],"life_fnc_broadcast",civilian,false] spawn life_fnc_MP;
[[0,format["ATTENTION: Des habitants se defoncent avec de l'opium de plus en plus... -Anonyme",name player]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
