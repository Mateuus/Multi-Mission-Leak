...
if(isNull _curTarget) exitWith {hint "Mauvaise cible !"; closeDialog 0;};
if(!isPlayer _curTarget && side _curTarget == civilian) exitWith {hint "Ne peut pas faire ca !"; closeDialog 0;};
