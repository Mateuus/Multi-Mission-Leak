...
if(count _sellers == 0) exitWith {hint "Personne n'est venu vendre à ce dealeur recemment"}; //No data.
...
hint parseText format["Les personnes suivantes ont vendu à ce dealeur récemment :<br/><br/>%1",_names];
