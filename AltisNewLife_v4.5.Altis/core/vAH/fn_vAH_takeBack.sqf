...
if (_status == 3) exitWith {hint "Vous ne pouvez pas recuperer un objet qui est deja dans votre inventaire !";};
...
if (count _found == 0) exitWith {hint "Cet objet vient d'etre vendu";};
