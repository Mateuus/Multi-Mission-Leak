...
#define ITEM_ILLEGAL(varName) M_CONFIG(getNumber,"ANL_VItems",varName,"illegal")
#define ITEM_SELLPRICE(varName) M_CONFIG(getNumber,"ANL_VItems",varName,"sellPrice")
#define ITEM_BUYPRICE(varName) M_CONFIG(getNumber,"ANL_VItems",varName,"buyPrice")
