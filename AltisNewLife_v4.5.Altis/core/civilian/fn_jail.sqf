...
if(life_inv_coke > 0) then {[false,"coke",life_inv_coke] call life_fnc_handleInv;};
...
if(life_inv_meth97 > 0) then {[false,"meth97",life_inv_meth97] call life_fnc_handleInv;};
