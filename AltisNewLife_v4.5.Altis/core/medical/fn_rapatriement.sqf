...
_title = format["Mise en place du rapatriement d'urgence %1",_targetName];
...
if(_target getVariable["Revive",FALSE]) exitWith {hint "Cette personne est soit reapparue ou a deja ete secourue."};
...
titleText[format["Vous avez secourue %1 et vous avez recu 4000€ pour vos services.",_targetName],"PLAIN"];
uiSleep 0.6;
