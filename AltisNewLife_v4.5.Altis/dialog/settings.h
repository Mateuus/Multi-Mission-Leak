class SettingsMenu
{
	...
	class controlsBackground
	{
		...
		{
			idc = -1;
			text = "Voir le nom des habitants";
		...
		{
			idc = -1;
			text = "Voir les objets proches";
			
			y = 0.57;
		};
		
		class FpsHeader : PlayerTagsHeader
		{
			idc = -1;
			text = "Augmenter ces FPS";
	...
	class controls
	{
		...
		class HighFPSONOFF : PlayerTagsONOFF 
		{
			tooltip = "Augmenter ces FPS";
			idc = 2973;
			y = 0.63;
		};
