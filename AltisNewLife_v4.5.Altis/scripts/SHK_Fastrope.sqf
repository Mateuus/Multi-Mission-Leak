...
#define STR_TOSS_ROPES "Lacher les cordes"
#define STR_FAST_ROPE "Descendre en rappel"
#define STR_CUT_ROPES "Couper les cordes"
#define STR_JOIN_QUEUE_HINT "Vous etes dans la file d'attente"
...
SHK_Fastrope_fnc_AIs = {
  ...
  [_heli, _units] spawn {
    ...
    waituntil {uiSleep 0.5; { (getPosATL _x select 2) < 1 } count _units == count _units };
    uiSleep 3;
...
SHK_Fastrope_fnc_fastRope = {
  ...
  uiSleep 1.2 + (random 0.3); // delay to leave cap between units
};
