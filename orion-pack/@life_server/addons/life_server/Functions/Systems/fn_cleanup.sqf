...
for "_i" from 0 to 1 step 0 do {
    ...
    {
        if ((typeOf _x) in ["Land_LuggageHeap_02_F","Land_Airhorn_01_F","Land_BottlePlastic_V1_F","Land_Camping_Light_off_F","Land_TacticalBacon_F","Land_Can_V3_F","Land_CanisterFuel_F", "Land_Can_V3_F","Land_Money_F","Land_Suitcase_F"]) then {
            deleteVehicle _x;
        };
