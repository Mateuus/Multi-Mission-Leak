...
[ 1 , "Your vehicle is available and it is insured!" ] RemoteExecCall [ "life_fnc_broadcast" , _unit];
}else{
[ 1 , "Your vehicle is available but it is not insured, we suggest getting insuance!" ] RemoteExecCall [ "life_fnc_broadcast" , _unit];
};
serv_sv_use deleteAt _servIndex;
