...
compileFinal "
    ...
    [life_fishFinder,life_houseProtect,owner player,player,profileNameSteam,getPlayerUID player,playerSide] remoteExecCall [""life_fnc_adminInfo"",_ret];
";
...
private [""_msg"",""_to""];
    ...
    [] call life_fnc_phoneRequestMarker;
