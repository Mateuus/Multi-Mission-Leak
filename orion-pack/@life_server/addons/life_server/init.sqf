...
diag_log "----------------------------------------------------------------------------------------------------";
diag_log "---------------------------------- Starting Malden Life Server Init ---------------------------------";
...
_dome = nearestObject [_pos,"Land_Dome_Small_F"];
...
_prisonvault setVariable ["prison_open", false, true];
_prisonvault setVariable ["pchargeplaced", false, true];
...
diag_log "----------------------------------------------------------------------------------------------------";
diag_log format ["               End of Malden Life Server Init :: Total Execution Time %1 seconds ",(diag_tickTime) - _timeStamp];
diag_log "----------------------------------------------------------------------------------------------------";
