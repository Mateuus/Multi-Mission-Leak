...
{
   idd = 7770;
   onKeyDown = "if (_this select 1 isEqualTo 0x01) then { [] ExecVM 'Custom\scarCODE\ServerInfoMenu\sqf\onEscape.sqf' }; true";
   onLoad = "uiNamespace setVariable ['RscDisplayServerInfoMenu', _this select 0]; [] ExecVM 'Custom\scarCODE\ServerInfoMenu\sqf\onLoad.sqf'; playSound ['ZoomIn', true]; 'DynamicBlur' ppEffectEnable true; 'DynamicBlur' ppEffectAdjust [7]; 'DynamicBlur' ppEffectCommit 0.1";
   ...
   class controls
   {
      ...
      class menu:RscListbox
      {
         ...
         idc = 7;
         onLBSelChanged = "[] ExecVM 'Custom\scarCODE\ServerInfoMenu\sqf\handleContent.sqf'";
      };
