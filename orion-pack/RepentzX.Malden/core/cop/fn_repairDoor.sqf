...
if (_door isEqualTo 0) exitWith {[localize "STR_Cop_NotaDoor",true,"slow"] call life_fnc_notificationSystem; //Not near a door to be broken into.
_doorN = _building getVariable [format ["bis_disabled_Door_%1",_door],0];
if (_doorN isEqualTo 1) exitWith {[localize "STR_House_FedDoor_Locked",true,"slow"] call life_fnc_notificationSystem;};
...
switch (typeOf _building) do {
    ...
    case "Land_Cargo_House_V4_F": {_cpRate = 0.005;};
