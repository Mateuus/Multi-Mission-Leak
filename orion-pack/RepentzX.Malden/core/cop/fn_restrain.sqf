...
[player,"handcuffson"] remoteexeccall ["say3D",0];
...
while {player getVariable  "restrained"} do {
    ...
    waitUntil {animationState player != "Acts_ExecutionVictim_Loop" || !(player getVariable "restrained") || vehicle player != _state};
