...
if (count _containerInfo isEqualTo 0) exitWith {[localize "STR_Cop_ContainerEmpty",true,"slow"] call life_fnc_notificationSystem;};
...
if (_value > 0) then {
    ...
    [localize "STR_Cop_NoIllegalContainer",true,"slow"] call life_fnc_notificationSystem;
};
