...
if (life_action_inUse) exitWith {[localize "STR_NOTF_Action",true,"slow"] call life_fnc_notificationSystem;};
...
if (civRDM < _serviceCost) exitWith {[localize "STR_Serive_Chopper_NotEnough",true,"slow"] call life_fnc_notificationSystem;};
