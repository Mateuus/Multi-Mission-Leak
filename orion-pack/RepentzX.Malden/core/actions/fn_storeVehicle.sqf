...
if (isNil "_vehicle") exitWith {[localize "STR_Garage_NoNPC",true,"slow"] call life_fnc_notificationSystem;};
if (isNull _vehicle) exitWith {};
if (!alive _vehicle) exitWith {[localize "STR_Garage_SQLError_Destroyed",true,"slow"] call life_fnc_notificationSystem;};
...
[localize "STR_Garage_Store_Server",true,"slow"] call life_fnc_notificationSystem;
