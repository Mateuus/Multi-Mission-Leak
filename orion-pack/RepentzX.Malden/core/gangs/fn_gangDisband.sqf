...
if (_action) then {
    [localize "STR_GNOTF_DisbandGangPro",true,"slow"] call life_fnc_notificationSystem;
    ...
    [localize "STR_GNOTF_DisbandGangCanc",true,"slow"] call life_fnc_notificationSystem;
};