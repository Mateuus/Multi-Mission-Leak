...
if (!isNil {(group _unit) getVariable "gang_name"}) exitWith {[localize "STR_GNOTF_playerAlreadyInGang",true,"slow"] call life_fnc_notificationSystem;}; //Added
...
if (_action) then {
    ...
    [localize "STR_GNOTF_InviteCancel",true,"slow"] call life_fnc_notificationSystem;
};
