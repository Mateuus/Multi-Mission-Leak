...
if (_action) then {
    if (civRDMed < _upgradePrice) exitWith {
        hint parseText format [
            ...
            [civRDMed] call life_fnc_numberText,
            [_upgradePrice - civRDMed] call life_fnc_numberText
        ];
    };
    civRDMed = civRDMed - _upgradePrice;
    ...
    [localize "STR_GNOTF_UpgradeCancel",true,"slow"] call life_fnc_notificationSystem;
};
