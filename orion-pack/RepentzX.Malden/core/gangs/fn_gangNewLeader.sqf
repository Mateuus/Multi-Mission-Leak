...
if (_action) then {
    ...
    if (_unitID isEqualTo "") exitWith {[localize "STR_GNOTF_badUID",true,"slow"] call life_fnc_notificationSystem;}; //Unlikely?
    ...
    [localize "STR_GNOTF_TransferCancel",true,"slow"] call life_fnc_notificationSystem;
};
