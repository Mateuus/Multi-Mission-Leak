...
if (_badChar) exitWith {[localize "STR_GNOTF_IncorrectChar",true,"slow"] call life_fnc_notificationSystem;};
if (civRDMed < (LIFE_SETTINGS(getNumber,"gang_price"))) exitWith {hint format [localize "STR_GNOTF_NotEnoughMoney",[((LIFE_SETTINGS(getNumber,"gang_price")) - civRDMed)] call life_fnc_numberText];};
...
[localize "STR_NOTF_SendingData",true,"slow"] call life_fnc_notificationSystem;
closeDialog 0;
