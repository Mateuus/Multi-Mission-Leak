...
#define civRDM life_houseProtect
#define civRDMed life_fishFinder
#define GANG_FUNDS grpPlayer getVariable ["gangBank",0];
//
#define LEVEL life_level
#define EXP life_exp
#define NEXTEXP life_nextExp
#define SKILLPOINT life_skillpoint
...
#define SKILL_VARNAME(varName,flag) format["skill_%1_%2",flag,M_CONFIG(getText,"Skills",varName,"variable")]
#define SKILL_VALUE(varName,flag) GVAR_MNS [SKILL_VARNAME(varName,flag),false]
