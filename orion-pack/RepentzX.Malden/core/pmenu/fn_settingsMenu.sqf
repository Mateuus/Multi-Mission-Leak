...
if (isNull (findDisplay 2900)) then {
    if (!createDialog "SettingsMenu") exitWith {[localize "STR_NOTF_menuWillNotOpen",true,"slow"] call life_fnc_notificationSystem;};
};
...
CONTROL(2900,2974) cbSetChecked life_settings_enableHUDStats;
