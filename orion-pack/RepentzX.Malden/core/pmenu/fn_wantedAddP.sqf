...
*/
if !(playerSide isEqualTo west) exitWith {[localize "STR_Cop_wantedList_notCop",true,"slow"] call life_fnc_notificationSystem;};
if ((lbCurSel 2406) isEqualTo -1) exitWith {[localize "STR_Cop_wantedList_noPlayerSelected",true,"slow"] call life_fnc_notificationSystem;};
if ((lbCurSel 2407) isEqualTo -1) exitWith {[localize "STR_Cop_wantedList_noCrimeSelected",true,"slow"] call life_fnc_notificationSystem;};
