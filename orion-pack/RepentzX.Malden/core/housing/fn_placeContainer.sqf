...
if (_message isEqualTo 0 || _message isEqualTo 1) then {
    [localize "STR_House_Container_House_Near",true,"slow"] call life_fnc_notificationSystem;
};
if (_message isEqualTo 2) then {
    [localize "STR_House_Container_House_Near_Owner",true,"slow"] call life_fnc_notificationSystem;
};
if (_message isEqualTo 3) then {
    [localize "STR_House_Container_Floating",true,"slow"] call life_fnc_notificationSystem;
};
if (_message isEqualTo 4) then {
    [localize "STR_ISTR_Box_HouseFull",true,"slow"] call life_fnc_notificationSystem;
};