...
if (mav_ttm_var_relicReward2 == 1) exitwith {["You have already completed this quest!",true,"slow"] call life_fnc_notificationSystem;}; 

if (!(life_inv_relicTransport > 0)) exitWith {["You do not have a Prized Relic!",true,"slow"] call life_fnc_notificationSystem; };

[false,"relicTransport",1] call life_fnc_handleInv;
[true,"prize",2] call life_fnc_handleInv;
...
["relic2"] spawn mav_ttm_fnc_addExp;
