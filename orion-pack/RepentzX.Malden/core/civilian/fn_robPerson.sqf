...
if (civRDM > 0) then {
    [civRDM,player,_robber] remoteExecCall ["life_fnc_robReceive",_robber];
    ...
    [1,"STR_NOTF_Robbed",true,[_robber getVariable ["realname",name _robber],profileName,[civRDM] call life_fnc_numberText]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
    civRDM = 0;
