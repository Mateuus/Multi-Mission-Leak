...
if (!createDialog "TrunkMenu") exitWith {[localize "STR_MISC_DialogError",true,"slow"] call life_fnc_notificationSystem;}; //Couldn't create the menu?
...
if (_veh_data select 0 isEqualTo -1) exitWith {closeDialog 0; _vehicle setVariable ["trunk_in_use",false,true]; [localize "STR_MISC_NoStorageVeh",true,"slow"] call life_fnc_notificationSystem;};
