...
civRDM = civRDM + parseNumber(_val);
[format["%1 Has given %2 to %3",_from getVariable ["realname",name _from], _val, _unit getVariable ["realname",name _unit]], "MoneyLogs"] remoteExecCall ["A3Log", 2]; //TODO Move to Money Logs
