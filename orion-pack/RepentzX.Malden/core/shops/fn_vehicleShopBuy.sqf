...
if (civRDM < _purchasePrice) exitWith {hint format [localize "STR_Shop_Veh_NotEnough",[_purchasePrice - civRDM] call life_fnc_numberText];closeDialog 0;};
...
switch (playerSide) do {
    case west: {
        [_vehicle] remoteExecCall ["TON_fnc_lightbarSpawn",RSERV];
