...
if (!isClass(missionConfigFile >> "VirtualShops" >> life_shop_type)) exitWith {closeDialog 0; [localize "STR_NOTF_ConfigDoesNotExist",true,"slow"] call life_fnc_notificationSystem;}; //Make sure the entry exists..
