...
if(_pin != -1 && _pin != -3) then {
  ...
  if(_pin == -3) then {
    ...
    if(life_bankingpin != (parseNumber _pinText)) exitWith {[localize "STR_Banking_WrongPinConfirm",true,"slow"] call life_fnc_notificationSystem;};
    [8] call SOCK_fnc_updatePartial;
    closeDialog 0;
    //[localize "STR_Banking_PinSuccess",true,"slow"] call life_fnc_notificationSystem;
	[localize "STR_Banking_PinSuccess",true,"slow"] call life_fnc_notificationSystem;
