class Life_banking_main {
    idd = 45070;
    name= "life_banking_main";
    movingEnable = 0;
    enableSimulation = 1;
    ...
    class controls {
        ...
        class FirstButton: Life_BankButton {
            idc = 45071;
            onButtonClick = "[] call life_fnc_bankingBalance";
            x = 0.175;
            y = 0.075;
            w = 0.05925;
            h = 0.06775;
        ...
        class SecondButton: Life_BankButton {
            idc = 45072;
            onButtonClick = "[] call life_fnc_bankingWithdraw";
            x = 0.175;
            y = 0.175;
            w = 0.05925;
            h = 0.06775;
        ...
        class ThirdButton: Life_BankButton {
            idc = 45073;
            onButtonClick = "[] call life_fnc_bankingDeposit";
            x = 0.175;
            y = 0.275;
            w = 0.05925;
            h = 0.06775;
        ...
        class FourthButton: Life_BankButton {
            idc = 45074;
            onButtonClick = "[] call life_fnc_bankingTransfer";
            x = 0.175;
            y = 0.375;
            w = 0.05925;
            h = 0.06775;
        ...
        class FifthButton: Life_BankButton {
            idc = 45075;
            onButtonClick = "[] call life_fnc_bankingGangDeposit";
            x = 0.795;
            y = 0.075;
            w = 0.05925;
            h = 0.06775;
        ...
        class SixthButton: Life_BankButton {
            idc = 45076;
            onButtonClick = "[] call life_fnc_bankingGangWithdraw";
            x = 0.795;
            y = 0.175;
            w = 0.05925;
            h = 0.06775;
