class Life_banking_createconfirmaccount {
    idd = 45000;
    name= "life_banking_createconfirmaccount";
    movingEnable = 0;
    enableSimulation = 1;
    ...
    class controls {
        ...
        class ClearButton: Life_BankButton {
            ...
            onButtonClick = "[-2] spawn life_fnc_confirmPINMenu;";
            x = 0.39075;
            y = 0.68975;
            w = 0.05925;
            h = 0.06775;
        ...
        class EnterButton: Life_BankButton {
            ...
            onButtonClick = "[-3] spawn life_fnc_confirmPINMenu;";
            x = 0.3815;
            y = 0.871;
            w = 0.05925;
            h = 0.06775;
        ...
        class OneButton: Life_BankButton {
            idc = 45093;
            tooltip = "1";
            onButtonClick = "[1] spawn life_fnc_confirmPINMenu;";
            x = 0.165;
            y = 0.595;
            w = 0.05925;
            h = 0.06775;
        ...
        class FourButton: Life_BankButton {
            idc = 45096;
            tooltip = "4";
            onButtonClick = "[4] spawn life_fnc_confirmPINMenu;";
            x = 0.15825;
            y = 0.68975;
            w = 0.05925;
            h = 0.06775;
        ...
        class FiveButton: Life_BankButton {
            idc = 45097;
            tooltip = "5";
            onButtonClick = "[5] spawn life_fnc_confirmPINMenu;";
            x = 0.23575;
            y = 0.68975;
            w = 0.05925;
            h = 0.06775;
        ...
        class SixButton: Life_BankButton {
            idc = 45098;
            tooltip = "6";
            onButtonClick = "[6] spawn life_fnc_confirmPINMenu;";
            x = 0.31325;
            y = 0.68975;
            w = 0.05925;
            h = 0.06775;
        ...
        class SevenButton: Life_BankButton {
            idc = 45099;
            tooltip = "7";
            onButtonClick = "[7] spawn life_fnc_confirmPINMenu;";
            x = 0.15175;
            y = 0.778;
            w = 0.05925;
            h = 0.06775;
        ...
        class EightButton: Life_BankButton {
            idc = 45100;
            tooltip = "8";
            onButtonClick = "[8] spawn life_fnc_confirmPINMenu;";
            x = 0.22975;
            y = 0.778;
            w = 0.05925;
            h = 0.06775;
        ...
        class NineButton: Life_BankButton {
            idc = 45101;
            tooltip = "9";
            onButtonClick = "[9] spawn life_fnc_confirmPINMenu;";
            x = 0.30725;
            y = 0.778;
            w = 0.05925;
            h = 0.06775;
        ...
        class ZeroButton: Life_BankButton {
            idc = 45102;
            tooltip = 0;
            onButtonClick = "[0] spawn life_fnc_confirmPINMenu;";
            x = 0.2265;
            y = 0.871;
            w = 0.05925;
            h = 0.06775;
        ...
        class CancelButton: Life_BankButton {
            ...
            onButtonClick = "hint format[""%1"", localize ""STR_Banking_NoCancel""];";
            x = 0.3975;
            y = 0.595;
            w = 0.05925;
            h = 0.06775;
