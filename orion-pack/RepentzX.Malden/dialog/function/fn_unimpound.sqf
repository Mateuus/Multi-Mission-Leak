...
if (civRDMed < _price) exitWith {hint format [(localize "STR_Garage_CashError"),[_price] call life_fnc_numberText];};
...
[localize "STR_Garage_SpawningVeh",true,"slow"] call life_fnc_notificationSystem;
