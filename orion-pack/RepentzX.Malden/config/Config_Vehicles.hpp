class CarShops {
    ...
    class cop_car {
        ...
        vehicles[] = {
            ...
            { "B_G_Offroad_01_armed_F", "call life_coplevel >= 3" }
    ...
    class cop_carAdvanced {
        ...
        vehicles[] = {
            ...
            { "B_T_LSV_01_armed_F", "call life_coplevel >= 7" },
            { "O_T_LSV_02_armed_F", "call life_coplevel >= 7" }
        };
    };
...
*/
    ...
    class B_Heli_Light_01_F {
        ...
        textures[] = {
            { "Police", "cop", {
                "images\Textures\Vehicles\Cop\police_hummingbird.paa"
            }, "" },
            { "Sheriff", "civ", {
