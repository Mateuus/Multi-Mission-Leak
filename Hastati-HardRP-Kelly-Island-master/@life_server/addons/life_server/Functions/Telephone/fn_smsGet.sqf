...
_query = format ["SELECT senderNumber, recipientNumber, message FROM TelSMS WHERE recipientNumber='%1' OR senderNumber='%1' ORDER BY id DESC LIMIT 30",_phoneNumber];
