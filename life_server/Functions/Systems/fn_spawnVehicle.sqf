...
[[_vehicle],"life_fnc_RestrictSlingLoad",_unit,false] spawn life_fnc_MP;
...
if((_vInfo select 1) == "cop" && (_vInfo select 2) in ["C_Offroad_01_F","B_MRAP_01_F","C_SUV_01_F","C_Hatchback_01_sport_F","B_Quadbike_01_F","B_Heli_Light_01_F","B_Heli_Transport_03_F","I_Heli_light_03_unarmed_F","O_Heli_Light_02_unarmed_F","B_Heli_Transport_01_F"]) then
{
...
if((_vInfo select 1) == "med" && (_vInfo select 2) in ["C_Offroad_01_F","C_SUV_01_F","C_Hatchback_01_sport_F"]) then
{
