...
compileFinal "
	...
	[] call life_fnc_cellphone;
	hint format[""Purge Message Sent To All: %1"",_msg];
";

TON_fnc_cell_warmsgall =
compileFinal "
	if(isServer) exitWith {};
	if((call life_adminlevel) < 1) exitWith {hint ""You are not an admin!"";};
	private[""_msg"",""_from""];
	...
	[] call life_fnc_cellphone;
	hint format[""War Message Sent To All: %1"",_msg];
";

TON_fnc_cell_alertmsgall =
compileFinal "
	if(isServer) exitWith {};
	if((call life_adminlevel) < 1) exitWith {hint ""You are not an admin!"";};
	private[""_msg"",""_from""];
...
publicVariable "TON_fnc_cell_purgemsgall";
publicVariable "TON_fnc_cell_warmsgall";
publicVariable "TON_fnc_cell_alertmsgall";
//Client Message
/*
	0 = private message
	1 = police message
	...
	5 = Reserved for Medic Message
	6 = purge message to all
	7 = war message to all
	8 = alert message to all
*/
...
compileFinal "
	...
	switch (_type) do
	{
		...
		case 6: {
			private[""_message""];
			_message = format[""!!!PURGE ANNOUNCEMENT: %1"",_msg];
			_admin = format[""Sent by admin: %1"", _from];
			hintSilent parseText format [""<t color='#FF0000'><t size='2'><t align='center'>Purge Announcement<br/><br/><t color='#33CC33'><t align='left'><t size='1'>To: <t color='#ffffff'>All Players<br/><t color='#33CC33'>From: <t color='#ffffff'>The Admins<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%1"",_msg];
		...
		case 7: {
			private[""_message""];
			_message = format[""!!!WAR ANNOUNCEMENT: %1"",_msg];
			_admin = format[""Sent by admin: %1"", _from];
			hintSilent parseText format [""<t color='#FF0000'><t size='2'><t align='center'>War Announcement<br/><br/><t color='#33CC33'><t align='left'><t size='1'>To: <t color='#ffffff'>All Players<br/><t color='#33CC33'>From: <t color='#ffffff'>The Admins<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%1"",_msg];
			
			player say3D ""warsiren""; 
			systemChat _message;
			if((call life_adminlevel) > 0) then {systemChat _admin;};
		};
		...
		case 8: {
			private[""_message""];
			_message = format[""!!!ALERT: %1"",_msg];
			_admin = format[""Sent by admin: %1"", _from];
			hintSilent parseText format [""<t color='#FF0000'><t size='2'><t align='center'>!ALERT!<br/><br/><t color='#33CC33'><t align='left'><t size='1'>To: <t color='#ffffff'>All Players<br/><t color='#33CC33'>From: <t color='#ffffff'>The Admins<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%1"",_msg];
