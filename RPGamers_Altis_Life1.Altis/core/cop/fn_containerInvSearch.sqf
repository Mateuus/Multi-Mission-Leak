...
if (count _containerInfo isEqualTo 0) exitWith {[localize "STR_Cop_ContainerEmpty",5,"blue"] call RPG_Fnc_Msg;};
...
if (_value > 0) then {
    ...
    [localize "STR_Cop_NoIllegalContainer",5,"blue"] call RPG_Fnc_Msg;
};
