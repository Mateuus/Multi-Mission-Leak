...
if (typeOf _vault != "Land_CargoBox_V1_F") exitWith {[localize "STR_ISTR_defuseKit_NotNear",5,"gray"] call RPG_Fnc_Msg;};
if (!(_vault getVariable ["chargeplaced",false])) exitWith {[localize "STR_ISTR_Defuse_Nothing",5,"gray"] call RPG_Fnc_Msg;};
