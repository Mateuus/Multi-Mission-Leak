...
if (!(nearestObject [player, "House"] in life_vehicles)) exitWith {[localize "STR_ISTR_Box_NotinHouse",5,"gray"] call RPG_Fnc_Msg;};
...
[localize "STR_NOTF_PlaceContainer",5,"gray"] call RPG_Fnc_Msg;
