...
if (isNull _vehicle) exitWith {[localize "STR_ISTR_Jerry_NotLooking",5,"gray"] call RPG_Fnc_Msg;};
if (!(_vehicle isKindOF "LandVehicle") && !(_vehicle isKindOf "Air") && !(_vehicle isKindOf "Ship")) exitWith {};
if (player distance _vehicle > 7.5) exitWith {[localize "STR_ISTR_Jerry_NotNear",5,"gray"] call RPG_Fnc_Msg;};
...
if (!alive player) exitWith {};
if (life_interrupted) exitWith {life_interrupted = false; [localize "STR_NOTF_ActionCancel",5,"gray"] call RPG_Fnc_Msg;};
