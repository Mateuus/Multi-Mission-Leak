...
if (isNull life_trunk_vehicle || !alive life_trunk_vehicle) exitWith {[localize "STR_MISC_VehDoesntExist",5,"gray"] call RPG_Fnc_Msg;};
...
if ((lbCurSel 3502) isEqualTo -1) exitWith {[localize "STR_Global_NoSelection",5,"gray"] call RPG_Fnc_Msg;};
