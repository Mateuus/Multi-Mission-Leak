...
if (_action) then {
    ...
    [format [localize "STR_GNOTF_UpgradeSuccess",_maxMembers,_slotUpgrade,[_upgradePrice] call life_fnc_numberText],5,"blue"] call RPG_Fnc_Msg;
    ...
    [localize "STR_GNOTF_UpgradeCancel",5,"blue"] call RPG_Fnc_Msg;
};
