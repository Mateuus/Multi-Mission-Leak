...
if ((lbCurSel 2621) isEqualTo -1) exitWith {[localize "STR_GNOTF_SelectKick",5,"gray"] call RPG_Fnc_Msg;};
_unit = call compile format ["%1",CONTROL_DATA(2621)];

if (isNull _unit) exitWith {}; //Bad unit?
if (_unit == player) exitWith {[localize "STR_GNOTF_KickSelf",5,"gray"] call RPG_Fnc_Msg;};
