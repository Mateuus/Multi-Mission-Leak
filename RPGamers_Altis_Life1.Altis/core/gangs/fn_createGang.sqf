...
if (_length > 32) exitWith {[localize "STR_GNOTF_Over32",5,"gray"] call RPG_Fnc_Msg;};
_badChar = false;
{if (!(_x in _allowed)) exitWith {_badChar = true;};} forEach _chrByte;
if (_badChar) exitWith {[localize "STR_GNOTF_IncorrectChar",5,"gray"] call RPG_Fnc_Msg;};
if (BANK < (LIFE_SETTINGS(getNumber,"gang_price"))) exitWith {[format [localize "STR_GNOTF_NotEnoughMoney"],5,"gray"] call RPG_Fnc_Msg;[format [localize "STR_GNOTF_NotEnoughMoney1",[((LIFE_SETTINGS(getNumber,"gang_price")) - BANK)] call life_fnc_numberText],5,"gray"] call RPG_Fnc_Msg;};
...
[localize "STR_NOTF_SendingData",5,"gray"] call RPG_Fnc_Msg;
closeDialog 0;
