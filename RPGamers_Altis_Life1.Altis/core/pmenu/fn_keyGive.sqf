...
if ((lbCurSel 2702) isEqualTo -1) exitWith {[localize "STR_NOTF_didNotSelectPlayer",5,"gray"] call RPG_Fnc_Msg;};
...
[format [localize "STR_NOTF_givenKeysTo",_unit getVariable ["realname",name _unit],typeOf _vehicle],5,"blue"] call RPG_Fnc_Msg;
