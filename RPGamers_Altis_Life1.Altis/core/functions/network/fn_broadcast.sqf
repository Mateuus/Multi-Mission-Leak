    ...
    if (_type isEqualType []) then {
        for "_i" from 0 to (count _type)-1 do {
            switch (_type select _i) do {
                ...
                case 3: {[_msg,5,"blue"] call RPG_Fnc_Msg;};
                case 4: {[_msg,5,"gray"] call RPG_Fnc_Msg;};
            };
        };
    } else {
        switch (_type) do {
...
if (_type isEqualType []) then {
    for "_i" from 0 to (count _type)-1 do {
        switch (_type select _i) do {
            ...
            case 3: {[format ["%1",_message],5,"blue"] call RPG_Fnc_Msg;};
            case 4: {[format ["%1",_message],5,"gray"] call RPG_Fnc_Msg;};
        };
    };
} else {
    switch (_type) do {
