...
switch (playerSide) do
{
    case west: {
        ...
        if (_item in ["B_Carryall_cbr"]) then {
            [] call life_fnc_playerSkins;
        };
    };
    case civilian: {
        if(_item in ["U_C_Scientist"]) then {
            [] call life_fnc_playerSkins;
        };
        if (_item in ["B_Carryall_ocamo","B_Carryall_oucamo","B_Carryall_mcamo","B_Carryall_oli","B_Carryall_khk","B_Carryall_cbr","B_Carryall_ocamo_AAA","B_Carryall_ocamo_Eng","B_Carryall_oucamo_AAT","B_Carryall_mcamo_AAT","B_Carryall_cbr_AAT","B_Carryall_ocamo_AAR","B_Carryall_oucamo_Eng","B_Carryall_oucamo_Exp","B_Carryall_oucamo_AAR","B_Carryall_ocamo_Exp","B_Carryall_oucamo_AAA","B_Carryall_mcamo_AAA"]) then {
            [] call life_fnc_playerSkins;
        };
