...
[_pos,"death"] spawn life_fnc_nearestSound;
...
_unit spawn {
    ...
    waitUntil {_medic=""; if(!isNull life_medic_enroute) then { _medic = format["Paramedic %1 is en-route! ", name life_medic_enroute]; }; _Timer ctrlSetText format [localize "STR_Medic_Respawn",[(_maxTime - time),"MM:SS"] call BIS_fnc_secondsToString];
