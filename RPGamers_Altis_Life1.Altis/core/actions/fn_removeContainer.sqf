...
if (!(_house in life_vehicles)) exitWith {[localize "STR_ISTR_Box_NotinHouse",5,"gray"] call RPG_Fnc_Msg;};
...
if (_action) then {
    ...
    if (_diff isEqualTo 0) exitWith {[localize "STR_NOTF_InvFull",5,"gray"] call RPG_Fnc_Msg;};
