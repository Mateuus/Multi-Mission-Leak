...
if (_vehicle getVariable "NPC") exitWith {[localize "STR_NPC_Protected",5,"gray"] call RPG_Fnc_Msg;};
...
if (player distance _vehicle > 10) exitWith {[localize "STR_NOTF_ImpoundingCancelled",5,"gray"] call RPG_Fnc_Msg; life_action_inUse = false;};
...
if (count crew _vehicle isEqualTo 0) then {
    ...
    if (playerSide isEqualTo west) then {
            ...
            if (_vehicle in life_vehicles) then {
                [format [localize "STR_NOTF_OwnImpounded",[_value] call life_fnc_numberText,_type],5,"blue"] call RPG_Fnc_Msg;
                BANK = BANK - _value;
            } else {
                [format [localize "STR_NOTF_Impounded",_type],5,"blue"] call RPG_Fnc_Msg;
                [format [localize "STR_NOTF_Impounded1",[_value] call life_fnc_numberText],5,"blue"] call RPG_Fnc_Msg;
    ...
    [localize "STR_NOTF_ImpoundingCancelled",5,"gray"] call RPG_Fnc_Msg;
};
