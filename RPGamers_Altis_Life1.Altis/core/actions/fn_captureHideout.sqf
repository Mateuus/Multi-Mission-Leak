...
if ((_hideout getVariable ["inCapture",false])) exitWith {[localize"STR_GNOTF_onePersonAtATime",1,"gray"] call RPG_Fnc_Msg;};
...
if (player getVariable ["restrainedz",false]) exitWith {life_action_inUse = false;_hideout setVariable ["inCapture",false,true];};
