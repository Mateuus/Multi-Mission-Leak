...
if (CASH < _price) exitWith {[format [localize "STR_NOTF_NE_1",[_price] call life_fnc_numberText,localize _displayName],5,"gray"] call RPG_Fnc_Msg;};
CASH = CASH - _price;

[0] call SOCK_fnc_updatePartial;

[format [localize "STR_NOTF_B_1", localize _displayName,[_price] call life_fnc_numberText],5,"blue"] call RPG_Fnc_Msg;
