...
if (!isClass(missionConfigFile >> "VirtualShops" >> life_shop_type)) exitWith {closeDialog 0; [localize "STR_NOTF_ConfigDoesNotExist",5,"gray"] call RPG_Fnc_Msg;}; //Make sure the entry exists..
