...
if (_amount > (ITEM_VALUE(_type))) exitWith {[localize "STR_Shop_Virt_NotEnough",5,"gray"] call RPG_Fnc_Msg;};
...
if ([false,_type,_amount] call life_fnc_handleInv) then {
    [format[localize "STR_Shop_Virt_SellItem",_amount,(localize _name),[_price] call life_fnc_numberText],5,"blue"] call RPG_Fnc_Msg;
    CASH = CASH + _price;
