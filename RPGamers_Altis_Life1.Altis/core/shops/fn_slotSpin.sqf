...
_betamt = param [0,1,[0]];
if(life_cash < _betamt) exitWith {[format ["You don't have enough money to play (%1$)",_betamt],5,"gray"] call RPG_Fnc_Msg;};   
...
if (_number == 0) then {_slot1 = 0; _slotPic1 ctrlSetText "textures\slot\slot_zero.paa";};
if (_number == 1) then {_slot1 = 100; _slotPic1 ctrlSetText "textures\slot\1.paa";};
if (_number == 2) then {_slot1 = 200; _slotPic1 ctrlSetText "textures\slot\2.paa";};
if (_number == 3) then {_slot1 = 300; _slotPic1 ctrlSetText "textures\slot\3.paa";};
if (_number == 4) then {_slot1 = 400; _slotPic1 ctrlSetText "textures\slot\4.paa";};
if (_number == 5) then {_slot1 = 500; _slotPic1 ctrlSetText "textures\slot\5.paa";};
if (_number == 6) then {_slot1 = 600; _slotPic1 ctrlSetText "textures\slot\6.paa";};
if (_number == 7) then {_slot1 = 700; _slotPic1 ctrlSetText "textures\slot\7.paa";};
...
_number = ceil(random 7);
_pplayer = _this select 0;
if (_number == 0) then {_slot2 = 0; _slotPic2 ctrlSetText "textures\slot\slot_zero.paa";};
if (_number == 1) then {_slot2 = 10; _slotPic2 ctrlSetText "textures\slot\1.paa";};
if (_number == 2) then {_slot2 = 20; _slotPic2 ctrlSetText "textures\slot\2.paa";};
if (_number == 3) then {_slot2 = 30; _slotPic2 ctrlSetText "textures\slot\3.paa";};
if (_number == 4) then {_slot2 = 40; _slotPic2 ctrlSetText "textures\slot\4.paa";};
if (_number == 5) then {_slot2 = 50; _slotPic2 ctrlSetText "textures\slot\5.paa";};
if (_number == 6) then {_slot2 = 60; _slotPic2 ctrlSetText "textures\slot\6.paa";};
if (_number == 7) then {_slot2 = 70; _slotPic2 ctrlSetText "textures\slot\7.paa";};
...
if (_number == 0) then {_slot3 = 0; _slotPic3 ctrlSetText "textures\slot\slot_zero.paa";};
if (_number == 1) then {_slot3 = 1; _slotPic3 ctrlSetText "textures\slot\1.paa";};
if (_number == 2) then {_slot3 = 2; _slotPic3 ctrlSetText "textures\slot\2.paa";};
if (_number == 3) then {_slot3 = 3; _slotPic3 ctrlSetText "textures\slot\3.paa";};
if (_number == 4) then {_slot3 = 4; _slotPic3 ctrlSetText "textures\slot\4.paa";};
if (_number == 5) then {_slot3 = 5; _slotPic3 ctrlSetText "textures\slot\5.paa";};
if (_number == 6) then {_slot3 = 6; _slotPic3 ctrlSetText "textures\slot\6.paa";};
if (_number == 7) then {_slot3 = 7; _slotPic3 ctrlSetText "textures\slot\7.paa";};
