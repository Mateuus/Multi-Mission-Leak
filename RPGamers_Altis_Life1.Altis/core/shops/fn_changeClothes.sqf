...
if (_selection isEqualTo -1) exitWith {[localize "STR_Shop_NoSelection",5,"gray"] call RPG_Fnc_Msg;};
if (isNull _control) exitWith {[localize "STR_Shop_NoDisplay",5,"gray"] call RPG_Fnc_Msg;};
