class life_broadcast_menu {
	...
	class controls {
		...
		class OK_Button: Life_RscButtonMenu
		{
			...
			w = 0.10572 * safezoneW;
			h = (1 / 25);
			onButtonClick = "BANK = BANK - 30000; [[ctrlText 10402,ctrlText 10404,profileName],'life_fnc_showBroadcast',true,false] spawn BIS_fnc_MP; life_last_broadcast = time; publicVariable ""life_last_broadcast""; closeDialog 0;";
		};
