...
if (!(_vault getVariable ["safe_open",false])) exitWith {[localize "STR_Cop_VaultLocked",5,"gray"] call RPG_Fnc_Msg;};
...
[localize "STR_Cop_VaultRepaired",5,"blue"] call RPG_Fnc_Msg;