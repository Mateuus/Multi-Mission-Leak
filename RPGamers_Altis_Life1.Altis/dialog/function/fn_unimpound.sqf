...
if (BANK < _price) exitWith {[format [(localize "STR_Garage_CashError"),[_price] call life_fnc_numberText],5,"gray"] call RPG_Fnc_Msg;};
...
[localize "STR_Garage_SpawningVeh",5,"gray"] call RPG_Fnc_Msg;
BANK = BANK - _price;
