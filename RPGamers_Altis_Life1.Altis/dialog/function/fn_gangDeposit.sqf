...
if ((group player getVariable ["gbank_in_use_by",player]) != player) exitWith {[localize "STR_ATM_WithdrawMin",5,"gray"] call RPG_Fnc_Msg;}; //Check if it's in use.
...
[format [localize "STR_ATM_DepositSuccessG",[_value] call life_fnc_numberText],5,"blue"] call RPG_Fnc_Msg;
