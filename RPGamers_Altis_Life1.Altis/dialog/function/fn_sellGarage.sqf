...
if ((lbCurSel 2802) isEqualTo -1) exitWith {[localize "STR_Global_NoSelection",5,"gray"] call RPG_Fnc_Msg;};
...
if (isNil "_vehicle") exitWith {[localize "STR_Garage_Selection_Error",5,"gray"] call RPG_Fnc_Msg;};
if ((time - life_action_delay) < 1.5) exitWith {[localize "STR_NOTF_ActionDelay",5,"gray"] call RPG_Fnc_Msg;};
...
[format [localize "STR_Garage_SoldCar",[_sellPrice] call life_fnc_numberText],5,"blue"] call RPG_Fnc_Msg;
