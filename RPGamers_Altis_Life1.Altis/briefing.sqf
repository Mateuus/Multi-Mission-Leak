...
player createDiarySubject ["initiation","Initiation"];
...
Any weapon shop<br/>
All Police HQs<br/>
50m away from any marked ATM<br/>
Rebel Outposts/Rebel City<br/><br/>
                "
        ]
    ];

    player createDiaryRecord ["initiation",
        [
            "Initiation",
                "
Initiation<br/><br/><br/>
...
After a head on traffic collision (on purpose or accident doesn't matter) you're no longer allowed to act hostile to the other party, This includes robbing them, shooting them or flaming them.<br/><br/>

You must vocally initiate on someone before causing them any harm<br/><br/>

If you're threatening someone you must pose a threat, Example: 'Stop the car or your dead' you must have a gun/weapon out for it to be classed as proper initiation.<br/><br/>

You can not initiate from a vehicle<br/><br/>

You cannot initiate gun play with anyone when you are restrained/ziptied. Example: Telling the APD that they need to let you go or they will be shot.<br/><br/>

Being 'Initiated' only lasts for about 10 minutes from the initial contact, This means within 10 minutes you may still act on a previous initiation, After this time has expired it is classified as RDM<br/><br/>

The initiation rule is different for Suicide Vests, You should have a valid reason for setting one off, 'FUCK THE POLICE' is not a valid argument and there should be RP grounds for using this - Randomly running up and using a Suicide Vest next to people who you have no previous RP with is RDM/FAIL RP<br/><br/>

If you talk trash / threaten / abuse people inside a safe zone this can be classed as a hostile action against you meaning you are no longer in a 'safe zone'.<br/><br/>
                "
        ]
    ];
...
4. Out Of Character<br/>
5. RDM/VRDM<br/>
6. Fail RP<br/>
7. Being kicked 3 or more times.<br/>
+ Read everything in the rules on our website! (www.rpgamerslife.com)<br/><br/>
                "
        ]
    ];
...
7. Police speedboats or Hunter HMGs may be used to assist in apprehending criminals. The weapon should be used to disable vehicles, not to blow them up.<br/><br/>
    ...
    player createDiaryRecord ["policerules",
        [
            "Speeding", 
                "
                The following speeds are to be enforced by the Altis Police Force for the absolute safety of the citizens and all travelling beyond the city.<br/><br/>
                
                Side streets in towns and cities: 50 km/hr<br/>
                Main road in towns and cities: 70 km/hr<br/>
                Built up residential areas outside of towns and cities: 90 km/hr<br/>
                Main road outside of towns and cities: 120 km/hr<br/>
                "
        ]
    ];
...
6. The Police HQ buildings are illegal for civilians to enter without authorization, however it is NOT illegal for civilians to be nearby unless they are causing a nuisance.<br/><br/>
    ...
    player createDiaryRecord ["policerules",
        [
            "Probable Cause", 
                "
                What Is Probable Cause?<br/><br/>

                Probable cause is a reasonable belief that a person has committed or will commit a crime.<br/>
                For probable cause to exist, a police officer must have sufficient knowledge of facts to warrant a belief that a suspect is committing a crime.<br/>
                The belief must be based on factual evidence, not just on suspicion.<br/><br/>

                Sources of Probable Cause<br/><br/>

                Observation - Information obtained by an officer through observation.<br/>
                Circumstantial evidence - Indirect evidence that implies something occurred but does not directly prove it.  The circumstances surrounding the facts can be used to reasonably infer guilt or innocence.<br/>
                Expertise - The training of police officers which enables them to identify certain movements, gestures, preparations, or tools as tending to indicate criminal activity.<br/>
                Information - Includes statements by witnesses, victims, and informants.<br/>
                Sensory – If the officer detects evidence of a crime simply through sight, smell or hearing, the officer has probable cause. This includes the smell of marijuana or other drugs from inside a vehicle.<br/>
                Consent – if the defendant agrees to a search, then probable cause is automatically created.<br/><br/>
                "
        ]
    ];
    ...
    player createDiaryRecord ["illegalitems",
        [
            "Illegal Vehicles",
                ...
                2. Speed Boat<br/>
                3. Hunter<br/>
                4. Any police vehicle<br/>
                5. Any EMS vehicle (Should contact an admin as this is against the rules)<br/><br/>
                "
        ]
    ];
    ...
    player createDiaryRecord ["illegalitems",
        [
            "Illegal Clothing",
                ...
                2. Shemag<br/>
                3. Bandana<br/>
                4. All Vests (If a citizen is wearing a suicide vest it is considered terrorism)<br/><br/>
                "
        ]
    ];
    ...
    player createDiaryRecord ["controls",
        [
            "Police Controls",
                "
F: Vehicle siren.<br/>
C: Warning sound 1 (In a car).<br/>
V: Warning sound 2 (In a car).<br/>
B: Warning sound 3 (In a car).<br/>
G: Speed radar (In a car).<br/>
Left Shift + L: Activates siren lights.<br/>
Left Shift + R: Restrain.<br/>
Left Shift + G: Crash Tackle.<br/>
INSERT: Panic Button (With one in your inv).<br/>
F4: Deploy Spike Strip (With one in your inv).<br/><br/>
                "
        ]
    ];
    ...
    player createDiaryRecord ["controls",
        [
            "Medic Controls",
                "
F: Vehicle siren.<br/>
Left Shift + L: Activates siren lights.<br/><br/>
                "
        ]
    ];
    ...
    player createDiaryRecord ["controls",
        [
            "Civilian Controls",
                "
Left Shift + G: Knock out / stun (Weapon required. Used for robbing & zip tying).<br/>
...
Ctrl + Y: Shortcut to player inventory.<br/>
...
End: Ear Plugs (90%) (60%) (30%)<br/>
0: Sync Data<br/>
1,2,3,4,5: Hand Gestures<br/>
Q,E Turn Signals (While In Car)<br/<br/>
                "
        ]
    ];
