		...
		class GoldBarTransport
		{
			...
			class AIUnits
			{
				gear[] = {
												...
												"", // Backpack
												{"arifle_ARX_blk_F", "30Rnd_65x39_caseless_green", 5}, // Primary weapon, ammo and how many magazines
												{"", "0Rnd_50BW_Mag_F", 2}, // Secondary weapon, ammo and how many magazines
				};
			};
			...
			class Messages
			{
				...
				startAnnouncementDescription	= "The guarded transporter is currently moving larger amounts of gold to the Federal Reserve.";
			...
			{
				// Route configuration
				markers[] 						= {"mav_convoy_waypoint1","mav_convoy_waypoint2","mav_convoy_waypoint3","mav_convoy_waypoint4","mav_convoy_waypoint5","mav_convoy_waypoint6","mav_convoy_waypoint7"};
			};
