...
class Clothing {
    class bruce {
        ...
        backpacks[] = {
            ...
            { "B_Bergen_rgr", "", 6500, "" },
            { "B_Bergen_blk", "", 6500, "" },
            { "B_Carryall_ocamo_AAA", "Nike Carryall", 7500, "" },
            { "B_Carryall_ocamo", "Cat Carryall", 7500, "" },
            { "B_Carryall_oucamo", "Vote Trump Carryall", 7500, "" },
            { "B_Carryall_mcamo", "Twitch Carryall", 7500, "" },
            { "B_Carryall_oli", "ADC Carryall", 7500, "" },
            { "B_Carryall_khk", "Kind Message Carryall", 7500, "" },
            { "B_Carryall_cbr", "SpongeBob Carryall", 7500, "" },
            { "B_Carryall_ocamo_Eng", "Addidas Carryall", 7500, "" },
            { "B_Carryall_oucamo_AAT", "Grab Your Shirt Carryall", 7500, "" },
            { "B_Carryall_mcamo_AAA", "Breaking Bad Carryall", 7500, "" },
            { "B_Carryall_mcamo_AAT", "RPG Carryall", 7500, "" },
            { "B_Carryall_cbr_AAT", "Black Carryall", 7500, "" },
            { "B_Carryall_ocamo_AAR", "Brown Carryall", 7500, "" },
            { "B_Carryall_oucamo_Eng", "Blue Carryall", 7500, "" },
            { "B_Carryall_oucamo_Exp", "Pink Carryall", 7500, "" },
            { "B_Carryall_oucamo_AAR", "Purple Carryall", 7500, "" },
            { "B_Carryall_ocamo_Exp", "Orange Carryall", 7500, "" }
            //{ "B_Carryall_oucamo_AAA", "Yellow Carryall", 7500, "" }
        };
    };
    ...
    class cop {
        ...
        uniforms[] = {
            ...
            //{ "U_B_survival_uniform", "", 1250, { "life_coplevel", "SCALAR", 2 } },
        ...
        goggles[] = {
            ...
            { "G_Lady_Dark", "", 150, "" },
            { "G_Lady_Blue", "", 150, "" },
            { "G_Bandanna_beast", "", 150, "call life_coplevel >= 3" }
        };
        vests[] = {
            { "NONE", "Remove Vest", 0, "" },
        ...
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, "" },
            { "B_Carryall_cbr", "Invisible Backpack", 3500, "" }
        };
    };
    ...
    class reb {
        ...
        vests[] = {
            ...
            { "V_HarnessO_brn", "", 7500, "" },
            { "V_TacVest_khk", "", 12500, "" },
            { "V_TacVestIR_blk", "", 22500, "" },
            { "V_PlateCarrier1_blk", "", 40000, "" },
            { "V_HarnessOGL_gry", "Suicide Vest", 150000, "" }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, "" },
            { "B_OutdoorPack_blk", "", 500, "" },
