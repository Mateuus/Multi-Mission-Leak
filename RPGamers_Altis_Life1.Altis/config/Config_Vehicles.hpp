...
class LifeCfgVehicles {
    ...
    */
    ...
    class B_Heli_Transport_01_F {
        ...
        textures[] = {
            { "Police", "cop", {
                "textures\cop\police_ghosthawk.jpg"
            }, "" }
        };
    };
    ...
    class O_MRAP_02_F {
        ...
        textures[] = {
            ...
            { "Rebel", "reb", {
                "textures\rebel\ifrit_r1.jpg",
                "textures\rebel\ifrit_r2.jpg"
            }, "" }
        };
    };
    ...
    class C_Offroad_01_F {
        vItemSpace = 65;
        conditions = "license_civ_driver || {license_cop_cop} || {license_med_med}";
        price = 12500;
        textures[] = {
            { "Red", "civ", {
            ...
            { "Gay Migs", "civ", {
                "textures\civ\gay_offroad.paa"
            }, "" },
            { "Monster", "civ", {
                "textures\civ\monster_offroad.jpg"
            }, "" },
            { "Police", "cop", {
...
*/
    ...
    class C_Hatchback_01_sport_F {
        vItemSpace = 45;
        conditions = "license_civ_driver || {license_cop_cop}";
        price = 40000;
        textures[] = {
            { "Red", "civ", {
            ...
            { "Cunt Chaser", "civ", {
                "textures\civ\CuntChaser_hatchback.jpg"
            }, "" },
            { "Monster Stain", "civ", {
                "textures\civ\monster_hatchback.jpg"
            }, "" },
            { "Police", "cop", {
    ...
    class I_Truck_02_covered_F {
        ...
        textures[] = {
            ...
            { "Blue Meth", "civ", {
                "textures\civ\bluemeth2_zamak.jpg",
                "textures\civ\bluemeth_zamak.jpg"
            }, "" },
            { "Black", "cop", {
    ...
    class C_SUV_01_F {
        ...
        textures[] = {
            ...
            { "Hello Kitty", "civ", {
                "textures\civ\kitty_suv.jpg"
            }, "" },
            { "Tiger", "civ", {
                "textures\civ\tiger_suv.jpg"
            }, "" },
            { "Police", "cop", {
                "textures\cop\police_suv.paa"
            }, "" },
            //{ "DEA", "cop", {
            //    "textures\dea\dea_suv.jpg"
            //}, "" },
            { "EMS", "med", {
    ...
    class B_MRAP_01_F {
        ...
        textures[] = {
            ...
            //{ "DEA", "cop", {
            //    "textures\dea\dea_hunter.jpg",
            //    "textures\dea\dea_hunter_2.jpg"
            //}, "" }
        };
    };
    ...
    class B_Heli_Light_01_F {
        ...
        textures[] = {
            ...
            { "EMS", "med", {
                "textures\medic\medic_littlebird.jpg"
            }, "" }
        };
    };
