...
class VirtualShops {
    ...
    class market {
        ...
        side = "civ";
        conditions = "";
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "cprKit", "nitro", "tbacon", "pickaxe", "fuelFull", "peach", "storagesmall", "storagebig", "rabbit_raw", "hen_raw", "rooster_raw", "sheep_raw", "goat_raw", "froglegs" };
    };
    ...
    class rebel {
        ...
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "cprKit", "nitro", "lockpick", "zipties", "pickaxe", "fuelFull", "peach", "boltcutter", "blastingcharge" };
    };
    ...
    class cop {
        ...
        side = "cop";
        conditions = "";
        items[] = { "donuts", "coffee", "spikeStrip", "panicbutton", "waterBottle", "rabbit", "apple", "redgull", "fuelFull", "defusekit" };
    };
};
...
class VirtualItems {
    ...
    class froglegs {
        variable = "froglegs";
        displayName = "STR_Item_FrogLegs";
        weight = 4;
        buyPrice = -1;
        sellPrice = -1;
        illegal = false;
        edible = 1;
        icon = "icons\ico_froglegs.paa";
        processedItem = "lsd";
    };
    ...
    class plateMetal {
        variable = "plateMetal";
        displayName = "STR_Item_PlateMetal";
        weight = 2;
        buyPrice = -1;
        sellPrice = -1;
        illegal = false;
        edible = -1;
        icon = "icons\plateMetal.paa";
    };

    class plate {
        variable = "plate";
        displayName = "STR_Item_Plate";
        weight = 1;
        buyPrice = -1;
        sellPrice = 100;
        illegal = false;
        edible = -1;
        icon = "icons\plate.paa";
    };
