...
// Make vehicle not visible for players
...
// Set default variables on vehicle in case they dont exist
...
mav_tuning_nightlight setLightColor [250,150,50];
mav_tuning_nightlight setLightAmbient [1,1,0.2];
mav_tuning_nightlight setLightAttenuation [1,0,0,0];
