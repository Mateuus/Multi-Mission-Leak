...
class DS_RscControlsGroup {
	...
	class VScrollBar : DS_RscScrollBar
	{
		width = 0.021;
		autoScrollEnabled = 1;
	};

	class HScrollBar : DS_RscScrollBar
	{
		height = 0.028;
	};
...
class DS_RscControlsGroupNoScrollbars : DS_RscControlsGroup {
...
class DS_RscListNBox
{
	...
	autoScrollDelay = 5;
	autoScrollRewind = 0;
	class ListScrollBar: DS_RscScrollBar{};
	class ScrollBar: DS_RscScrollBar{};
};
...
class DS_RscTextMulti : DS_RscText
{
	linespacing = 1;
	style = 0 + 16 + 0x200;
};

class DS_RscPictureKeepAspect : DS_RscPicture
{
	style = 0x30 + 0x800;
};

class DS_RscStructuredText {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class DS_RscButtonTextOnly : DS_RscButton {
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	colorBackground[] = {1, 1, 1, 0};
...
class DS_RscButtonMenu : DS_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class DS_RscShortcutButtonMain : DS_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class DS_RscCheckbox {
	...
	soundEscape[] = { "\A3\ui_f\data\sound\RscButton\soundEscape", 0.09, 1 }; // Sound played when the control is released after pushing
};

class DS_RscProgress
{
	type = 8;
	style = 0;
	x = 0.344;
...
class DS_RscBackground : DS_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
...
class DS_RscCombo {
	...
	class ComboScrollBar : DS_RscScrollBar {};
};
