...
if(playerSide isEqualTo west) exitwith {hint "Police can not check this, check drug prices at a drug dealer"};//How did that even happen

[] spawn DS_civ_openMarket;
