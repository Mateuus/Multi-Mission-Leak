...
if(player distance atm29_2 < 200)then
	{
	_buildingarray = nearestObjects [atm29_2, ["All"], 100];
	{
...
if(_this select 0)exitwith
	...
	[player,_query,1,_vid,false] remoteExec ["HUNT_fnc_returnVehicleList",2];
...
if((playerSide isEqualTo west)&&(miscInfoArray select 8)&&((_vInfo select 2) == "I_APC_Wheeled_03_cannon_F"))then
	{
...
if((((_vInfo select 9)select 2) == 2)&&(!(playerSide isEqualTo west)))then
	{
