...
//issue 10 tickets
if(((DS_infoArray select 4) > 19)&&((DS_infoArray select 21) == 1))then{[3] call DS_fnc_questCompleted};
//Impound 10 vehicles
if(((DS_infoArray select 3) > 24)&&((DS_infoArray select 21) == 2))then{[3] call DS_fnc_questCompleted};
...
//Done in scripts
//Make 10 Arrest
if(((DS_infoArray select 5) > 19)&&((DS_infoArray select 21) == 6))then{[3] call DS_fnc_questCompleted};
//Play for 30 hours
...
//impound 300 vehicles
if(((DS_infoArray select 3) > 299)&&((DS_infoArray select 21) == 29))then{[3] call DS_fnc_questCompleted};
//play 300 hours
if(((DS_infoArray select 0) > 17999)&&((DS_infoArray select 21) == 34))then{[3] call DS_fnc_questCompleted};
