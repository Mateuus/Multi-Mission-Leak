	...
	case 0:
		...
		switch(_curQuest)do
			...
			case 14:
				{
				_return =
				["Water Taxi",1,"Ability to use Cruise Control on boats (8 Key)"];
				};
			case 15:
				{
				_return =
			...
			case 20:
				{
				_return =
				["Taxi Driver",1,"Extra 20% per taxi mission"];
				};
			case 21:
				{
				_return =
			...
			case 26:
				{
				_return =
				["Water Taxi Part 2",1,"20% extra payment for water taxi missions"];
				};
			case 27:
				{
				_return =
			...
			case 31:
				{
				_return =
				["Air Taxi Part 2",1,"Extra 30% payment for Air Taxi Missions"];
				};
			case 32:
				{
				_return =
			...
			case 34:
				{
				_return =
				["Truck Driver Advanced",1,"25% extra payment from truck driving"];
				};
			case 35:
				{
				_return =
			...
			case 36:
				{
				_return =
				["Water Taxi Part 2",1,"30% extra payment for water taxi missions"];
				};
			case 37:
				{
				_return =
			...
			case 38:
				{
				_return =
				["Crop Dusting",1,"100% extra payment for crop dusting missions"];
				};
			case 39:
				{
				_return =
			...
			case 45:
				{
				_return =
				["Chopper Missions Part 2",1,"100% Extra payment for completing Chopper Missions"];
				};
			case 46:
				{
				_return =
			...
			case 47:
				{
				_return =
				["Big Crop Duster",1,"Ability to purchase two extra houses over your limit"];
				};
			case 48:
				{
				_return =
			...
			case 49:
				{
				_return =
				["Pro Air Taxi Pilot",1,"Ability to purchase jets at air shops"];
				};
			case 50:
				{
				_return =
			...
			case 56:
				{
				_return =
				["Chopper Missions Advances",1,"Never have to sit your Air license test again (Just pay for it)"];
				};
			case 57:
				{
				_return =
	...
	case 1:
		...
		switch(_curQuest)do
			...
			case 29:
				{
				_return =
				["Cop Killer Gang Hideout",1,"All future water drug convoys are free to start"];
				};
			case 30:
				{
				_return =
	...
	case 2:
		...
		switch(_curQuest)do
			...
			case 41:
				{
				_return =
				["Vehicle Rearm Advanced",1,"Full money return on any future armed vehicle training purchase"];
				};
			case 42:
				{
				_return =
		...
		if(playerSide isEqualTo west)then
			...
			switch(_curQuest)do
				...
				case 2:
					{
					_return =
					["Impound 10 vehicles",1,"25% Extra Payment for Impounding vehicles"];
					};
				case 3:
					{
					_return =
				...
				case 6:
					{
					_return =
					["Make 10 Arrest",6,"50% extra bounty reward for arresting criminals"];
					};
				case 7:
					{
					_return =
				...
				case 32:
					{
					_return =
					["Close down a base",1,"You will always have banking insurance"];
					};
				case 33:
					{
					_return =
				...
				case 34:
					{
					_return =
					["Play for 300 hours",1,"50% Faster reviving"];
					};
				case 35:
					{
					_return =
