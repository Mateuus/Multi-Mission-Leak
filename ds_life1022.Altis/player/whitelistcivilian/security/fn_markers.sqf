...
if(visibleMap)then
	{
		{
			if(((side _x) isEqualTo civilian)&&((_x distance hosp1_1_2_3_1_1_3_1_1 < 300)||(_x distance hosp1_1_2_3_1_1_3_1_1_1 < 300)||(_x distance hosp1_1_2_3_1_1_3_1_2 < 300)))then
				{
				_civs pushBack _x;
				};
			...
			if(((side _x) isEqualTo west)&&(_x distance player < _copDistance))then
				{
				_cops pushBack _x;
				};
			if(((side _x) isEqualTo civilian)&&(_x distance player < _distance)&&(_x != player)&&(!(_x getVariable ["realModeMan",false])))then
				{
				_civs pushBack _x;
				};
			if(((side _x) isEqualTo civilian)&&(_x distance player < 50)&&(_x != player)&&(_x getVariable ["realModeMan",false]))then
				{
				_civs pushBack _x;
				};
			if(((side _x) isEqualTo independent)&&(!(_x getVariable ["security",false]))&&(_x distance player < _distance)&&(_x != player))then
				{
				_wlcivs pushBack _x;
				};
