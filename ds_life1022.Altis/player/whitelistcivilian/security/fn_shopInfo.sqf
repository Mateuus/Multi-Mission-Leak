/*
    ...
    Description:
    Job money info for security contractors
*/
...
if(gasdesk2 getVariable ["closed",false])then{_closedShops = _closedShops + "Chalkeia Gas<br/>";};
if(gasdesk3 getVariable ["closed",false])then{_closedShops = _closedShops + "Zaros Gas<br/>";};
if(gasdesk4 getVariable ["closed",false])then{_closedShops = _closedShops + "Paros Gas<br/>";};
if(gasdesk5 getVariable ["closed",false])then{_closedShops = _closedShops + "Athira Gas<br/>";};
if(gasdesk6 getVariable ["closed",false])then{_closedShops = _closedShops + "Charkia Gas<br/>";};
if(gasdesk7 getVariable ["closed",false])then{_closedShops = _closedShops + "Pyrgos Gas<br/>";};
if(gasdesk8 getVariable ["closed",false])then{_closedShops = _closedShops + "Lakka Gas<br/>";};
if(gasdesk9 getVariable ["closed",false])then{_closedShops = _closedShops + "Panochori Gas<br/>";};
if(gasdesk10 getVariable ["closed",false])then{_closedShops = _closedShops + "Sofia Gas<br/>";};
if(gasdesk12 getVariable ["closed",false])then{_closedShops = _closedShops + "Bay Gas<br/>";};
if(gasdesk13 getVariable ["closed",false])then{_closedShops = _closedShops + "Gulf Gas<br/>";};
if(hosp1 getVariable ["closed",false])then{_closedShops = _closedShops + "Sofia Hospital<br/>";};
if(hosp2 getVariable ["closed",false])then{_closedShops = _closedShops + "Telos Hospital<br/>";};

_telHosp = round(((gasMoneyArray select 13)/20000)*100);
_sopHosp = round(((gasMoneyArray select 12)/20000)*100);
_gasKore = round(((gasMoneyArray select 1)/20000)*100);
_gasChal = round(((gasMoneyArray select 2)/20000)*100);
_gasZar = round(((gasMoneyArray select 3)/20000)*100);
_gasPar = round(((gasMoneyArray select 4)/20000)*100);
_gasAth = round(((gasMoneyArray select 5)/20000)*100);
_gasChar = round(((gasMoneyArray select 6)/20000)*100);
_gasPyr = round(((gasMoneyArray select 7)/20000)*100);
_gasLak = round(((gasMoneyArray select 8)/20000)*100);
_gasPan = round(((gasMoneyArray select 9)/20000)*100);
_gasSof = round(((gasMoneyArray select 10)/20000)*100);
if((DS_securityArray select 13) == 1)then{_telHospRobbed = "Recently Robbed"}else{_telHospRobbed = ""};
if((DS_securityArray select 12) == 1)then{_sopHospRobbed = "Recently Robbed"}else{_sopHospRobbed = ""};
...
<t color='#FFFFF'>Chalkeia Gas: %6%1 | %18</t><br/>
<t color='#FFFFF'>Zaros Gas: %7%1 | %19</t><br/>
<t color='#FFFFF'>Paros Gas: %8%1 | %20</t><br/>
<t color='#FFFFF'>Athira Gas: %9%1 | %21</t><br/>
<t color='#FFFFF'>Charkia Gas: %10%1 | %22</t><br/>
<t color='#FFFFF'>Pyrgos Gas: %11%1 | %23</t><br/>
<t color='#FFFFF'>Lakka Gas: %12%1 | %24</t><br/>
<t color='#FFFFF'>Panochori Gas: %13%1 | %25</t><br/>
<t color='#FFFFF'>Sofia Gas: %14%1 | %26</t><br/>
%27
"
,"%"
