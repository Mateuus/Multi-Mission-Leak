...
private ["_result","_vehicle","_dialog","_storeAmount","_list2","_vehWeight","_itemWeight","_storeItem","_held","_parsed","_multiple","_value","_newWeight"];
...
_result = {_x isEqualTo _storeItem} count _vehInventory;
if(_parsed > _result)exitWith{hint "You do not have this much of that item"};

{
	if((_x isEqualTo _storeItem)&&(_parsedTemp > 0))then {
