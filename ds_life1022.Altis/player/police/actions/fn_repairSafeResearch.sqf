...
_infoArray = [0,safe_research,"cracking","closed"];
...
[(_infoArray select 0),(_infoArray select 1)] remoteExec ["HUNT_fnc_reseach",2];
[25000,"Locked a safe at the Altis Research Facility",name player] remoteExec ["DS_fnc_copRewards",west];
