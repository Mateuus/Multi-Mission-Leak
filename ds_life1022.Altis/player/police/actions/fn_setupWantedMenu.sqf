...
_btn30 = _display displayCtrl 190333;
...
_btn3 ctrlSetTooltip "Player has shot at or done some action where they intended to kill somebody else";
...
_btn9 ctrlSetTooltip "Player was inside the Fort Knox/Research Facility area while a robbery was in progress";
_btn10 ctrlSetTooltip "Player has declared on police through text or capture script in any of the following areas (Checkpoints/Cities/Bridges/Security HQ's) or attacked police in a police HQ";
...
_btn13 ctrlSetTooltip "The player's actions has resulted in the death of somebody. (Unintentional Murder)";
...
_btn19 ctrlSetTooltip "Player has failed to stop within 30 seconds when asked by police";
_btn20 ctrlSetTooltip "Alcohol has been detected on the player";
_btn21 ctrlSetTooltip "Player has flown an air vehicle in a way that could cause damage to property or loss of life";
...
_btn25 ctrlSetTooltip "Player is acting in such a way that they are causing a negative disturbance to others";
_btn26 ctrlSetTooltip "Player is on restricted property (Bank - Fort Knox - Jail Island - Police HQ - Someone's house etc)";
...
_specBtn4 ctrlSetTooltip "Revoke a player's drivers licenses (Car + Truck) for reckless driving charges";
_specBtn5 ctrlSetTooltip "Revoke a player's pilots license for careless flying charges";
_btn30 ctrlSetTooltip "Revoke a player's boat license for careless boating charges";
...
{
	if(alive _x)then {
		_index = _list lbAdd format ["%1",_x getVariable ["name",name _x]];
