...
private["_lock","_door","_property","_sleep"];
...
if(_lock)exitWith
	...
	hint "This houses doors are now locked";
	player say3D "dingDong";
	};

if((player getVariable ["policeSquad",""]) == "Rapid Response")then{_sleep = 0.05;};
...
hint "This house's doors are now unlocked";
player say3D "dingDong";