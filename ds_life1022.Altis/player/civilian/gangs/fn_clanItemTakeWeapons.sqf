...
private ["_index","_result","_vehicle","_dialog","_storeAmount","_list2","_vehWeight","_itemWeight","_storeItem","_held","_parsed","_multiple","_index","_value","_newWeight"];

disableSerialization;

_check = [_this,0,false,[false]] call BIS_fnc_param;
_vehicle = DS_bootVeh;
...
if((_nearbyPlayers > 0)&&(!_check))exitWith {
	...
	sleep _sleepTimer;
	[true] spawn DS_civ_clanItemTakeWeapons;
};
...
DS_bootVeh setVariable["weapons",[_vehInventory,_newWeight],true];

closeDialog 0;
[] spawn DS_fnc_clanItemStorage;