...
if(((_vehData select 1) + (_itemWeight*_parsed)) > _vehMaxWeight)exitWith{hint "The base can not hold this much of that item"};
...
if(_vehInventory isEqualTo [])then {
...
[_vehicle,player,3,DS_bootVeh] remoteExec ["HUNT_fnc_dupePrevention",2];
