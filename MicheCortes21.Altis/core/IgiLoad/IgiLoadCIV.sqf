...
if (isnil "IL_Variables") then
{
	...
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["C_Offroad_01_F"];
	IL_Supported_Vehicles_VAN = ["C_Van_01_transport_F"];
	IL_Supported_Vehicles_HEMTT = ["B_Truck_01_transport_F"];
	IL_Supported_Vehicles_KAMAZ = ["I_Truck_02_transport_F"];
	...
	IL_Supported_Veh_Ammo = ["Land_CargoBox_V1_F"];
	IL_Supported_Barrel = [""];
	IL_Supported_Tank = ["Land_WaterTank_F"];
	IL_Supported_Rubberboat = [""];
	IL_Supported_SDV = [""];
	IL_Supported_Box_H1 = [""];
	IL_Supported_Box_H2 = [""];
	IL_Supported_Cargo20 = ["Land_Cargo20_yellow_F"];
	//TODO
...
//	END IL_SetNewMass
	...
	IL_Vehicle_Chat =
	{
		...
		if (_mass_info && IL_Mass) then
		{
			...
			_text = _text + "<t color='#00aafd' size='1.2' shadow='1' shadowColor='#000000' align='left'>Fahrzeuggewicht: </t>";
			_text = _text + Format ["<t color='#ffff00' size='1.2' shadow='1' shadowColor='#000000' align='left'>%1</t><br/>", _v_def_mass];

			_text = _text + "<t color='#00aafd' size='1.2' shadow='1' shadowColor='#000000' align='left'>Gewicht der Ladung: </t>";
			_text = _text + Format ["<t color='#ffff00' size='1.2' shadow='1' shadowColor='#000000' align='left'>%1</t><br/>", _cargo_mass];

			_text = _text + "<t color='#00aafd' size='1.2' shadow='1' shadowColor='#000000' align='left'>Gesamtes Gewicht: </t>";
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Aufladen von außerhalb aktivieren</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Aufladen von außerhalb deaktivieren</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_OFFROAD) then
{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\load.paa' /><t color=""#007f0e"">  Kiste aufladen auf Offroader</t>",
	{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf Offroader</t>",
	{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\unload.paa' /><t color=""#ff0000"">  Abladen vom Offroader</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Aufladen von außen aktivieren</t>",
	{
		(_this select 0) setVariable["can_outside", true, true];;
	},[],IL_Action_S_Priority,false,true,"",
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Aufladen von außen deaktivieren</t>",
	{
		(_this select 0) setVariable["can_outside", false, true];;
	},[],IL_Action_S_Priority,false,true,"",
	"((driver _target == _this) && (_target getVariable 'can_outside') && IL_Can_Outside)"
...
if (_obj_main_type in IL_Supported_Vehicles_VAN) then
{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\load.paa' /><t color=""#007f0e"">  Kiste aufladen auf VAN</t>",
	{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf VAN</t>",
	{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\unload.paa' /><t color=""#ff0000"">  Abladen vom VAN</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_KAMAZ) then
{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\load.paa' /><t color=""#007f0e"">  Kiste aufladen auf ZAMAK</t>",
	{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf ZAMAK</t>",
	{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\unload.paa' /><t color=""#ff0000"">  Abladen vom ZAMAK</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_TEMPEST) then
{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\load.paa' /><t color=""#007f0e"">  Kiste aufladen auf TEMPEST</t>",
	{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf TEMPEST</t>",
	{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\unload.paa' /><t color=""#ff0000"">  Abladen vom TEMPEST</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_HEMTT) then
{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\load.paa' /><t color=""#007f0e"">  Kiste aufladen auf HEMTT</t>",
	{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\load.paa' /><t color=""#007f0e"">  Fahrzeug aufladen auf HEMTT</t>",
	{
	...
	_obj_main addAction [
	"<img image='Textures\Igiload\unload.paa' /><t color=""#ff0000"">  Abladen vom HEMTT</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
