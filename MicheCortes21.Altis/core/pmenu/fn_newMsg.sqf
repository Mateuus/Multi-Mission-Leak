...
[ObjNull,_msg,player,1,_loc] remoteExec ["TON_fnc_handleMessages",2];
 _to = "Police";
...
[ObjNull,_msg,player,3,_loc] remoteExec ["TON_fnc_handleMessages",2];
