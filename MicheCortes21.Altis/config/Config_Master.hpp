...
/* System Settings */
    ...
    escapeMenu_displayText = "Michecortes.de"; //Text displayed in the escape menu. Make it short.. around 20 characters.
    ...
    houseGarage_buyPrice = 7000000;
    houseGarage_sellPrice = 2500000;
    ...
    sendtoJail_locations[] = { "police_hq_1", "police_hq_2", "cop_spawn_3", "cop_spawn_5", "Correctional_Facility", "police_hq_flugplatz", "police_hq_pyrgos", "sendtojail_gefaengnisinnen" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    ...
    bank_cop = 75000; //Amount of cash in bank for new cops
    ...
    vehicleShop_rentalOnly[] = { "Land_CargoBox_V1_F", "Land_WaterTank_F", "Land_Cargo20_yellow_F" }; //Vehicles that can only be rented and not purchased. (Last only for the session)
    vehicleShop_3D = true; //Add preview 3D inside Shop vehicle.       Default : False

    /* Vehicle Purchase Prices */
    vehicle_purchase_multiplier_CIVILIAN = 1; //Civilian Vehicle Buy Price = Config_Vehicle price * multiplier
    vehicle_purchase_multiplier_COP = .01; //Cop Vehicle Buy Price = Config_Vehicle price * multiplier
    ...
    vehicle_rental_multiplier_MEDIC = .01; //Medic Vehicle Rental Price = Config_Vehicle price * multiplier
