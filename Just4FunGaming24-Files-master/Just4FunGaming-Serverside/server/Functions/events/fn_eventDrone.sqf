...
{ diag_log format["<EVENT> (UAVWreck) addAction to %1", XY_pvpUAVwreck]; XY_pvpUAVwreck addAction["Dateien herunterladen", XY_fnc_processAction, "usb1", 0, false, false, "", 'XY_i_usbstick_1 > 0 && !XY_actionInUse && (player distance XY_pvpUAVwreck) < 5']; } remoteExecCall ["bis_fnc_call", -2, true]; 
...
{ diag_log format["<EVENT> (UAVProcessor) addAction to %1", XY_pvpUAVprocessor]; XY_pvpUAVprocessor addAction["Dateien entschlüsseln", XY_fnc_processAction, "usb2", 0, false, false, "", 'XY_i_usbstick_2 > 0 && !XY_actionInUse && (player distance XY_pvpUAVprocessor) < 5']; } remoteExecCall ["bis_fnc_call", -2, true]; 
...
{ diag_log format["<EVENT> (UAVTrader) addAction to %1", XY_pvpUAVtrader]; XY_pvpUAVtrader addAction["Darknet-Händler", XY_fnc_virtualShopMenu, "blackmarket", 0, false, false, "", '!XY_actionInUse && (player distance XY_pvpUAVtrader) < 3']; } remoteExecCall ["bis_fnc_call", -2, true]; 
