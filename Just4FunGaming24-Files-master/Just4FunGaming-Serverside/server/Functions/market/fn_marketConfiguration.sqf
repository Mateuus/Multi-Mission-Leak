...
#define PRICE_LOW 350 
#define PRICE_MID 500 
#define PRICE_HIGH 650 
#define PRICE_ILLEGAL 850 
#define PRICE_ILLEGAL_HIGH 1000 
...
{ 
    ...
    XY_marketPrices pushBack [ _item, _price, _price ]; 
