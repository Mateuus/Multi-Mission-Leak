...
XY_fnc_updateRTC = { 
    private _result = ["SELECT Hour, Minute, Second, DayOfWeek FROM vcurrenttime", 2] call XYDB_fnc_asyncCall; 
...
"XY_RTC" spawn { scriptName _this; 
    ...
    // TODO: This doesn't work when there isn't a 0am shutdown, but I'm lazy and so it's Future-Kupferkarpfen's problem 
