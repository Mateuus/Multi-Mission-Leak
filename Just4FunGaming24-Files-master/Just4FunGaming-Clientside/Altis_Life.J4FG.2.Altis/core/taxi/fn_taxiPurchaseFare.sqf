...
if( player getVariable ["restrained", false] || player getVariable ["escorting", false] || player getVariable ["transporting", true] || XY_isArrested || XY_isTazed || !XY_atmUsable ) exitWith {
