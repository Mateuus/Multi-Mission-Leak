...
_btnManual ctrlEnable false;

_btnContinue ctrlSetStructuredText parseText "<t color='#EEEEEE'>Weiterspielen</t>";
_btnSave ctrlSetStructuredText parseText "<t color='#999999'>WWW: www.Just4FunGaming24.de</t>";
_btnRespawn ctrlSetStructuredText parseText "<t color='#999999'>TS: ts.Just4FunGaming24.de</t>";
...
_btnAbort ctrlSetEventHandler [ "ButtonClick", "diag_log ""sync call""; [] call XY_fnc_updateRequest; false" ];
_btnAbort ctrlCommit 0;
