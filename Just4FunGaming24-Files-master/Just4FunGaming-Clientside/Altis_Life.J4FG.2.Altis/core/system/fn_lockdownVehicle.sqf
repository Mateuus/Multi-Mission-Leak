...
if( _vehicle distance (getMarkerPos "poi_thwImpoundedVehicles_1") > 60 &&
    _vehicle distance (getMarkerPos "poi_thwImpoundedVehicles_2") > 60 &&
    _vehicle distance (getMarkerPos "poi_thwImpoundedVehicles_3") > 60 ) exitWith {
...
private _dbInfo = _vehicle getVariable["dbInfo", -1];
