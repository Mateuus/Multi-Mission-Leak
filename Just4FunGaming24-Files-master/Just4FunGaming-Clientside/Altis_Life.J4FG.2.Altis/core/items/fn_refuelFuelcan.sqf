...
if( !([500] call XY_fnc_pay) ) exitWith {
    hint "Du hast keine 500€ zum Befüllen";
};
...
if( !([false, "fuelE", 1] call XY_fnc_handleInv) ) then {
    _interrupted = true;
};
...
hint "Kanister für 500€ aufgefüllt";

[true, "fuelF", 1] call XY_fnc_handleInv;