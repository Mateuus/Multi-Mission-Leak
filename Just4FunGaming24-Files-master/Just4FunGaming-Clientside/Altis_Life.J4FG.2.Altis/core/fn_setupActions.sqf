...
switch (playerSide) do {
    case civilian: {
        ...
        player addAction[ localize "STR_pAct_RobPerson", XY_fnc_robAction, "", 0, false, true, "", '!(isNull cursorTarget) && { player distance cursorTarget < 3.5 } && { isPlayer cursorTarget } && { animationState cursorTarget == "incapacitated" } && { !(cursorTarget getVariable["robbed", false]) }'];
