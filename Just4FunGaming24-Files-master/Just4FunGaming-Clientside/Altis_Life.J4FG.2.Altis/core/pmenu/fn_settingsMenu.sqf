...
if(XY_tagsON) then {
    ...
    _tags buttonSetAction "[XY_ID_PlayerTags,""onEachFrame""] call BIS_fnc_removeStackedEventHandler; XY_tagsON = false; [] call XY_fnc_settingsMenu;";
} else {
    _tags ctrlSetTextColor [1,0,0,1];
    _tags ctrlSetText "AUS";
    _tags buttonSetAction "XY_ID_PlayerTags = [""XY_PlayerTags"",""onEachFrame"",""XY_fnc_playerTags""] call BIS_fnc_addStackedEventHandler; XY_tagsON = true; [] call XY_fnc_settingsMenu;";
};
