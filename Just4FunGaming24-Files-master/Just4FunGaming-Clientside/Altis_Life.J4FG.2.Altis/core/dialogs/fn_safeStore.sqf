...
if(_num > XY_i_goldbar) exitWith {hint format[localize "STR_Cop_NotEnoughGold",_num];};

//Store it.
if(!([false,_ctrl,_num] call XY_fnc_handleInv)) exitWith {hint localize "STR_Cop_CantRemove";};
