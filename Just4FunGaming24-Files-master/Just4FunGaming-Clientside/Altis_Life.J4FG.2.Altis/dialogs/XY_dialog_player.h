class XY_dialog_player {
    ...
    class controls {
        ...
        class moneyGive : XY_RscButtonMenu
        {
            idc = 2001;
        ...
        class GiveItemButton : XY_RscButtonMenu {
        ...
        class UseButton : XY_RscButtonMenu {
        ...
        class RemoveButton : XY_RscButtonMenu {
        ...
        class ButtonSettings : XY_RscButtonMenu {
            idc = -1;
        ...
        class ButtonMyGang : XY_RscButtonMenu {
            idc = 2011;
            text = "$STR_PM_MyGang";
            onButtonClick = "closeDialog 0; if( ((group player) getVariable [""gang.owner"", """"] isEqualTo """") ) then { createDialog ""XY_dialog_createGang""; } else { [""open""] call XY_fnc_gangMenu; };";
        ...
        class ButtonCallTaxi : XY_RscButtonMenu {
            idc = 2050;
            text = "TAXI";
        ...
        class ButtonGangList : XY_RscButtonMenu {
            idc = 2012;
        ...
        class ButtonKeys : XY_RscButtonMenu {
            idc = 2013;
        ...
        class ButtonCell : XY_RscButtonMenu {
            idc = 2014;
        ...
        class ButtonSyncData : XY_RscButtonMenu {
            idc = -1;
            text = "$STR_PM_SyncData";
            onButtonClick = "[] call XY_fnc_syncData;";
            x = 0.1;
            y = 0.805;
            w = (6.25 / 40);
            h = (1 / 25);
        ...
        class ButtonMarket : XY_RscButtonMenu {
            idc = 9900;
            text = "Markt";
            onButtonClick = "[] call XY_fnc_openMarketView;";
            x = 0.26 + (6.25 / 19.8) + (1 / 250 / (safezoneW / safezoneH));
            y = 0.805;
            w = (6.25 / 40);
            h = (1 / 25);
        ...
        class ButtonWantedAdd : XY_RscButtonMenu {
            idc = 9800;
            text = "Wanted +";
