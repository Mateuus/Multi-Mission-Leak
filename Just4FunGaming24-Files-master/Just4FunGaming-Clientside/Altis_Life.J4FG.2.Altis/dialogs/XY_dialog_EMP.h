class XY_dialog_EMP {
	...
	class controls {
		...
		class CloseButtonKey : XY_RscButtonMenu {
			idc = -1;
			text = "Schließen";
		...
		class Refresh : XY_RscButtonMenu {
			idc = -1;
			text = "Scan";
			onButtonClick = "[] spawn XY_fnc_scanVehicles;";
		...
		/*class WarnEMP : XY_RscButtonMenu {
			idc = 2030;
			text = "Warnen";
			onButtonClick = "";
		...
		class ExecEMP : XY_RscButtonMenu {
			idc = 2070;
			text = "Deaktivieren";
			onButtonClick = "[] spawn XY_fnc_empVehicle;";
		...
		class WarnEMP : XY_RscButtonMenu {
			idc = 2060;
			text = "Warnen";
			onButtonClick = "[] spawn XY_fnc_warnVehicle;";
