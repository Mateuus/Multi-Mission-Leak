class XY_dialog_unlockVehicles {
	...
	class controlsBackground
	{
		...
		{
			idc = 2801;
			text = "Eingezogene Fahrzeuge ausgeben";
			x = 0.1;
			y = 0.2;
			w = 0.8;
			h = (1 / 25);
		...
		class RentCar : XY_RscButtonMenu
		{
			idc = 2885;
			text = "Freigeben";
			onButtonClick = "(_this select 0) ctrlEnable false; [true] call XY_fnc_unimpound; closeDialog 0;";
	...
	class controls
	{
		class VehicleList : XY_RscListBox
		{
			...
			onLBSelChanged = "_this call XY_fnc_unlockLBChange;";
