class XY_dialog_smartphone {
	...
	class controls {
		...
		class Schreiben : XY_RscButtonMenu {
			idc = 887892;
		...
		class CloseLoadMenu : XY_RscButtonMenu {
			idc = -1;
...
class XY_dialog_smartphoneWrite
{
	...
	class controls {
		...
		class Absenden : XY_RscButtonMenu {
			idc = 88885;
		...
		class AdminMsg : XY_RscButtonMenu
		{
			idc = 888897;
...
class XY_dialog_smartphoneEmergency {
	...
	class controls {
		...
		sizeEx = 0.030;
		x = 0.11; y = 0.25;
		w = 0.83; h = 0.03;  //w war 62

		};

		class TxtCopButton : XY_RscButtonMenu
		{
			idc = 888895;
		...
		class TxtAdminButton : XY_RscButtonMenu
		{
			idc = 888896;
		...
		class AdminMsgAll : XY_RscButtonMenu
		{
			idc = 888898;
		...
		class thwReq : XY_RscButtonMenu
		{
			idc = 888900;
			text = "$STR_CELL_THWRequest";
			colorBackground[] = {0.576, 0.533, 0.074,1.0};
			onButtonClick = "[8,-1,(ctrlText 888894)] call XY_fnc_newMsg;";
		...
		class CloseButton : XY_RscButtonMenu {
			idc = -1;
			text = "$STR_Global_Close";
			onButtonClick = "closeDialog 0;";
			x = -0.06 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
        ...
        class policeBroadcast : XY_RscButtonMenu {
			idc = 888901;
        ...
        class MedicBroadcast : XY_RscButtonMenu {
			idc = 888902;
			text = "MEDIC-MELDUNG";
            colorBackground[] = {0.129, 0.152, 0.450,1.0};
        ...
        class THWBroadcast : XY_RscButtonMenu {
			idc = 888903;
			text = "THW-MELDUNG";
            colorBackground[] = {0.129, 0.152, 0.450,1.0};
			onButtonClick = "[11,-1,(ctrlText 888894)] call XY_fnc_newMsg; closeDialog 0;";
			x = 0.70;
			y = 0.36 + (1 / 50);
			w = 0.2;
			h = (1 / 25);
