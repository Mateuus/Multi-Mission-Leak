...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Qilin = ["O_T_LSV_02_unarmed_F", "O_T_LSV_02_unarmed_viper_F", "O_LSV_02_unarmed_F", "O_LSV_02_unarmed_viper_F", "O_T_LSV_02_unarmed_black_F", "O_T_LSV_02_unarmed_ghex_F", "O_T_LSV_02_unarmed_arid_F", "O_LSV_02_unarmed_black_F", "O_LSV_02_unarmed_ghex_F", "O_LSV_02_unarmed_arid_F"];
	IL_Supported_Prowler = ["B_T_LSV_01_unarmed_F", "B_T_LSV_01_unarmed_CTRG_F", "B_LSV_01_unarmed_F", "B_LSV_01_unarmed_black_F", "B_LSV_01_unarmed_olive_F", "B_LSV_01_unarmed_sand_F", "B_T_LSV_01_unarmed_black_F", "B_T_LSV_01_unarmed_olive_F", "B_T_LSV_01_unarmed_sand_F"];
	...
	IL_Supported_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_G_Offroad_01_armed_F", "C_Offroad_02_unarmed_F"];
	...
	IL_Supported_Quadbike = ["I_Quadbike_01_F", "C_Quadbike_01_F", "O_Quadbike_01_F", "B_G_Quadbike_01_F", "B_Quadbike_01_F", "CAF_Quadbike_OD", "CAF_Quadbike_AR", "Marinir_Quadbike_01_FG", "B_mas_mar_Quadbike_01_F", "C_Kart_01_Blu_F", "C_Kart_01_Fuel_F", "C_Kart_01_Red_F", "C_Kart_01_Vrana_F"];
	...
	IL_Supported_Cargo_Veh_Kamaz = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_VAN + IL_Supported_OFFROAD;
	...
	IL_Supported_Cargo_Veh_HEMTT = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_Hunter + IL_Supported_Ifrit + IL_Supported_Strider + IL_Supported_Qilin + IL_Supported_Prowler;
	...
	IL_Supported_Cargo_Veh_Mohawk = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_Cargo_Veh_HEMTT;
...
//	END IL_SetNewMass
	...
	IL_Vehicle_Chat =
	{
		...
		if (_mass_info && IL_Mass) then
		{
			...
			_text = _text + "<t color='#00aafd' size='1.2' shadow='1' shadowColor='#000000' align='left'>Standart Menge: </t>";
			_text = _text + Format ["<t color='#ffff00' size='1.2' shadow='1' shadowColor='#000000' align='left'>%1</t><br/>", _v_def_mass];

			_text = _text + "<t color='#00aafd' size='1.2' shadow='1' shadowColor='#000000' align='left'>Fracht   Menge: </t>";
			_text = _text + Format ["<t color='#ffff00' size='1.2' shadow='1' shadowColor='#000000' align='left'>%1</t><br/>", _cargo_mass];

			_text = _text + "<t color='#00aafd' size='1.2' shadow='1' shadowColor='#000000' align='left'>Aktuelle Menge: </t>";
		...
		{
			{
				...
				else
				{
					...
					if ((_box_num > _slot_num) && !_done) then
					{
						...
						{
							[_v, Format ["""%1"" wurde in ""%2"" geladen. Freie Plätze: ""%3"".", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName"), abs(_slot_num - _counter)], true] call IL_Vehicle_Chat;
						}
						else
						{
							[_v, Format ["""%1"" wurde in ""%2"" geladen. Es ist kein Platz mehr.", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName")], true] call IL_Vehicle_Chat;
						};
		...
		{
			{
				...
				if (_x getVariable "doors" == _doors) then
				{
					...
					if (((_x getVariable "attachedTruck") == _v) && ((_x getVariable "attachedPos") == (_counter)) && (_counter < 0) && !_done) then
					{
						...
						[_v, Format ["""%1"" wurde abgeladen von: ""%2"". Freue Plätze: ""%3"".", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName"), _free_slots], true] call IL_Vehicle_Chat;
						//player addScore IL_Unload_Score;
						[Player, IL_Unload_Score] call IL_Score;
						sleep 1;
					};
			...
			if (_skip) then
			{
				[_v, "Konnte keine Fracht finden. versuch es nochmal."] call IL_Vehicle_Chat;
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fracht laden</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fahrzeug laden</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload_para.paa' /><t color=""#b200ff""> Abwerfen</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fracht ausladen</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Fracht mit Fallschirm abwerfen</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload_all_para.paa' /><t color=""#a50b00"">  Ganze Fracht mit Fallschirm abwerfen</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Ladeklappe öffnen</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Ladeklappe schließen</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Laden für Ko-Pilot aktivieren</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Laden für Ko-Pilot deaktivieren</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Laden von außerhalb aktivieren</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Laden von außerhalb deaktivieren</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_CHINOOK) then
{
	...
	{
		_obj_main addAction [
		"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fracht auf Chinook laden</t>",
		{
		...
		_obj_main addAction [
		"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Fahrzeug auf Chinook laden</t>",
		{
		...
		_obj_main addAction [
		"<t color=""#007f0e"">In Chinok hinten</t>",
		{
			(_this select 1) moveInCargo (_this select 0);
		},[],IL_Action_LU_Priority,false,true,"",
		...
		_obj_main addAction [
		"<t color=""#007f0e"">In Chinook laden</t>",
		{
		...
		_obj_main addAction [
		"<img image='IgiLoad\images\unload_para.paa' /><t color=""#b200ff""> Auswerfen</t>",
		{
			[_this select 0, _this select 1, true] call IL_GetOut;
		},[],IL_Action_LU_Priority,false,true,"",
		...
		_obj_main addAction [
		"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fracht von Chinook ausladen</t>",
		{
			[_this select 0] call IL_Do_Unload;
		},[],IL_Action_LU_Priority,false,true,"",
		...
		_obj_main addAction [
		"<img image='IgiLoad\images\unload_all_para.paa' /><t color=""#a50b00"">  Alles mit Fallschirm abwerfen</t>",
		{
			while {((_this select 0) getVariable "box_num") != 0} do
			{
				[_this select 0, true] call IL_Do_Unload;
		...
		_obj_main addAction [
		"<t color=""#0000ff"">Rampe in Chinook öffnen</t>",
		{
		...
		_obj_main addAction [
		"<t color=""#0000ff"">Rampe in Chninook schließen</t>",
		{
	...
	if (typeOf _obj_main == "CH_47F") then
	{
		...
		_obj_main addAction [
		"<t color=""#ff0000"">Aus Chinook gehen</t>",
		{
			[_this select 0, _this select 1, false] call IL_GetOut;
		},[],IL_Action_LU_Priority,false,true,"",
		...
		_obj_main addAction [
		"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fracht abladen</t>",
		{
			[_this select 0] call IL_Do_Unload;
		},[],IL_Action_LU_Priority,false,true,"",
		...
		_obj_main addAction [
		"<img image='IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Abwurf mit Fallschirm</t>",
		{
			[_this select 0, true] call IL_Do_Unload;
		},[],IL_Action_LU_Priority,false,true,"",
	...
	if (typeOf _obj_main in ["kyo_MH47E_HC", "kyo_MH47E_Ramp", "kyo_MH47E_base"]) then
	{
		...
		_obj_main addAction [
		"<t color=""#007f0e"">In Chinook und zurück</t>",
		{
			(_this select 1) moveInCargo (_this select 0);
		},[],IL_Action_LU_Priority,false,true,"",
		"(_this in (nearestObjects[ _target modelToWorld [0,-9,-3], [], IL_SDistL + IL_SDistL_Heli_offset])) && ((_target emptyPositions 'cargo') > 0) && (abs(speed _target) <= IL_LU_Speed) && (((getPos _target) select 2) <= IL_LU_Alt) && (_target animationPhase 'Ani_Ramp' < 0.43) && (_target getVariable 'usable_ramp')"
		...
		_obj_main addAction [
		"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fracht abwerfen</t>",
		{
			[_this select 0] call IL_Do_Unload;
		},[],IL_Action_LU_Priority,false,true,"",
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Laden für Co-Pilot aktivieren</t>",
	{
		(_this select 0) setVariable["can_copilot", true, true];;
	},[],IL_Action_S_Priority,false,true,"",
	"((driver _target == _this) && !(_target getVariable 'can_copilot') && IL_Can_CoPilot)"
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Laden für Co-Pilot deaktivieren</t>",
	{
		(_this select 0) setVariable["can_copilot", false, true];;
	},[],IL_Action_S_Priority,false,true,"",
	"((driver _target == _this) && (_target getVariable 'can_copilot') && IL_Can_CoPilot)"
...
if (_obj_main_type in IL_Supported_Vehicles_C130J) then
{
	...
	{
		_obj_main addAction [
		"<t color=""#ff0000"">Auf der Seite der Rampe aussteigen</t>",
		{
			[_this select 0, _this select 1, false] call IL_GetOut;
		},[],IL_Action_LU_Priority,false,true,"",
...
//		"('Cargo' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (((getPosATL _target) select 2) >= IL_Para_Jump_ATL) && (_target animationPhase 'ramp_bottom' < 0.1) && (_target getVariable 'usable_ramp')"
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Fahrzeug ausparken</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
